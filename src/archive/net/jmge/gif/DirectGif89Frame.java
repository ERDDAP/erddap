...
// ==============================================================================
/**
 * Instances of this Gif89Frame subclass are constructed from RGB image info, either in the form of
 * an Image object or a pixel array.
 *
 * <p>There is an important restriction to note. It is only permissible to add DirectGif89Frame
 * objects to a Gif89Encoder constructed without an explicit color map. The GIF color table will be
 * automatically generated from pixel information.
 *
...
public class DirectGif89Frame extends Gif89Frame {
  ...
  public DirectGif89Frame(Image img) throws IOException {
    ...
    if (errmsg != null) throw new IOException(errmsg + " (" + getClass().getName() + ")");
