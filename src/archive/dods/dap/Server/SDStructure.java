...
public abstract class SDStructure extends DStructure implements ServerMethods, RelOps {
   ...
   * will not have sensible responses to all of the relational operators (e.g. DStructure won't know
   * how to match a regular expression but DString will). For those operators that are nonsensical a
  ...
  public boolean equal(BaseType bt) throws InvalidOperatorException, RegExpException, SBHException {
    throw new InvalidOperatorException(
        "Equals (=) operator does not work with the type SDStructure!");
  }
  ...
  public boolean not_equal(BaseType bt)
    ...
    throw new InvalidOperatorException(
        "Not Equals (!=) operator does not work with the type SDStructure!");
  }
  ...
  public boolean greater(BaseType bt)
      throws InvalidOperatorException, RegExpException, SBHException {
    throw new InvalidOperatorException(
        "Greater Than (>)operator does not work with the type SDStructure!");
  }
  ...
  public boolean greater_eql(BaseType bt)
      throws InvalidOperatorException, RegExpException, SBHException {
    throw new InvalidOperatorException(
        "GreaterThan or equals (<=) operator does not work with the type SDStructure!");
  }

  @Override
  public boolean less(BaseType bt) throws InvalidOperatorException, RegExpException, SBHException {
    throw new InvalidOperatorException(
        "LessThan (<) operator does not work with the type SDStructure!");
  }
  ...
  public boolean less_eql(BaseType bt)
      throws InvalidOperatorException, RegExpException, SBHException {
    throw new InvalidOperatorException(
        "LessThan oe equals (<=) operator does not work with the type SDStructure!");
  }
  ...
  public boolean regexp(BaseType bt)
      throws InvalidOperatorException, RegExpException, SBHException {
    throw new InvalidOperatorException(
        "Regular Expression's don't work with the type SDStructure!");
  }
  ...
  public void serialize(String dataset, DataOutputStream sink, CEEvaluator ce, Object specialO)
    ...
    // System.out.println("Serializing Structure "+getName()+"   isRead(): "+isRead()+"
    // isProject(): " + isProject());
