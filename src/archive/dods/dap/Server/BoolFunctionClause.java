...
public class BoolFunctionClause extends AbstractClause implements TopLevelClause {
   ...
   * @param children A list of SubClauses, to be given as arguments to the function. If all the
   *     arguments are constant, the function clause will be flagged as constant, and evaluated
   *     immediatelyx.
   * @exception SDODSException Thrown if either 1) the function does not accept the arguments given,
   *     or 2) the clause is constant, and the attempt to evaluate it fails.
   */
