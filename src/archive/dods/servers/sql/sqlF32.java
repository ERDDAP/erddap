...
/**
 * Holds a DODS Server <code>sqlF32</code> value.
 *
 * @version $Revision: 1.3.2.1 $
 * @author ndp
 * @see BaseType
 */
public class sqlF32 extends SDFloat32 {

    //private static final boolean _Debug = false;

    /** Constructs a new <code>sqlF32</code>. */
    public sqlF32() {
        super();
    }

    /**
     * Constructs a new <code>sqlF32</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlF32(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
            ...
            switch (rsmd.getColumnType(column)) {
                ...
                default:
                    throw new NoSuchVariableException(
                            ...
                            ") as the DODS type: DFloat32");

            }

            if (result.wasNull()) { // Is this column a null value?
        ...
        if (Debug.isSet("sqlRead")) System.out.println("Float32 received from SQl Query: \"" + b + "\"");
