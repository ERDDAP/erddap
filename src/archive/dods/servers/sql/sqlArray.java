...
/**
 * Holds a DODS Server <code>sqlArray</code> value.
 *
...
public class sqlArray extends SDArray {
    ...
    /** Constructs a new <code>sqlArray</code>. */
    public sqlArray() {
        super();
    }

    /**
     * Constructs a new <code>sqlArray</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlArray(String n) {
        super(n);
    }
