...
public class sqlI32 extends SDInt32 {


    //private static final boolean _Debug = false;

    /** Constructs a new <code>sqlI32</code>. */
    public sqlI32() {
        super();
    }

    /**
     * Constructs a new <code>sqlI32</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlI32(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
        ...
        if (Debug.isSet("sqlRead")) System.out.println("Int32 received from SQl Query: \"" + b + "\"");
