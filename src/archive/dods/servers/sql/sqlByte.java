...
/**
 * Holds a DODS Server <code>sqlByte</code> value.
 *
 * @version $Revision: 1.3.2.1 $
 * @author ndp
 * @see BaseType
 */
public class sqlByte extends SDByte {

    //private static final boolean _Debug = false;


    /** Constructs a new <code>sqlByte</code>. */
    public sqlByte() {
        super();
    ...
    /**
     * Constructs a new <code>sqlByte</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlByte(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
            ...
            switch (rsmd.getColumnType(column)) {
                ...
                default:
                    throw new NoSuchVariableException(
                            ...
                            ") as the DODS type: DByte");

            }

            if (result.wasNull()) { // Was this column a null value?
                if (Debug.isSet("sqlRead")) System.out.println("NULL value in resultSet!");
            }
        ...
        if (Debug.isSet("sqlRead")) System.out.println("Byte received from SQl Query: \"" + b + "\"");
