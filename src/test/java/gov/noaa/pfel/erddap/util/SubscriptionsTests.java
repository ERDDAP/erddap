...
"https://localhost:8443/erddap/subscriptions/validate.html?subscriptionID=0&key=" + key + "\n" +
"\n" +
"\n" +
"*****\n" +
"Now or in the future, you can delete that subscription (unsubscribe) with\n" +
"https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=0&key=" + key + "\n" +
"\n" +
"You can request an email with a list of all of your valid and pending subscriptions with this URL:\n" +
"https://localhost:8443/erddap/subscriptions/list.html?email=john.smith@company.com\n";              
...
"status:         pending\n" +
"to validate:    https://localhost:8443/erddap/subscriptions/validate.html?subscriptionID=0&key=" + key + "\n" +
"\n" +
...
"action:         mailto:john.smith@company.com\n" +
"status:         valid\n" +
"to unsubscribe: https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=0&key=" + key + "\n" +
"\n" +
"Note that pending subscriptions that aren't validated soon will be deleted.\n" +
"\n" +
"\n" +
...
"rPmelTao             pending http://www.yahoo.com                https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=4&key=" + key4 + "\n" +
"\n" +
"john.smith@company.com\n" +
"pmelTao              pending mailto:john.smith@company.com       https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=0&key=" + key0 + "\n" +
"pmelTao              pending http://www.google.com               https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=1&key=" + key1 + "\n" +
"rPmelTao             pending mailto:john.smith@company.com       https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=2&key=" + key2 + "\n" +
"rPmelTao             pending http://www.yahoo.com                https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=3&key=" + key3 + "\n" +
"\n",
            "results=\n" + results);
...
"action:         mailto:john.smith@company.com\n" +
"status:         valid\n" +
"to unsubscribe: https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=0&key=" + key0 + "\n" +
"\n" +
"datasetID:      pmelTao\n" +
"action:         http://www.google.com\n" +
"status:         valid\n" +
"to unsubscribe: https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=1&key=" + key1 + "\n" +
"\n" +
"datasetID:      rPmelTao\n" +
"action:         mailto:john.smith@company.com\n" +
"status:         valid\n" +
"to unsubscribe: https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=2&key=" + key2 + "\n" +
"\n" +
"datasetID:      rPmelTao\n" +
"action:         http://www.yahoo.com\n" +
"status:         valid\n" +
"to unsubscribe: https://localhost:8443/erddap/subscriptions/remove.html?subscriptionID=3&key=" + key3 + "\n" +
"\n" +
"Note that pending subscriptions that aren't validated soon will be deleted.\n" +
"\n" +
"\n" +
