...
public class DatasetHandlerTests {
    ...
    void EDDTableFromErddapHandlerTest () throws IOException, SAXException {
        var eddTableFromErddapHandler = new EDDTableFromErddapHandler(saxHandler, "cwwcNDBCMet", topLevelHandler, context);
        saxHandler.setState(eddTableFromErddapHandler);
        saxParser.parse(inputStream, saxHandler);
        assertEquals("https://coastwatch.pfeg.noaa.gov/erddap/tabledap/cwwcNDBCMet", eddTableFromErddapHandler.tLocalSourceUrl);
    }
}
