...
class FindDuplicateTimeTests {
  ...
  void testBasic() throws Throwable {
    ...
    String expected = "*** FindDuplicateTime directory=" + testDir
        ...
        "\n" +
        "error #1=" + testDir + "/GL_201111_TS_DB_44761Invalid.nc\n" +
        "    java.io.IOException: java.io.EOFException: Reading " + testDir
        + "/GL_201111_TS_DB_44761Invalid.nc at 3720 file length = 3720\n" +
        "\n" +
        "2 files have time=2011-11-01T00:00:00Z\n" +
        testDir + "/GL_201111_TS_DB_44761.nc\n" +
        testDir + "/GL_201111_TS_DB_44761Copy.nc\n" +
        "\n" +
