...
class EDDTableFromAsciiFilesTests {
  ...
  void testBasic() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    // String2.log(results);
    expected = "longitude,latitude,altitude,time,station,wd,wspd,atmp,wtmp\n" +
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    // String2.log(results);
    expected = "longitude,latitude,altitude,time,station,atmp,wtmp\n" +
  ...
  void testFixedValueAndScripts() throws Throwable {
    ...
    for (int test = 0; test < 2; test++) {
      ...
      EDDTableFromAsciiFiles.deleteCachedDatasetInfo(id);
      EDDTable eddTable = (EDDTable) (test == 0 ? EDDTestDataset.gettestWTDLwSV()
          : EDDTestDataset.gettestWTDLwoSV());
      ...
      expected = "String infoUrl \"http://shiptracker.noaa.gov/\";\n" +
      ...
      results = File2.readFromFile88591(EDStatic.fullTestCacheDirectory + tName)[1];
      expected = "ship_call_sign,time,latitude,longitude0360,longitude,seaTemperature,seaTemperatureF\n"
          +
      ...
      tName = eddTable.makeNewFileForDapQuery(language, null, null,
          ...
          EDStatic.fullTestCacheDirectory, eddTable.className() + "_fva" + test, ".csv");
      results = File2.readFromFile88591(EDStatic.fullTestCacheDirectory + tName)[1];
      expected = "longitude0360,longitude\n" +
  ...
  void testBasic2() throws Throwable {
    ...
    // String2.log(results);
    expected = "fileName,five,aString,aChar,aBoolean,aByte,aShort,anInt,aLong,aFloat,aDouble\n" +
        ",,,,,,,,,,\n" +
    ...
    results = File2.directReadFrom88591File(testDir + tName);
    expected = "anInt,fileName,five,aBoolean\n" +
        ",,,\n" +
  ...
  /**
   * This tests generateDatasetsXml and querying a dataset that is using
   * standardizeWhat
   * with source files in a private AWS S3 bucket.
   * This doesn't need or use cacheFromUrl. The directory is the AWS URL of the
   * directory.
   */
  @org.junit.jupiter.api.Test
  @TagAWS
  void testAwsS3StandardizeWhat() throws Throwable {
    ...
    tName = eddTable.makeNewFileForDapQuery(language, null, null, "&time=2010-01-01",
        EDStatic.fullTestCacheDirectory,
    ...
    tName = eddTable.makeNewFileForDapQuery(language, null, null, "&time=2010-01-03",
        EDStatic.fullTestCacheDirectory,
  ...
  void testFiles() throws Throwable {
    ...
    try {
      ...
      expected = "This is a header line.\n" +
          "*** END OF HEADER\n" +
          "# a comment line\n" +
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testTableAscii/gibberish/\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testTableAscii/gibberish.csv\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testTableAscii/subdir/gibberish.csv\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
          "    message=\"Not Found: File not found: gibberish.csv .\";\n" +
      ...
      throw new RuntimeException(
          "Unexpected error. This test requires testTableAscii in the localhost ERDDAP.",
          t);
    }
  }
  ...
  void testGenerateDatasetsXmlFromBCODMO() throws Throwable {
    ...
    String dataDir = Path.of(EDDTestDataset.class.getResource("/largeFiles/bcodmo/").toURI()).toString()
        + "/";
    String numberRegex = "(549122)";

    String results = EDDTableFromAsciiFiles.generateDatasetsXmlFromBCODMO(
    ...
    String expected = "<dataset type=\"EDDTableFromAsciiFiles\" datasetID=\"" + suggDatasetID
        ...
        +
        "    <fileDir>" + dataDir + "549122v20150217/</fileDir>\n" +
        ...
        "    <iso19115File>" + dataDir + "549122v20150217/iso_19115_2.xml</iso19115File>\n" +
        "    <!-- sourceAttributes>\n" +
        "    </sourceAttributes -->\n" +
        "    <!-- Please specify the actual cdm_data_type (TimeSeries?) and related info below, for example...\n"
        +
  ...
  void testQuickRestart() throws Throwable {
    ...
    String dataDir = Path.of(EDDTestDataset.class.getResource("/data/asciiNdbc/").toURI()).toString();
    ...
    try {
      ...
      // .csv for one lat,lon,time
      // 46012 -122.879997 37.360001
      String userDapQuery = "&longitude=-122.88&latitude=37.36&time%3E=2005-07-01&time%3C2005-07-01T10";
      String results = SSR.getUrlResponseStringUnchanged(
          EDStatic.erddapUrl + "/tabledap/" + datasetID + ".csv?" + userDapQuery);
      // String2.log(results);
      String expected = "longitude,latitude,altitude,time,station,wd,wspd,atmp,wtmp\n" +
          "degrees_east,degrees_north,m,UTC,,m s-1,m s-1,degree_C,degree_C\n" +
          "-122.88,37.36,0,2005-07-01T00:00:00Z,46012,294,2.6,12.7,13.4\n" +
          "-122.88,37.36,0,2005-07-01T01:00:00Z,46012,297,3.5,12.6,13.0\n" +
          "-122.88,37.36,0,2005-07-01T02:00:00Z,46012,315,4.0,12.2,12.9\n" +
  ...
  void testStandardizeWhat() throws Throwable {
    ...
    int language = 0;
    String dataDir = Path.of(EDDTestDataset.class.getResource("/data/ascii/").toURI()).toString() + "/";
    ...
    // String testColumns[], double testMin[], double testMax[],
    // String loadColumns[], boolean simplify) throws Exception {
    table.readASCII(dataDir + "standardizeWhat1.csv",
        "", "", "",
        0, 1, null,
        null, null, null,
        null, false);
  ...
  /**
   * This tests GenerateDatasetsXml with EDDTableFromInPort when there are child
   * entities.
   * This is the dataset Nazila requested (well, she requested 12866 and
   * this=26938, but
   * 12866 has no data).
   */
  @org.junit.jupiter.api.Test
  void testGenerateDatasetsXmlFromInPort2() throws Throwable {
    ...
    // testVerboseOn();
    String today = Calendar2.getCurrentISODateTimeStringZulu().substring(0, 10);
    String dataDir = Path.of(EDDTestDataset.class.getResource("/largeFiles/points/inportData/").toURI())
        .toString() + "/";
    String xmlFile = Path.of(EDDTestDataset.class
        .getResource("/largeFiles/points/inportXml/NOAA/NMFS/AFSC/inport-xml/xml/26938.xml")
        .toURI()).toString();
    String xmlFolder = Path.of(EDDTestDataset.class.getResource("/largeFiles/points/inportXml/").toURI())
        .toString() + "/";
    ...
    String expected = "<dataset type=\"EDDTableFromAsciiFiles\" datasetID=\"" + suggDatasetID
        ...
        "    <updateEveryNMillis>-1</updateEveryNMillis>\n" +
        "    <accessibleViaFiles>true</accessibleViaFiles>\n" +
        "    <fgdcFile>" + xmlFolder + "NOAA/NMFS/AFSC/fgdc/xml/26938.xml</fgdcFile>\n" +
        "    <iso19115File>" + xmlFolder
        ...
        + " (contact: erd.data@noaa.gov) converted inport-xml metadata from https://inport.nmfs.noaa.gov/inport-metadata/t-classes/largeFiles/points/inportXml/NOAA/NMFS/AFSC/inport-xml/xml/26938.xml into an ERDDAP dataset description.</att>\n"
        +
        "        <att name=\"infoUrl\">https://inport.nmfs.noaa.gov/inport-metadata/t-classes/largeFiles/points/inportXml/NOAA/NMFS/AFSC/inport-xml/xml/26938.xml</att>\n"
        +
        ...
        +
        "        <att name=\"InPort_xml_url\">https://inport.nmfs.noaa.gov/inport-metadata/t-classes/largeFiles/points/inportXml/NOAA/NMFS/AFSC/inport-xml/xml/26938.xml</att>\n"
        +
  ...
  void testTimeZone() throws Throwable {
    ...
    // the source file
    results = File2.readFromFile88591(
        Path.of(EDDTestDataset.class.getResource("/data/time/time_zone.txt").toURI())
            .toString())[1];
    expected = "timestamp_local,timestamp_utc,m\n" +
   ...
   * and tests if datasets.xml can be generated from csv file even if no
   * child-entity info.
  ...
  void testGenerateDatasetsXmlFromInPort() throws Throwable {
    ...
    String dataDir = Path.of(EDDTestDataset.class.getResource("/largeFiles/points/inportData/").toURI())
        .toString() + "/";
    String xmlDir = Path
        .of(EDDTestDataset.class.getResource(
            "/largeFiles/points/inportXml/NOAA/NMFS/AKRO/inport-xml/xml/").toURI())
        .toString() + "/";
    String inportXml = Path.of(EDDTestDataset.class.getResource("/largeFiles/points/inportXml/").toURI())
        .toString() + "/";
    ...
    String expected = "<dataset type=\"EDDTableFromAsciiFiles\" datasetID=\"" + suggDatasetID
        ...
        "    <updateEveryNMillis>-1</updateEveryNMillis>\n" +
        "    <accessibleViaFiles>true</accessibleViaFiles>\n" +
        "    <fgdcFile>" + inportXml + "NOAA/NMFS/AKRO/fgdc/xml/27377.xml</fgdcFile>\n" +
        "    <iso19115File>" + inportXml
        ...
        "2017-07-06T21:18:53Z Steve Lewis last modified InPort catalog-item-id #27377.\n" + // ERDDAP
                                                                                            ...
                                                                                            // line
        today + " GenerateDatasetsXml in ERDDAP v" + EDStatic.erddapVersion
        + " (contact: erd.data@noaa.gov) converted inport-xml metadata from https://inport.nmfs.noaa.gov/inport-metadata/t-classes/largeFiles/points/inportXml/NOAA/NMFS/AKRO/inport-xml/xml/27377.xml into an ERDDAP dataset description.</att>\n"
        +
        "        <att name=\"infoUrl\">https://inport.nmfs.noaa.gov/inport-metadata/t-classes/largeFiles/points/inportXml/NOAA/NMFS/AKRO/inport-xml/xml/27377.xml</att>\n"
        +
        ...
        +
        "        <att name=\"InPort_xml_url\">https://inport.nmfs.noaa.gov/inport-metadata/t-classes/largeFiles/points/inportXml/NOAA/NMFS/AKRO/inport-xml/xml/27377.xml</att>\n"
        +
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String suggDatasetID = EDDTableFromAsciiFiles.suggestDatasetID(dir + "31201_2009_NoComments\\.csv");
    String results = EDDTableFromAsciiFiles.generateDatasetsXml(
        dir, "31201_2009_NoComments\\.csv", "",
        File2.ISO_8859_1, 1, 3, "", -1,
        "", "_.*$", ".*", "stationID", // just for test purposes; station is already a column in
                                       // the file
        "time", "station time",
    ...
    String expected = "<!-- NOTE! Since the source files don't have any metadata, you must add metadata\n" +
        "  below, notably 'units' for each of the dataVariables. -->\n" +
        "<dataset type=\"EDDTableFromAsciiFiles\" datasetID=\"" + suggDatasetID
        + "\" active=\"true\">\n" +
    ...
    try {
      ...
      results = EDDTableFromAsciiFiles.generateDatasetsXml(
          dir, "31201_2009_NoComments\\.csv", "",
          File2.ISO_8859_1, 1, 3, "", -1,
          "", "_.*$", ".*", "stationID", // just for test purposes; station is already a
                                         // column in the file
          "time", "station time",
          "https://www.ndbc.noaa.gov/", "NOAA NDBC", "The new summary!",
          "The Newer Title!",
          -1, "", externalAddAttributes) + "\n";
  ...
  /**
   * testGenerateDatasetsXml2 - notably to test reloadEveryNMinutes and
   * testOutOfDate.
   */
  @org.junit.jupiter.api.Test
  ...
  void testGenerateDatasetsXmlWithMV() throws Throwable {
    ...
    Attributes externalAddAttributes = new Attributes();
    externalAddAttributes.add("title", "New Title!");
    String suggDatasetID = EDDTableFromAsciiFiles.suggestDatasetID(
        dataDir + "mvTest\\.csv");
    String results = EDDTableFromAsciiFiles.generateDatasetsXml(
        dataDir, "mvTest\\.csv", "",
