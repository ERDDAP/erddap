...
class EDDGridFromEDDTableTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String expected = "<dataset type=\"EDDGridFromEDDTable\" datasetID=\"erdNph_c2e8_7f71_e246\" active=\"true\">\n" +
  ...
  void testBasic() throws Throwable {
    ...
    expected = "String infoUrl \"ftp://ftp.nodc.noaa.gov/nodc/archive/arc0006/0002039/1.1/about/WCOS_project_document_phaseI_20060317.pdf\";\n"
        +
     ...
     */
    expected = "time,latitude,longitude,depth,Eastward,Eastward_flag,Northward,Northward_flag\n" +
  ...
  void testFiles() throws Throwable {
    ...
    try {
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testGridFromTable/gibberish/\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testGridFromTable/gibberish.csv\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testGridFromTable/2005/gibberish.csv\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
          "    message=\"Not Found: File not found: gibberish.csv .\";\n" +
