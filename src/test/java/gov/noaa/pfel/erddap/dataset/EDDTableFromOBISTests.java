...
class EDDTableFromOBISTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    try {
      results = EDDTableFromOBIS.generateDatasetsXml(
          "http://iobis.marine.rutgers.edu/digir2/DiGIR.php",
          "OBIS-SEAMAP", EDDTableFromOBIS.DEFAULT_RELOAD_EVERY_N_MINUTES, "dhyrenbach@duke.edu",
          null) + "\n";
  ...
  void testRutgers() throws Throwable {
    ...
    try {
      EDDTable obis = (EDDTable) EDDTableFromOBIS.oneFromDatasetsXml(null, "rutgersGhmp"); // should work
      ...
      results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
      // String2.log(results);
      expected = "longitude, latitude, time, ID, Genus, Species\n" +
  ...
  void testFishbase() throws Throwable {
    ...
    try {
      EDDTable fishbase = (EDDTable) EDDTableFromOBIS.oneFromDatasetsXml(null, "fishbaseObis"); // should work
      ...
      results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
      // String2.log(results);
      expected = "longitude, latitude, time, ID, Genus, Species, Citation\n" +
          "degrees_east, degrees_north, UTC, , , , \n" +
      ...
      // data for mapExample
      tName = fishbase.makeNewFileForDapQuery(language, null, null,
