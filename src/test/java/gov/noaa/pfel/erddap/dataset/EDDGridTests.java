...
class EDDGridTests {
    ...
    void testSaveAsImage() throws Throwable {
        ...
        tName = eddGrid.makeNewFileForDapQuery(language, null, null,
                MessageFormat.format(userDapQueryTemplate, -100, 40, 210, 220), // #'s are minLat, maxLat, minLon,
                                                                                // maxLon
                dir, baseName, ".transparentPng");
        Image2.testImagesIdentical(
                dir + tName,
        ...
        tName = eddGrid.makeNewFileForDapQuery(language, null, null,
                MessageFormat.format(userDapQueryTemplate, -100, 100, -200, 370), // #'s are minLat, maxLat, minLon,
                                                                                  // maxLon
                dir, baseName, ".transparentPng");
        Image2.testImagesIdentical(
                dir + tName,
