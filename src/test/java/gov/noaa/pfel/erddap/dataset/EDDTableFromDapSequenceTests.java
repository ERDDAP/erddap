...
class EDDTableFromDapSequenceTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String expected = "<dataset type=\"EDDTableFromDapSequence\" datasetID=\"dyndns_cimt_8cad_5f3b_717e\" active=\"true\">\n"
        +
  ...
  void testGenerateDatasetsXml2() throws Throwable {
    ...
    try {
      ...
      String tUrl = "http://localhost:8080/cwexperimental/tabledap/testNccsvScalar11.html"; // test that it removes
                                                                                            // .html
      String results = EDDTableFromDapSequence.generateDatasetsXml(tUrl, 1440, null) + "\n";

      String expected = "<dataset type=\"EDDTableFromDapSequence\" datasetID=\"localhost_6f85_6209_a3de\" active=\"true\">\n"
          +
      ...
      expected = "        <att name=\"infoUrl\">https://erddap.github.io/NCCSV.html</att>\n" +
  ...
  void testOneTime() throws Throwable {
    ...
    if (false) {
      // get summary string
      EDDTable tedd = (EDDTable) EDDTableFromDapSequence.oneFromDatasetsXml(null, "nwioosGroundfish");
  ...
  void testPsdac() throws Throwable {
    ...
    String expected = "time,longitude,latitude,depth,station,waterTemperature,salinity\n" +
      ...
      for (int outerRow = 0; outerRow < Math.min(5, nOuterRows); outerRow++) {
        ...
        for (int outerCol = 0; outerCol < outerVector.size(); outerCol++) {
          ...
          if (obt instanceof DByte t)
            ...
            sb.append(t.getValue());
          else if (obt instanceof DSequence t)
            sb.append("DSequence)");
          else
            sb.append(obt.getTypeName());
        }
  ...
  void testSubsetVariablesRange() throws Throwable {
    ...
    expected = "tabledap/nwioosCoral.das\";[10]\n" +
