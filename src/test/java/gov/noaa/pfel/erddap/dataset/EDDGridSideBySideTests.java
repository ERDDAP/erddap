...
class EDDGridSideBySideTests {
  ...
  /**
   * This tests the methods in this class (easy test since x and y should have
   * same time points).
   *
  ...
  void testQSStress() throws Throwable {
    ...
    results = File2.directReadFrom88591File(tDir + tName);
    // String2.log(results);
    expected = "time,altitude,latitude,longitude,taux,tauy\n" +
  ...
  /**
   * This tests allowing datasets with duplicate sourceNames (they would be in
   * different datasets).
   */
  @org.junit.jupiter.api.Test
  ...
  void testFiles() throws Throwable {
    ...
    expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/erdTAgeo1day/gibberish/\n"
        +
        "(Error {\n" +
        "    code=404;\n" +
    ...
    expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/erdTAgeo1day/gibberish.csv\n"
        +
        "(Error {\n" +
        "    code=404;\n" +
    ...
    expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/erdTAgeo1day/subdir/gibberish.csv\n"
        +
        "(Error {\n" +
        "    code=404;\n" +
        "    message=\"Not Found: File not found: gibberish.csv .\";\n" +
