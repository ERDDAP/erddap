    ...
    expected =
        EDStatic.config.generateCroissantSchema
            ? "{\n"
                ...
                + "    \"@id\": \"sampleCSV.jsonl\",\n"
                + "    \"contentSize\": \"633 B\",\n"
                + "    \"contentUrl\": \"http://localhost:8080/erddap/files/testJsonlCSV/sampleCSV.jsonl\",\n"
                + "    \"encodingFormat\": \"application/x-jsonlines\"\n"
                + "  },\n"
                + "  {\n"
                + "    \"@type\": \"cr:FileSet\",\n"
                + "    \"@id\": \"testJsonlCSVFiles\",\n"
                + "    \"description\": \"Files that contain the data.\",\n"
                + "    \"encodingFormat\": \"application/json\",\n"
                + "    \"includes\": \"http://localhost:8080/erddap/files/testJsonlCSV/*.*\"\n"
                + "  }\n"
                + "  ],\n"
                + "  \"recordSet\": [\n"
                + "    {\n"
