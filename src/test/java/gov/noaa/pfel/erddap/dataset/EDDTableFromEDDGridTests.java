...
class EDDTableFromEDDGridTests {
  ...
  void testBasic() throws Throwable {
    ...
    expected2 = "String infoUrl \"https://coastwatch.pfeg.noaa.gov/infog/MB_sstd_las.html\";\n" +
    ...
    expected = "Caught: com.cohort.util.SimpleException: Your query produced no matching results. " +
    ...
    results = File2.directReadFrom88591File(dir + tName);
    expected = "latitude,longitude,altitude,time\n" +
    ...
    expected = "Caught: com.cohort.util.SimpleException: Query error: Unrecognized variable=\"chlorophyll\".";
    Test.ensureEqual(results, expected, "results=\n" + results);
    ...
    tName = tedd.makeNewFileForDapQuery(language, null, null, query, dir,
        tedd.className() + "allaxes", ".csv");
    results = File2.directReadFrom88591File(dir + tName);
    expected = "latitude,longitude,altitude,time,sst\n" +
    ...
    expected = "Caught: com.cohort.util.SimpleException: Your query produced too much data.  Try to request less data. [memory]: "
        +
  ...
  void testInErddap() throws Throwable {
    ...
    // "longitude,latitude&latitude>20&latitude<=20.1" +
        ...
        "&longitude%3E=215&longitude%3C215.1&time=%222008-02-15T12%22"); // time constraint is ignored (since it's
                                                                         // valid)
    expected = "longitude,latitude\n" +
        "degrees_east,degrees_north\n" +
        "215.0,20.025\n" +
    ...
    expected = "Caught: java.io.IOException: HTTP status code=413 for URL: " +
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String results = EDDTableFromEDDGrid.generateDatasetsXml(language, url, regex, Integer.MAX_VALUE) + "\n";

    String expected = "<dataset type=\"EDDTableFromEDDGrid\" datasetID=\"erdMBsstdmday_AsATable\" active=\"true\">\n" +
        "    <addAttributes>\n" +
   ...
   * This requires erdMBsstdmday and erdMBsstdmday_AsATable in the localhost
   * ERDDAP.
   */
  @org.junit.jupiter.api.Test
  @TagLocalERDDAP
  void testFiles() throws Throwable {
    ...
    try {
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/erdMBsstdmday_AsATable/gibberish/\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/erdMBsstdmday_AsATable/gibberish.csv\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
