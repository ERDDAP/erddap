...
class EDDTableFromThreddsFilesTests {
  ...
  void testShipWTEP(boolean deleteCachedInfo) throws Throwable {
    ...
    if (deleteCachedInfo)
      EDDTableFromThreddsFiles.deleteCachedDatasetInfo(id);
    ...
    try {
      ...
      expected = // 2019-11-22 ~2 dozen small changes to centerline, precision, instrument,
          ...
          "Attributes \\{\n" +
              ...
              (with ? "    String average_center \"time at end of period\";\n"
                  +
                  "    Int16 average_length 60;\n" +
                  "    String average_method \"average\";\n" +
                  "    Float32 centerline_offset 0.0;\n" +
              ...
              "    Int32 qcindex 15;\n" +
              (with ? "    Float32 sampling_rate [0-9.]+;\n" +
                  "    String serial_number \"157\";\n" +
                  "    Float32 special_value -8888.0;\n" : "")
              +
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    // String2.log(results);
    expected = "time,latitude,longitude,airPressure,airTemperature,flag\n" +
  ...
  void testGetThreddsFileInfo() throws Throwable {
    ...
    if (true) {
      ...
      expected = "https://tds.coaps.fsu.edu/thredds/dodsC/samos/data/quick/WTEP/2011/\n" +
      ...
      expected = "WTEP_20110821v10001.nc\n" +
    ...
    if (true) {
      ...
      results = fileDir.toNewlineString();
      expected = "https://data.nodc.noaa.gov/thredds/dodsC/nmsp/wcos/SMS/2004/\n" +
      ...
      results = fileName.toNewlineString();
      expected = "SMSXXX_015ADCP015R00_20041130.nc\n" +
  ...
  /**
   * This tests the methods in this class.
   * 2020-10-21 I stopped running this test because thredds randomly stalls when
   * returning catalog.xml pages.
   *
   * @throws Throwable if trouble
   */
  @ParameterizedTest
  ...
  void testWcosTemp(boolean deleteCachedInfo) throws Throwable {
    ...
    expected = "station,longitude,latitude,time,depth,Temperature,Temperature_flag\n" +
