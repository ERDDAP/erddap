...
class EDDTableFromNccsvFilesTests {
  ...
  void testBasic(boolean deleteCachedDatasetInfo) throws Throwable {
    ...
    if (deleteCachedDatasetInfo)
      EDDTableFromNccsvFiles.deleteCachedDatasetInfo(id);
    ...
    expected = "http://127.0.0.1:8080/cwexperimental/tabledap/testNccsvScalar11.das\";\n" +
    ...
    // String2.log(results);
    expected = "ship,time,latitude,longitude,status,testByte,testUByte,testLong,testULong,sst\n" +
    ...
    results = File2.directReadFromUtf8File(dir + tName);
    // String2.log(results);
    expected = "*GLOBAL*,Conventions,\"COARDS, CF-1.10, ACDD-1.3, NCCSV-1.2\"\n" +
  ...
  void testChar() throws Throwable {
    ...
    results = File2.directReadFrom88591File(dir + tName);
    // String2.log(results);
    expected = "ship,time (UTC),latitude (degrees_north),longitude (degrees_east),status,testByte (1),testUByte (1),testLong (1),testULong (1),sst (degree_C)\n"
        +
        "\" a\\t~\\u00fc,\\n'z\"\"\\u20ac\",2017-03-23T00:45:00Z,28.0002,-130.2576,A,-128,0,-9223372036854775808,0,10.9\n"
        +
        "\" a\\t~\\u00fc,\\n'z\"\"\\u20ac\",2017-03-23T01:45:00Z,28.0003,-130.3472,\"\\u20ac\",0,127,-9007199254740992,9223372036854775807,10.0\n"
    ...
    results = File2.directReadFrom88591File(dir + tName);
    // String2.log(results);
    expected = "ship,date,time,Y,X,status,testByte,testUByte,testLong,testULong,sst\n" +
    ...
    // String2.log(results);
    expected = "netcdf EDDTableFromNccsvFiles_char.nc {[10]\n" +
        "  dimensions:[10]\n" +
        "    row = 6;[10]\n" +
        "    ship_strlen = 11;[10]\n" +
        "  variables:[10]\n" +
    ...
    expected = "http://127.0.0.1:8080/cwexperimental/tabledap/testNccsvScalar11.nc\";[10]\n" +
    ...
    expected = "http://127.0.0.1:8080/cwexperimental/tabledap/testNccsvScalar11.ncCF\";[10]\n" +
        "  :id = \"testNccsvScalar11\";[10]\n" +
        "  :infoUrl = \"https://erddap.github.io/NCCSV.html\";[10]\n" +
        "  :institution = \"NOAA NMFS SWFSC ERD, NOAA PMEL\";[10]\n" +
        "  :keywords = \"center, data, demonstration, Earth Science > Oceans > Ocean Temperature > Sea Surface Temperature, environmental, erd, fisheries, identifier, laboratory, latitude, long, longitude, marine, national, nccsv, nmfs, noaa, ocean, oceans, pacific, pmel, science, sea, sea_surface_temperature, service, ship, southwest, sst, status, surface, swfsc, temperature, test, testLong, time, trajectory\";[10]\n"
    ...
    expected = "http://127.0.0.1:8080/cwexperimental/tabledap/testNccsvScalar11.ncCFMA\";[10]\n" +
        "  :id = \"testNccsvScalar11\";[10]\n" +
        "  :infoUrl = \"https://erddap.github.io/NCCSV.html\";[10]\n" +
        "  :institution = \"NOAA NMFS SWFSC ERD, NOAA PMEL\";[10]\n" +
        "  :keywords = \"center, data, demonstration, Earth Science > Oceans > Ocean Temperature > Sea Surface Temperature, environmental, erd, fisheries, identifier, laboratory, latitude, long, longitude, marine, national, nccsv, nmfs, noaa, ocean, oceans, pacific, pmel, science, sea, sea_surface_temperature, service, ship, southwest, sst, status, surface, swfsc, temperature, test, testLong, time, trajectory\";[10]\n"
    ...
    // String2.log(results);
    expected = "//<Creator>https://erddap.github.io/NCCSV.html</Creator>[10]\n" +
    ...
    // String2.log(results);
    expected = "ship[9]time[9]latitude[9]longitude[9]status[9]testByte[9]testUByte[9]testLong[9]testULong[9]sst[10]\n" +
    ...
    results = String2.annotatedString(File2.directReadFrom88591File(dir + tName));
    // String2.log(results);
    expected = "ship[9]time (UTC)[9]latitude (degrees_north)[9]longitude (degrees_east)[9]status[9]testByte (1)[9]testUByte (1)[9]testLong (1)[9]testULong (1)[9]sst (degree_C)[10]\n"
        +
        "\" a\\t~\\u00fc,\\n'z\\\"\\u20ac\"[9]2017-03-23T00:45:00Z[9]28.0002[9]-130.2576[9]A[9]-128[9]0[9]-9223372036854775808[9]0[9]10.9[10]\n"
        +
        "\" a\\t~\\u00fc,\\n'z\\\"\\u20ac\"[9]2017-03-23T01:45:00Z[9]28.0003[9]-130.3472[9]\"\\u20ac\"[9]0[9]127[9]-9007199254740992[9]9223372036854775807[9]10.0[10]\n"
    ...
    results = String2.annotatedString(
        File2.directReadFromUtf8File(dir + tName));
    // String2.log(results);
    expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>[10]\n" +
  ...
  void testActualRange() throws Throwable {
    ...
    expected2 = "http://127.0.0.1:8080/cwexperimental/tabledap/pmelTaoDySst.nccsv?&station=%220n125w%22&time%3E=2010-01-01&time%3C=2010-01-05\"\n"
        +
        "*GLOBAL*,infoUrl,https://www.pmel.noaa.gov/gtmba/mission\n" +
        "*GLOBAL*,institution,\"NOAA PMEL, TAO/TRITON, RAMA, PIRATA\"\n" +
        "*GLOBAL*,keywords,\"buoys, centered, daily, depth, Earth Science > Oceans > Ocean Temperature > Sea Surface Temperature, identifier, noaa, ocean, oceans, pirata, pmel, quality, rama, sea, sea_surface_temperature, source, station, surface, tao, temperature, time, triton\"\n"
