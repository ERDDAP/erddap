 ...
 * These aren't actually slow tests, but they fail/change so often that it
 * usually isn't worth the time to test.
 * Stated the other way: the problems usually aren't ERDDAP problems.'
 * 
 * So until these are significantly updated they are likely to be flaky.
 */
class EDDTableFromSOSTests {
  ...
  void testNosSosATemp() throws Throwable {
    ...
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,air_temperature,quality_flags\n" +
    ...
    expected = "    Float64 Southernmost_Northing -14.2767;\n" +
...
int language = 0;
  ...
  void testNosSosATempStationList() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id\n" +
  ...
  void testNosSosCond() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,conductivity,quality_flags\n" +
  ...
  private static void testFindValidStation(EDDTable eddTable, String stations[],
  ...
  void testNosSosCurrents() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,sensor_depth,direction_of_sea_water_velocity,sea_water_speed,platform_orientation,platform_pitch_angle,platform_roll_angle,sea_water_temperature,orientation,sampling_rate,reporting_interval,processing_level,bin_size,first_bin_center,number_of_bins,bin\n"
        +
  ...
  void testNosSosWind() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,wind_from_direction,wind_speed,wind_speed_of_gust\n"
        +
  ...
  void testNosSosWTemp() throws Throwable {
    ...
    tName = eddTable.makeNewFileForDapQuery(language, null, null,
        ...
        EDStatic.fullTestCacheDirectory, eddTable.className() + "_nosSosWTemp", ".csv");
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,sea_water_temperature,quality_flags\n" +
        "degrees_east,degrees_north,,m,UTC,,degree_C,\n" +
  ...
  /**
   * This should work, but server is in flux so it often breaks.
   * Note: starting in 2009, there is a test server at
   * https://sdftest.ndbc.noaa.gov/sos/ .
   * 
   * @throws Throwable if trouble
   */
  @org.junit.jupiter.api.Test
  ...
  void testNdbcSosCurrents() throws Throwable {
    ...
    expected = "-87.944,29.108,urn:ioos:station:wmo:42376,-952.8,2008-06-01T14:23:00Z,urn:ioos:sensor:wmo:42376::adcp0,29,89,4.0,0.5,0.0,NaN,NaN,NaN,NaN,100,0,0,NaN,74,75,96,48,236,237,NaN,239,2;9;2;3;9;3;3;3;2\n"
        +
  ...
  void testNdbcSosSalinity() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,sea_water_salinity\n" +
        "degrees_east,degrees_north,,m,UTC,,PSU\n" +
  ...
  void testNdbcSosLongTime() throws Throwable {
    ...
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,sea_water_temperature\n" +
        "degrees_east,degrees_north,,m,UTC,,degree_C\n" +
  ...
  void testNdbcSosWLevel() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    expected = "longitude,latitude,station_id,altitude,time,sensor_id,averaging_interval\n" +
  ...
  void testNdbcSosWindQuickRestart() throws Throwable {
    ...
    String qrName = File2.forceExtension(EDDTableFromSOS.quickRestartFullFileName("ndbcSosWind"), ".xml");
  ...
  void testOostethys() throws Throwable {
    ...
    String name, tName, results, expected, userDapQuery;
    String error = "";
    String today = Calendar2.getCurrentISODateTimeStringZulu().substring(0, 14); // 14 is enough to check hour. Hard to
                                                                                 // check min:sec.
  ...
  void testNeracoos() throws Throwable {
    ...
    results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
    // String2.log(results);
    expected = "longitude,latitude,station_id,altitude,time,air_temperature,chlorophyll,direction_of_sea_water_velocity,dominant_wave_period,sea_level_pressure,sea_water_density,sea_water_electrical_conductivity,sea_water_salinity,sea_water_speed,sea_water_temperature,wave_height,visibility_in_air,wind_from_direction,wind_gust,wind_speed\n"
        +
        "degrees_east,degrees_north,,m,UTC,degree_C,mg m-3,degrees_true,s,hPa,kg m-3,S m-1,PSU,cm s-1,degree_C,m,m,degrees_true,m s-1,m s-1\n"
        +
        "-70.5652267750436,42.5227725835475,A01,4.0,2007-12-11T00:00:00Z,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,332.100006103516,3.94600009918213,3.36700010299683\n"
   ...
   * These tests are in EDDTableFromSOS because EDDTableFromFiles has a separate
   * test.
   *
   * @throws Throwable if trouble
   */
  ...
  void testGcoos52N() throws Throwable {
    ...
    String2.log(EDDTableFromSOS.generateDatasetsXmlFromOneIOOS(useCachedInfo,
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String results = EDDTableFromSOS.generateDatasetsXml(useCachedInfo,
        "https://sdf.ndbc.noaa.gov/sos/server.php", "1.0.0", "IOOS_NDBC") +
        "\n";

    String expected1 = "<!-- You have to choose which observedProperties will be used for this dataset.\n" +
        "\n" +
        "\n" +
    ...
    String expected2 = " id  ObservedProperty\n" +
        "---  --------------------------------------------------\n" +
  ...
  /**
   * Test generateDatasetsXmlFromIOOS. Their example from
  ...
  void testGenerateDatasetsXmlFromOneIOOS() throws Throwable {
    ...
    int language = 0;
    String results = EDDTableFromSOS.generateDatasetsXmlFromOneIOOS(useCachedInfo,
  ...
  void testGenerateDatasetsXmlFromIOOS() throws Throwable {
    ...
    int language = 0;
    String results = EDDTableFromSOS.generateDatasetsXmlFromIOOS(useCachedInfo,
        "https://sdf.ndbc.noaa.gov/sos/server.php", "1.0.0", "IOOS_NDBC");
    String expected = expectedTestGenerateDatasetsXml(
  ...
  private static String expectedTestGenerateDatasetsXml(String tInfoUrl,
    ...
    boolean isIoos52N = tSosServerType.toLowerCase().equals(
        EDDTableFromSOS.SosServerTypeIoos52N.toLowerCase());
    return "<dataset type=\"EDDTableFromSOS\" datasetID=\"noaa_ndbc_12f6_3b52_fb14\" active=\"true\">\n" +
        ...
        (whichObsProp.equals("air_temperature") ? "    <dataVariable>\n" +
  ...
  void testGetPhenomena() throws Throwable {
    ...
    EDDTableFromSOS.getPhenomena("https://ioos.github.io/sos-dif/gml/IOOS/0.6.1/dictionaries/phenomenaDictionary.xml",
        hashMap);
  ...
  void testErddapSos() throws Throwable {
    ...
    try {
      ...
      results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
      // String2.log(results);
      expected = "longitude,latitude,altitude,station_id,wvht,dpd,wtmp,dewp\n" +
      ...
      results = File2.directReadFrom88591File(EDStatic.fullTestCacheDirectory + tName);
      // String2.log(results);
      expected = "longitude,latitude,wtmp\n" +
