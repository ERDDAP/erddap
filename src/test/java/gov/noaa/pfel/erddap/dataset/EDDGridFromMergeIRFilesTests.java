...
class EDDGridFromMergeIRFilesTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String dataDir = Path.of(EDDGridFromMergeIRFilesTests.class.getResource("/largeFiles/mergeIR/").toURI()).toString();
    String results = EDDGridFromMergeIRFiles.generateDatasetsXml(
        dataDir,
        "merg_[0-9]{10}_4km-pixel\\.gz", -1,
        "") + "\n"; // cacheFromUrl

    // GenerateDatasetsXml
    String gdxResults = (new GenerateDatasetsXml()).doIt(new String[] { "-verbose",
        "EDDGridFromMergeIRFiles", dataDir,
    ...
    String expected = "<dataset type=\"EDDGridFromMergeIRFiles\" datasetID=\"mergeIR\" active=\"true\">\n" +
        ...
        "            <att name=\"missing_value\" type=\"short\">" + EDDGridFromMergeIRFiles.IR_MV + "</att>\n" +
        ...
        "            <att name=\"missing_value\" type=\"double\">" + EDDGridFromMergeIRFiles.FLUX_MV + "</att>\n" +
  ...
  void testMergeIR() throws Throwable {
    ...
    expected = "Attributes {\n" +
        ...
        "    Int16 missing_value " + EDDGridFromMergeIRFiles.IR_MV + ";\n" +
        ...
        "    Float64 missing_value " + EDDGridFromMergeIRFiles.FLUX_MV + ";\n" +
    ...
    String expected2 = "/erddap/griddap/mergeIR.das\";\n" +
