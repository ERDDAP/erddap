...
class EDDTableFromErddapTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String expected = "<dataset type=\"EDDTableFromErddap\" datasetID=\"erdGlobecBottle\" active=\"true\">\n" +
    ...
    expected = "<!-- Of the datasets above, the following datasets are EDDTableFromErddap's at the remote ERDDAP.\n";
  ...
  void testDegreesSignAttribute() throws Throwable {
    ...
    EDDTable edd = (EDDTableFromErddap) EDDTableFromErddap.oneFromDatasetsXml(null, "testCalcofiSurFromErddap");
    // String2.log(edd.toString());
  ...
  void testTableNoIoosCat() throws Throwable {
    ...
    expected = "trajectory,time,altitude,latitude,longitude,temperature,conductivity,salinity,density,pressure,dive_number\n"
        +
    ...
    expected = "[\"sg_114_003\", \"2008-12-10T19:41:02Z\", -7.02, 21.238798, -157.86617, 25.356133, 5.337507, 34.952133, 1023.1982, 7.065868, 568]\n"
        +
        "[\"sg_114_003\", \"2008-12-10T19:41:08Z\", -6.39, 21.238808, -157.86618, 25.353163, 5.337024, 34.951065, 1023.1983, 6.4317517, 568]\n"
        +
        "[\"sg_114_003\", \"2008-12-10T19:41:14Z\", -5.7, 21.238813, -157.86618, 25.352034, 5.337048, 34.95233, 1023.1996, 5.737243, 568]\n"
   ...
   * &lt;dataset type="EDDTableFromErddap" datasetID="ChukchiSea_454a_037a_fcf4"
   * active="true"&gt;
  ...
  void testFiles() throws Throwable {
    ...
    try {
      ...
      expected = "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: http://localhost:8080/cwexperimental/files/testTableFromErddap/gibberish/\n"
          +
          "(Error {\n" +
          "    code=404;\n" +
      ...
      expected = "java.io.IOException: ERROR from url=http://localhost:8080/cwexperimental/files/testTableFromErddap/gibberish.csv : "
          +
      ...
      expected = "java.io.IOException: ERROR from url=http://localhost:8080/cwexperimental/files/testTableFromErddap/subdir/gibberish.csv : "
          +
          "java.io.IOException: HTTP status code=404 java.io.FileNotFoundException: " +
