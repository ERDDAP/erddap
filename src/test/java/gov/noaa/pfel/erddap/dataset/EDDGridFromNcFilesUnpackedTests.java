...
class EDDGridFromNcFilesUnpackedTests {
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    expected = "<dataset type=\"EDDGridFromNcFilesUnpacked\" datasetID=\"" + suggDatasetID + "\" active=\"true\">\n"
        +
  ...
  void testUInt16File() throws Throwable {
    ...
    String fileDir = Path.of(EDDGridFromNcFilesUnpackedTests.class.getResource("/data/unsigned/").toURI()).toString()
        + "/";
    ...
    results = EDDGridFromNcFilesUnpacked.generateDatasetsXml(fileDir, fileName, "",
        "", // group
        "", -1, "", null);
    expected = "<dataset type=\"EDDGridFromNcFilesUnpacked\" datasetID=\"unsigned_d448_5210_7aa6\" active=\"true\">\n"
  ...
  void testMissingValue() throws Throwable {
    ...
    String today = Calendar2.getCurrentISODateTimeStringZulu() + "Z";
    String tDir = EDStatic.fullTestCacheDirectory;
    String fileDir = Path.of(EDDGridFromNcFilesUnpackedTests.class.getResource("/data/unpacked/").toURI()).toString()
        + "/";
