...
class EDDTableFromColumnarAsciiFilesTests {
  ...
  void testGenerateDatasetsXmlFromEML() throws Throwable {
    ...
    String results = EDDTableFromColumnarAsciiFiles.generateDatasetsXmlFromEML(
    ...
    String expected = "<dataset type=\"EDDTableFromAsciiFiles\" datasetID=\"knb_lter_sbc_6_t1\" active=\"true\">\n"
        +
    ...
    expected = "site_code,time,NH4_uM,NO3_uM,PO4_uM,TDN_uM,TDP_uM,TPC_uM,TPN_uM,TPP_uM,TSS_mg_per_L,Spec_Cond_uS_per_cm\n"
        +
  ...
  void testGenerateDatasetsXml() throws Throwable {
    ...
    String testResourceDir = Path.of(EDDTableFromColumnarAsciiFilesTests.class.getResource("/data/").toURI())
        .toString()
        + "/";
    ...
    String results = EDDTableFromColumnarAsciiFiles.generateDatasetsXml(
    ...
    String expected = "<!-- NOTE! Since the source files don't have any metadata, you must add metadata\n" +
        ...
        "    <fileDir>" + testResourceDir + "</fileDir>\n" +
  ...
  void testGlerl() throws Throwable {
    ...
    String dataDir = Path.of(EDDTableFromColumnarAsciiFilesTests.class.getResource("/data/").toURI()).toString();

    // one time for avg temp
    results = (new GenerateDatasetsXml()).doIt(new String[] { "-verbose",
        "EDDTableFromColumnarAsciiFiles",

        dataDir + "/ascii/", "glsea-temps1995.dat", // avg temp
        "", "", "8", "11", // avg temp
        "10080", "", "", "", "",
        "",
    ...
    results = (new GenerateDatasetsXml()).doIt(new String[] { "-verbose",
        "EDDTableFromColumnarAsciiFiles",
        dataDir + "/glerl/", "g2008_2009_ice.dat", // ice
        "", "", "6", "9", // ice
        "10080", "", "", "", "",
        "",
        "https://coastwatch.glerl.noaa.gov/statistic/statistic.html", "NOAA GLERL",
    ...
    results = File2.directReadFrom88591File(testDir + tName);
    // String2.log(results);
    expected = "time,Superior,Michigan,Huron,Erie,Ontario,St_Clair\n" +
    ...
    expected = "2015-12-26T00:00:00Z,4.06,5.89,5.99,7.33,7.02,6.24\n" +
    ...
    results = File2.directReadFrom88591File(testDir + tName);
    // String2.log(results);
    expected = "time,Superior,Michigan,Huron,Erie,Ontario,St_Clair,GL_Total\n" +
   ...
   * Test file is from
   * https://coastwatch.glerl.noaa.gov/statistic/statistic.html
   * then clicking on "Long term average surface water temperature (Data)"
   * 1992/2014 Superior to get
  ...
  void testGlerl2() throws Throwable {
    ...
    results = File2.directReadFrom88591File(testDir + tName);
    // String2.log(results);
    expected = "lake,dayOfYear,temperature\n" +
        ",count,degree_C\n" +
        "s,1,3.3175\n" +
        "s,2,3.2395\n" +
        "s,3,3.2215\n" +
