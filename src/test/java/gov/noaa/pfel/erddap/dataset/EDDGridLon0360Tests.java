...
class EDDGridLon0360Tests {
  ...
  /**
   * This tests a dataset that is initially -180.018 to 180.018 (min and max
   * beyond bounds are dropped by this dataset)
   *
   * @throws Throwable if trouble
   */
  @org.junit.jupiter.api.Test
  ...
  void testPM181() throws Throwable {
    ...
    expected = "    Float64 geospatial_lon_max 359.98125;\n" +
    ...
    results = File2.directReadFrom88591File(dir + tName);
    results = String2.replaceAll(results, "\n", ", ");
    expected = "longitude, degrees_east, 0.018749999999981976, 37.51874999999998, 75.01874999999998, 112.51874999999998, 150.01874999999998, 187.51874999999998, 225.01874999999998, 262.51874999999995, 300.01874999999995, 337.51874999999995, ";
    Test.ensureEqual(results, expected, "results=\n" + results);
    ...
    results = File2.directReadFrom88591File(dir + tName);
    results = String2.replaceAll(results, "\n", ", ");
    expected = "longitude, degrees_east, 179.94374999999997, 179.98125, 180.01874999999998, 180.05624999999998, ";
    Test.ensureEqual(results, expected, "results=\n" + results);
    ...
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(27.0188):1:(26.99)][(0.98):1900:(359.98)]"; // 2022=08-17
                                                                                                   // was
                                                                                                   // 2021-07-14,
                                                                                                   // 2022-08-17
                                                                                                   // was
    ...
    // 0-180 subset
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(27.0188):1:(26.99)][(0.98):1900:(179.9)]"; // beginTime
                                                                                                  // of
                                                                                                  // this
                                                                                                  // and
                                                                                                  // other
    ...
    expected = "time,altitude,latitude,longitude,chlor_a\n" +
        "UTC,m,degrees_north,degrees_east,mg m^-3\n" +
        "2023-02-28T12:00:00Z,0.0,27.01875,0.9937499999999819,NaN\n" + //
        "2023-02-28T12:00:00Z,0.0,27.01875,72.24374999999998,NaN\n" + //
    ...
    // "all from new left"
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(27.0188):1:(26.99)][(0.98):1900:(181)]"; // beginTime
                                                                                                // of this
                                                                                                // and
                                                                                                // other
                                                                                                // star.nesdis
    ...
    // 180-360 subset
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(27.0188):1:(26.99)][(214.74):1900:(359.98)]"; // beginTime
                                                                                                     // of
                                                                                                     // this
                                                                                                     // and
                                                                                                     // other
    ...
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][][]&.land=under"; // beginTime of this and other
                                                                        // star.nesdis
    ...
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(71):(-61)][(120):(245)]&.land=under"; // beginTime of
                                                                                             // this
                                                                                             // and
                                                                                             // other
                                                                                             // star.nesdis
    ...
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(41):(-61)][(10):(175)]&.land=under"; // beginTime of
                                                                                            // this and
                                                                                            // other
                                                                                            // star.nesdis
                                                                                            // datasets
    ...
    userDapQuery = "chlor_a[(2023-02-28T12:00:00Z)][][(41):(-61)][(190):(355)]&.land=under"; // beginTime of
                                                                                             // this
                                                                                             // and
                                                                                             // other
                                                                                             // star.nesdis
  ...
  /**
   * This tests that longitude valid_min and valid_max in child are removed by
   * constructor,
  ...
  void testValidMinMax() throws Throwable {
    ...
    expected = "Float64 geospatial_lon_max 244.32899808000002;\n" +
  ...
  void testPM180() throws Throwable {
    ...
    expected = "    Float64 geospatial_lon_max 359.98333333333335;\n" +
    ...
    results = File2.directReadFrom88591File(dir + tName);
    results = String2.replaceAll(results, "\n", ", ");
    expected = "longitude, degrees_east, 179.93333333333334, 179.95, 179.96666666666664, 179.98333333333335, 180.0, 180.01666666666668, 180.03333333333333, 180.05, 180.06666666666666, ";
    Test.ensureEqual(results, expected, "results=\n" + results);
  ...
  void testInsert() throws Throwable {
    ...
    expected = "    Float64 geospatial_lon_max 359.5;\n" +
    ...
    results = File2.directReadFrom88591File(dir + tName);
    // String2.log(results);
    expected = "time,latitude,longitude,sst\n" +
        "UTC,degrees_north,degrees_east,C\n" +
        "2020-12-16T12:00:00Z,-33.5,0.5,19.392572\n" +
        "2020-12-16T12:00:00Z,-33.5,20.5,NaN\n" +
        "2020-12-16T12:00:00Z,-34.5,0.5,18.77771\n" +
