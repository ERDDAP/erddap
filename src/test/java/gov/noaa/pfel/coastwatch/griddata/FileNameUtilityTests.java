...
class FileNameUtilityTests {
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(FileNameUtility.getTimePeriodNHours("LAHsstdS25hour_20010331150000_x225_X255_y22_Y50"), 25, "");
    Test.ensureEqual(FileNameUtility.getTimePeriodNHours("LAHsstdS33hour_20010331150000_x225_X255_y22_Y50"), 33, "");
    Test.ensureEqual(FileNameUtility.getTimePeriodNHours("LAHsstdS3day_20010310120000_x225_X255_y22_Y50"), 3 * 24, "");
    Test.ensureEqual(FileNameUtility.getTimePeriodNHours("LAHsstdSmday_20010116120000_x225_X255_y22_Y50"), 30 * 24, "");
    Test.ensureEqual(FileNameUtility.getTimePeriodNHours("LAHsstdS1year_200100701_x225_X255_y22_Y50"), 365 * 24, "");

    // test convertDaveNameToCWBrowserName
    // composite, westus center day 3/10 => 31 + 28 + 10 = 69
    Test.ensureEqual(FileNameUtility.convertDaveNameToCWBrowserName(
    ...
    for (int i = 0; i < names.length; i++) {
      ...
      Test.ensureEqual(FileNameUtility.getTimePeriodString(names[i]), "mday", "getTimePeriodString");
      Test.ensureEqual(FileNameUtility.getRawDateString(names[i]), "20030116120000", "getRawDateString");
      Test.ensureEqual(FileNameUtility.getCenteredCalendar(names[i]),
          Calendar2.newGCalendarZulu(2003, 1, 16, 12, 0, 0, 0), "getCenteredCalendar");
      Test.ensureEqual(FileNameUtility.getEndCalendar(names[i]),
          Calendar2.newGCalendarZulu(2003, 2, 1, 0, 0, 0, 0), "getEndCalendar");
      Test.ensureEqual(FileNameUtility.getTimePeriodNHours(names[i]), 30 * 24, "getTimePeriodNHours");
      Test.ensureEqual(FileNameUtility.getStartCalendar(names[i]).getTimeInMillis(),
      ...
      Test.ensureEqual(fnu.getBoldTitle(names[i]), "SST, NOAA POES AVHRR, LAC, 0.0125 degrees, West US, Day and Night",
          "getBoldTitle");
      ...
      Test.ensureEqual(FileNameUtility.getConventions(), "COARDS, CF-1.6, ACDD-1.3, CWHDF", "getConvention");
      Test.ensureEqual(FileNameUtility.getMetadataConventions(), "COARDS, CF-1.6, ACDD-1.3, CWHDF",
          "getMetadataConvention");
      Test.ensureEqual(fnu.getAbstract(names[i]),
          ...
          "getAbstract");
      Test.ensureEqual(fnu.getKeywords(names[i]),
          "EARTH SCIENCE > Oceans > Ocean Temperature > Sea Surface Temperature", "getKeywords");
      Test.ensureEqual(FileNameUtility.getNamingAuthority(), "gov.noaa.pfeg.coastwatch", "getNamingAuthority");
      Test.ensureEqual(FileNameUtility.getKeywordsVocabulary(), "GCMD Science Keywords", "getKeywordsVocabulary");
      Test.ensureEqual(FileNameUtility.getCDMDataType(), "Grid", "getCDMDataType");
      String2.log("history=" + fnu.getHistory(names[i]));
      Test.ensureTrue(fnu.getHistory(names[i]).startsWith("NOAA NWS Monterey and NOAA CoastWatch\n20"), "getHistory"); // changes
                                                                                                                       // every
                                                                                                                       // year
      Test.ensureTrue(fnu.getHistory(names[i]).endsWith("NOAA CoastWatch (West Coast Node) and NOAA SWFSC ERD"),
          "getHistory");
      Test.ensureEqual(FileNameUtility.getDateCreated(), Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()),
          "getDateCreated");
      Test.ensureEqual(FileNameUtility.getCreatorName(), "NOAA CoastWatch, West Coast Node", "getCreatorName");
      Test.ensureEqual(FileNameUtility.getCreatorURL(), "https://coastwatch.pfeg.noaa.gov", "getCreatorURL");
      ...
      Test.ensureEqual(FileNameUtility.getProject(), "CoastWatch (https://coastwatch.noaa.gov/)", "getProject");
      Test.ensureEqual(FileNameUtility.getProcessingLevel(), "3 (projected)", "getProcessingLevel");
      Test.ensureEqual(FileNameUtility.getAcknowledgement(), "NOAA NESDIS COASTWATCH, NOAA SWFSC ERD",
          "getAcknowledgement");
      ...
      Test.ensureEqual(FileNameUtility.getStandardNameVocabulary(), "CF Standard Name Table v70",
          "getStandardNameVocabulary");
      Test.ensureEqual(FileNameUtility.getLicense(),
      ...
      Test.ensureEqual(FileNameUtility.getContributorRole(), "Source of level 2 data.", "getContributorRole");
    ...
    Test.ensureEqual(FileNameUtility.getID("LATsstaSmday_20030116120000_x-135_X-105_y22_Y50"), desired, "");
    Test.ensureEqual(FileNameUtility.getID("LATsstaSmday_20030116120000_x-135_X-105_y22_Y50.mat"), desired, "");
    Test.ensureEqual(FileNameUtility.getID("LATsstaSmday_20030116120000_x-135_X-105_y22_Y50_other_stuff"), desired, "");
    ...
    Test.ensureEqual(fnu.getFGDCInfo(name2, "<metadata><idinfo><descript><abstract>"),
        "NOAA CoastWatch provides sea surface temperature (SST) products derived from NOAA's Polar Operational Environmental Satellites (POES).  This data is provided at high resolution (0.0125 degrees) for the North Pacific Ocean.  Measurements are gathered by the Advanced Very High Resolution Radiometer (AVHRR) instrument, a multiband radiance sensor carried aboard the NOAA POES satellites.",
        "getFGDCInfo 2");
    Test.ensureEqual(FileNameUtility.getRawDateString(name2), "20030110000000", "getRawDateString 2");
    Test.ensureEqual(FileNameUtility.getCenteredCalendar(name2),
        Calendar2.newGCalendarZulu(2003, 1, 10, 0, 0, 0, 0), "getCenteredCalendar 2");
    Test.ensureEqual(FileNameUtility.getEndCalendar(name2),
        Calendar2.newGCalendarZulu(2003, 1, 14, 0, 0, 0, 0), "getEndCalendar 2");
    Test.ensureEqual(FileNameUtility.getStartCalendar(name2),
        Calendar2.newGCalendarZulu(2003, 1, 6, 0, 0, 0, 0), "getStartCalendar 2");
    Test.ensureEqual(FileNameUtility.getPassDate(name2),
        new int[] { 12058, 12059, 12060, 12061, 12062, 12063, 12064, 12065 }, "getPassDate 2");
    Test.ensureEqual(FileNameUtility.getStartTime(name2), new double[] { 0, 0, 0, 0, 0, 0, 0, 0 }, "getStartTime 2");
    ...
    Test.ensureEqual(FileNameUtility.getRawDateString(name3), "20030331123456", "getRawDateString 3");
    Test.ensureEqual(FileNameUtility.getCenteredCalendar(name3),
        Calendar2.newGCalendarZulu(2003, 3, 31, 12, 34, 56, 00), "getCenteredCalendar 3");
    Test.ensureEqual(FileNameUtility.getEndCalendar(name3),
        Calendar2.newGCalendarZulu(2003, 3, 31, 12, 34, 56, 00), "getEndCalendar 3");
    Test.ensureEqual(FileNameUtility.getStartCalendar(name3),
    ...
    Test.ensureEqual(FileNameUtility.getStartTime(name3), new double[] { 12 * 3600 + 34 * 60 + 56 }, "getStartTime 3");
    ...
    Test.ensureEqual(FileNameUtility.getRawDateString(name25), "20030331083000", "getRawDateString 25");
    Test.ensureEqual(FileNameUtility.getCenteredCalendar(name25),
        Calendar2.newGCalendarZulu(2003, 3, 31, 8, 30, 0, 0), "getCenteredCalendar 25");
    Test.ensureEqual(FileNameUtility.getStartCalendar(name25),
        Calendar2.newGCalendarZulu(2003, 3, 30, 20, 0, 0, 0), "getStartCalendar 25");
    Test.ensureEqual(FileNameUtility.getEndCalendar(name25),
        Calendar2.newGCalendarZulu(2003, 3, 31, 21, 0, 0, 0), "getEndCalendar 25");
    Test.ensureEqual(FileNameUtility.getPassDate(name25), new int[] { 12141, 12142 }, "getPassDate 25");
    Test.ensureEqual(FileNameUtility.getStartTime(name25), new double[] { 20 * 3600 + 0 * 60 + 00, 0 },
        "getStartTime 25");
    ...
    Test.ensureEqual(FileNameUtility.getRawDateString(name33), "20030331083000", "getRawDateString 33");
    Test.ensureEqual(FileNameUtility.getCenteredCalendar(name33),
        Calendar2.newGCalendarZulu(2003, 3, 31, 8, 30, 0, 0), "getCenteredCalendar 33");
    Test.ensureEqual(FileNameUtility.getStartCalendar(name33),
        Calendar2.newGCalendarZulu(2003, 3, 30, 16, 0, 0, 0), "getStartCalendar 33");
    Test.ensureEqual(FileNameUtility.getEndCalendar(name33),
        Calendar2.newGCalendarZulu(2003, 4, 1, 1, 0, 0, 0), "getEndCalendar 33");
    Test.ensureEqual(FileNameUtility.getPassDate(name33), new int[] { 12141, 12142, 12143 }, "getPassDate 33");
    Test.ensureEqual(FileNameUtility.getStartTime(name33), new double[] { 16 * 3600 + 0 * 60 + 00, 0, 0 },
        "getStartTime 33");
    ...
    Test.ensureEqual(FileNameUtility.getRawDateString(name4), "00010110120000", "getRawDateString 4");
    Test.ensureEqual(FileNameUtility.getCenteredCalendar(name4),
        Calendar2.newGCalendarZulu(0001, 1, 10, 12, 00, 00, 0), "getEndCalendar 4");
    Test.ensureEqual(FileNameUtility.getEndCalendar(name4),
        Calendar2.newGCalendarZulu(0001, 1, 11, 0, 0, 0, 0), "getEndCalendar 4");
    Test.ensureEqual(FileNameUtility.getStartCalendar(name4),
