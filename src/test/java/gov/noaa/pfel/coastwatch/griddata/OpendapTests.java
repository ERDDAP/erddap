...
class OpendapTests {
   ...
   * @param query          e.g., "?CMusfc.CMusfc[0:1:0][0:1:0][0:1:20][0:1:20]",
   ...
   * Exception in thread "main" dods.dap.parser.TokenMgrError: Lexical error at
   * line 1, column 1. Encountered: "" (0), after : ""
   * at
   * dods.dap.parser.ErrorParserTokenManager.getNextToken(ErrorParserTokenManager.java:823)
   ...
   * at
   * gov.noaa.pfel.coastwatch.griddata.Opendap.simpleSpeedTest(Opendap.java:1180)
   * at
   * gov.noaa.pfel.coastwatch.griddata.Opendap.threddsTunnelTest(Opendap.java:1264)
