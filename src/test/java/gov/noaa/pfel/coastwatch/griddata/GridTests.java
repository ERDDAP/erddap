...
public class GridTests {
  ...
  void testForMemoryLeak() throws Exception {
    ...
    if (increase > 50000)
      ...
      Math2.gc("Grid (between tests)", 5000); // in a test, a pause after message displayed
  }
  ...
  void testGrd() throws Exception {
    ...
    String2.log(
        nLat + " " + nLon + " " + grid.minData + " " + grid.maxData + " " +
            ...
            grid.data[0] + " " + grid.data[1] + " " + grid.data[2] + " " + grid.data[nData - 2] + " "
            + grid.data[nData - 1]);
    // int nFound = 0;
  ...
  void testPM180() throws Exception {
    ...
    for (int tLon = 0; tLon < nLon; tLon++)
      if (grid.lon[tLon] > -2 && grid.lon[tLon] < 2)
        String2.log(
            "lon[" + tLon + "]=" + String2.genEFormat10(grid.lon[tLon]) + " data=" + (float) grid.getData(tLon, 0));
   ...
   *
   * @param fileNameUtility is used to generate all of the metadata based on the
   *                        file name
  ...
  void testNetCDF() throws Exception {
    ...
    Test.ensureEqual(grid2.globalAttributes().get("Conventions"),
        new StringArray(new String[] { "COARDS, CF-1.6, ACDD-1.3, CWHDF" }), "Conventions");
    Test.ensureEqual(grid2.globalAttributes().get("title"),
        new StringArray(new String[] { "SST, NOAA POES AVHRR, LAC, 0.0125 degrees, West US, Day and Night" }), "title");
    Test.ensureEqual(grid2.globalAttributes().get("summary"), new StringArray(new String[] {
        ...
        "summary");
    Test.ensureEqual(grid2.globalAttributes().get("keywords"),
        new StringArray(new String[] { "EARTH SCIENCE > Oceans > Ocean Temperature > Sea Surface Temperature" }),
        "keywords");
    Test.ensureEqual(grid2.globalAttributes().get("id"), new StringArray(new String[] { "LATsstaS1day" }), "id");
    Test.ensureEqual(grid2.globalAttributes().get("naming_authority"),
        new StringArray(new String[] { "gov.noaa.pfeg.coastwatch" }), "naming_authority");
    Test.ensureEqual(grid2.globalAttributes().get("keywords_vocabulary"),
        new StringArray(new String[] { "GCMD Science Keywords" }), "keywords_vocabulary");
    Test.ensureEqual(grid2.globalAttributes().get("cdm_data_type"), new StringArray(new String[] { "Grid" }),
        "cdm_data_typ");
    ...
    Test.ensureEqual(grid2.globalAttributes().get("date_created"),
        new StringArray(new String[] { Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()) }), "date_created");
    Test.ensureEqual(grid2.globalAttributes().get("creator_name"),
        new StringArray(new String[] { "NOAA CoastWatch, West Coast Node" }), "creator_name");
    Test.ensureEqual(grid2.globalAttributes().get("creator_url"),
        new StringArray(new String[] { "https://coastwatch.pfeg.noaa.gov" }), "creator_url");
    Test.ensureEqual(grid2.globalAttributes().get("creator_email"),
        new StringArray(new String[] { "erd.data@noaa.gov" }), "creator_email");
    Test.ensureEqual(grid2.globalAttributes().get("institution"),
        new StringArray(new String[] { "NOAA CoastWatch, West Coast Node" }), "institution");
    Test.ensureEqual(grid2.globalAttributes().get("project"),
        new StringArray(new String[] { "CoastWatch (https://coastwatch.noaa.gov/)" }), "project");
    Test.ensureEqual(grid2.globalAttributes().get("processing_level"),
        new StringArray(new String[] { "3 (projected)" }), "processing_level");
    Test.ensureEqual(grid2.globalAttributes().get("acknowledgement"),
        new StringArray(new String[] { "NOAA NESDIS COASTWATCH, NOAA SWFSC ERD" }), "acknowledgement");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lat_min"), new DoubleArray(new double[] { 22 }),
        "geospatial_lat_min");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lat_max"), new DoubleArray(new double[] { 23 }),
        "geospatial_lat_max");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lon_min"), new DoubleArray(new double[] { -135 }),
        "geospatial_lon_min");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lon_max"), new DoubleArray(new double[] { -134.25 }),
        "geospatial_lon_max");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lat_units"),
        new StringArray(new String[] { "degrees_north" }), "geospatial_lat_units");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lat_resolution"), new DoubleArray(new double[] { 0.5 }),
        "geospatial_lat_resolution");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lon_units"),
        new StringArray(new String[] { "degrees_east" }), "geospatial_lon_units");
    Test.ensureEqual(grid2.globalAttributes().get("geospatial_lon_resolution"), new DoubleArray(new double[] { 0.25 }),
        "geospatial_lon_resolution");
    Test.ensureEqual(grid2.globalAttributes().get("time_coverage_start"),
        new StringArray(new String[] { "2003-03-04T00:00:00Z" }), "time_coverage_start");
    Test.ensureEqual(grid2.globalAttributes().get("time_coverage_end"),
        new StringArray(new String[] { "2003-03-05T00:00:00Z" }), "time_coverage_end");
    // Test.ensureEqual(grid2.globalAttributes().get("time_coverage_resolution", new
    // StringArray(new String[]{""}), "time_coverage_resolution");
    Test.ensureEqual(grid2.globalAttributes().get("standard_name_vocabulary"),
        new StringArray(new String[] { "CF Standard Name Table v70" }), "standard_name_vocabulary");
    Test.ensureEqual(grid2.globalAttributes().get("license"), new StringArray(new String[] {
        "The data may be used and redistributed for free but is not intended for legal use, since it may contain inaccuracies. Neither the data Contributor, CoastWatch, NOAA, nor the United States Government, nor any of their employees or contractors, makes any warranty, express or implied, including warranties of merchantability and fitness for a particular purpose, or assumes any legal liability for the accuracy, completeness, or usefulness, of this information." }),
        "license");
    Test.ensureEqual(grid2.globalAttributes().get("contributor_name"),
        new StringArray(new String[] { "NOAA NWS Monterey and NOAA CoastWatch" }), "contributor_name");
    Test.ensureEqual(grid2.globalAttributes().get("contributor_role"),
        new StringArray(new String[] { "Source of level 2 data." }), "contributor_role");
    Test.ensureEqual(grid2.globalAttributes().get("date_issued"),
        new StringArray(new String[] { Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()) }), "date_issued");
    Test.ensureEqual(grid2.globalAttributes().getString("references"),
    ...
    // Google Earth
    Test.ensureEqual(grid2.globalAttributes().get("Southernmost_Northing"), new DoubleArray(new double[] { 22 }),
        "southernmost");
    Test.ensureEqual(grid2.globalAttributes().get("Northernmost_Northing"), new DoubleArray(new double[] { 23 }),
        "northernmost");
    Test.ensureEqual(grid2.globalAttributes().get("Westernmost_Easting"), new DoubleArray(new double[] { -135 }),
        "westernmost");
    Test.ensureEqual(grid2.globalAttributes().get("Easternmost_Easting"), new DoubleArray(new double[] { -134.25 }),
        "easternmost");

    // cwhdf attributes
    Test.ensureEqual(grid2.globalAttributes().get("cwhdf_version"), new StringArray(new String[] { "3.4" }),
    ...
    Test.ensureEqual(grid2.globalAttributes().get("origin"),
        new StringArray(new String[] { "NOAA NWS Monterey and NOAA CoastWatch" }), "origin"); // string
    // Test.ensureEqual(grid2.globalAttributes().get("history"), new StringArray(new
    // String[]{"unknown"}), "history"); //string

    Test.ensureEqual(grid2.globalAttributes().get("projection_type"), new StringArray(new String[] { "mapped" }),
        "projection_type"); // string
    Test.ensureEqual(grid2.globalAttributes().get("projection"), new StringArray(new String[] { "geographic" }),
        "projection"); // string
    ...
    Test.ensureEqual(grid2.globalAttributes().get("gctp_parm"), new DoubleArray(new double[15]), "gctp_parm"); // float64[15
                                                                                                               // 0's]
    Test.ensureEqual(grid2.globalAttributes().get("gctp_datum"), new IntArray(new int[] { 12 }), "gctp_datum");// int32
                                                                                                               // 12=WGS84

    Test.ensureEqual(grid2.globalAttributes().get("et_affine"),
        new DoubleArray(new double[] { 0, grid1.latSpacing, grid1.lonSpacing, 0, grid1.lon[0], grid1.lat[0] }),
        "et_affine"); // right side up

    Test.ensureEqual(grid2.globalAttributes().get("rows"), new IntArray(new int[] { grid1.lat.length }), "rows");// int32
                                                                                                                 // number
                                                                                                                 // of
                                                                                                                 // rows
    Test.ensureEqual(grid2.globalAttributes().get("cols"), new IntArray(new int[] { grid1.lon.length }), "cols");// int32
                                                                                                                 // number
                                                                                                                 // of
                                                                                                                 // columns
    ...
    // lat attributes
    Test.ensureEqual(grid2.latAttributes().get("long_name"), new StringArray(new String[] { "Latitude" }),
        "lat long_name");
    Test.ensureEqual(grid2.latAttributes().get("standard_name"), new StringArray(new String[] { "latitude" }),
        "lat standard_name");
    Test.ensureEqual(grid2.latAttributes().get("units"), new StringArray(new String[] { "degrees_north" }),
        "lat units");
    Test.ensureEqual(grid2.latAttributes().get("point_spacing"), new StringArray(new String[] { "even" }),
        "lat point_spacing");
    Test.ensureEqual(grid2.latAttributes().get("actual_range"), new DoubleArray(new double[] { 22, 23 }),
        "lat actual_range");
    ...
    // lon attributes
    Test.ensureEqual(grid2.lonAttributes().get("long_name"), new StringArray(new String[] { "Longitude" }),
        "lon long_name");
    Test.ensureEqual(grid2.lonAttributes().get("standard_name"), new StringArray(new String[] { "longitude" }),
        "lon standard_name");
    Test.ensureEqual(grid2.lonAttributes().get("units"), new StringArray(new String[] { "degrees_east" }), "lon units");
    Test.ensureEqual(grid2.lonAttributes().get("point_spacing"), new StringArray(new String[] { "even" }),
        "lon point_spacing");
    Test.ensureEqual(grid2.lonAttributes().get("actual_range"), new DoubleArray(new double[] { -135, -134.25 }),
        "lon actual_range");
    ...
    // data attributes
    Test.ensureEqual(grid2.dataAttributes().get("long_name"),
        new StringArray(new String[] { "SST, NOAA POES AVHRR, LAC, 0.0125 degrees, West US, Day and Night" }),
        "data long_name");
    Test.ensureEqual(grid2.dataAttributes().get("standard_name"),
        new StringArray(new String[] { "sea_surface_temperature" }), "data standard_name");
    Test.ensureEqual(grid2.dataAttributes().get("units"), new StringArray(new String[] { "degree_C" }), "data units");
    Test.ensureEqual(grid2.dataAttributes().get("_FillValue"), new FloatArray(new float[] { -9999999 }),
        "data _FillValue");
    Test.ensureEqual(grid2.dataAttributes().get("missing_value"), new FloatArray(new float[] { -9999999 }),
        "data missing_value");
    Test.ensureEqual(grid2.dataAttributes().get("numberOfObservations"), new IntArray(new int[] { 11 }),
        "data numberOfObservations");
    Test.ensureEqual(grid2.dataAttributes().get("percentCoverage"),
        new DoubleArray(new double[] { 0.9166666666666666 }), "data percentCoverage");

    // CWHDF metadata/attributes for the data: varName
    Test.ensureEqual(grid2.dataAttributes().get("coordsys"), new StringArray(new String[] { "geographic" }),
        "coordsys"); // string
    ...
    Test.ensureEqual(grid2.globalAttributes().get("date_created"),
        new StringArray(new String[] { Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()) }), "date_created");
    Test.ensureEqual(grid2.globalAttributes().get("time_coverage_start"),
        new StringArray(new String[] { "2003-03-04T17:00:00Z" }), "time_coverage_start");
    Test.ensureEqual(grid2.globalAttributes().get("time_coverage_end"),
        new StringArray(new String[] { "2003-03-04T17:00:00Z" }), "time_coverage_end");
    // Test.ensureEqual(grid2.globalAttributes().get("time_coverage_resolution", new
    // StringArray(new String[]{""}), "time_coverage_resolution");
    Test.ensureEqual(grid2.globalAttributes().get("date_issued"),
        new StringArray(new String[] { Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()) }), "date_issued");
    ...
    Test.ensureEqual(grid2.globalAttributes().get("pass_date"), new IntArray(new int[] { 12115 }), "pass_date"); // int32[nDays]
    Test.ensureEqual(grid2.globalAttributes().get("start_time"),
        new DoubleArray(new double[] { 17 * Calendar2.SECONDS_PER_HOUR }), "start_time"); // float64[nDays]
    ...
    Test.ensureEqual(grid2.globalAttributes().get("date_created"),
        new StringArray(new String[] { Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()) }), "date_created");
    Test.ensureEqual(grid2.globalAttributes().get("time_coverage_start"),
        new StringArray(new String[] { "0001-03-04T00:00:00Z" }), "time_coverage_start");
    Test.ensureEqual(grid2.globalAttributes().get("time_coverage_end"),
        new StringArray(new String[] { "0001-03-05T00:00:00Z" }), "time_coverage_end");
    // Test.ensureEqual(grid2.globalAttributes().get("time_coverage_resolution", new
    // StringArray(new String[]{""}), "time_coverage_resolution");
    Test.ensureEqual(grid2.globalAttributes().get("date_issued"),
        new StringArray(new String[] { Calendar2.formatAsISODate(Calendar2.newGCalendarZulu()) }), "date_issued");
