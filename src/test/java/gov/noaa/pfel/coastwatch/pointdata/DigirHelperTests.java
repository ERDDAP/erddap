...
class DigirHelperTests {
    ...
    void testGetInventory() throws Exception {
        ...
        if (false) {
            ...
            // caught");
            try {
                String xml = DigirHelper.getInventoryXml(DigirHelper.OBIS_VERSION, DigirHelper.OBIS_PREFIXES,
                        DigirHelper.OBIS_XMLNSES, DigirHelper.OBIS_XSDES,
                        "NONE", // !!! not available
                ...
                if (e.toString().indexOf("<diagnostic") < 0)
                    throw e;
        ...
        if (false) {
            ...
            table = DigirHelper.getInventoryTable(DigirHelper.OBIS_VERSION, DigirHelper.OBIS_PREFIXES,
                    DigirHelper.OBIS_XMLNSES, DigirHelper.OBIS_XSDES,
                    // "GHMP", //or
                    // "aims_biotech",
                    // "IMCS", not available
    ...
    void testBmde() throws Exception {
        ...
        try {
            ...
            Table table = DigirHelper.searchBmde(new String[] { "prbo05" },
            ...
            String expected = "\"bmde:DecimalLongitude\",\"bmde:DecimalLatitude\",\"bmde:ObservationDate\",\"bmde:GlobalUniqueIdentifier\",\"bmde:Genus\",\"bmde:ScientificName\"\n"
                    +
        ...
        try {
            ...
            if (false) {
                ...
                try {
                    ...
                    String2.log(e.toString());
                    if (e.toString().indexOf("darwin:XYZ") < 0)
                        throw e;
                    String2.log("\n*** diagnostic error (above) correctly caught\n");
                }
                ...
                try {
                    ...
                    String2.log(e.toString());
                    if (e.toString().indexOf("greaterTheen") < 0)
                        throw e;
                    String2.log("\n*** diagnostic error (above) correctly caught\n");
                }
                ...
                try {
                    ...
                    String2.log(e.toString());
                    if (e.toString().indexOf("darwin:InstitutionCoode") < 0)
                        throw e;
                    String2.log("\n*** diagnostic error (above) correctly caught\n");
                }
            ...
            if (false) {
                ...
                DigirHelper.searchObis(
                        ...
                        url,
                        new String[] { "darwin:Genus", "darwin:Latitude", "darwin:Latitude", "darwin:YearCollected",
            ...
            if (true) {
                ...
                String expected = "darwin:InstitutionCode,darwin:CollectionCode,darwin:CatalogNumber,darwin:ScientificName,darwin:Longitude,darwin:Latitude,obis:Temperature\n"
                        +
