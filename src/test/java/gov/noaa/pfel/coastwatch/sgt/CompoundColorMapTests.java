...
class CompoundColorMapTests {
  ...
  void basicTest() throws Exception {
    // verbose = true;
    String basePaletteDir = File2.webInfParentDirectory() + // with / separator and / at the end
        "WEB-INF/cptfiles/";
    ...
    // **** make a realistic continuous ccm
    {
      ...
      String newPalette = CompoundColorMap.makeCPT(basePaletteDir, "Rainbow", "Linear", 8, 32, 8,
          continuous, tempDir);
      ...
      String2.log("  " + n + " getColors  last=" + Integer.toHexString(c.getRGB()) +
          ...
          "\n  cumTotalTime=" + ccm.cumulativeTotalTime + "[was 434 if on, -1=off]" + // varies, but testTime more
                                                                                      // consistent
    ...
    // **** make a realistic !continuous ccm
    {
      ...
      // but real world use doesn't.
      String2.log("  " + n + " getColors  last=" + Integer.toHexString(c.getRGB()) +
          "\n  cumLookupTime=" + ccm.cumulativeLookupTime + "[was 156 if on, -1=off]" + // varies, but testTime more
                                                                                        // consistent
