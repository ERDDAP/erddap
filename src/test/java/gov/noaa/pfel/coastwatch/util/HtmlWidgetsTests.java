  ...
  void basicTest() throws Throwable {
    ...
    sb.append(
        HtmlWidgets.DOCTYPE_HTML +
            ...
            "</head>\n" +
            "<body>\n" +
            HtmlWidgets.htmlTooltipScript(imageDir) + // this test uses non-https url
            HtmlWidgets.dragDropScript(imageDir) + // this test uses non-https url
    ...
    sb.append("<br>This html tooltip doesn't work initially because wings.gif height and width aren't specified: " +
        HtmlWidgets.htmlTooltipImage(imageDir + "QuestionMark.png", "?",
    ...
    sb.append("\n<br>cssTooltipImage: ");
    sb.append(HtmlWidgets.cssTooltipImage(
        "http://localhost:8080/cwexperimental/images/QuestionMark.png", "?", "",
    ...
    sb.append("\n<br>cssTooltipVideo: ");
    sb.append(HtmlWidgets.cssTooltipVideo(
        "http://localhost:8080/cwexperimental/images/QuestionMark.png", "?", "",
    ...
    sb.append(
        widgets.checkbox("checkboxName1", "checkboxTooltip literal: &lt;&gt;&amp;\"!", true, "checkboxValue1",
            "rightLabel1", "") +
            "\n" +
            ...
            +
            "<br>\n" +
            widgets.checkbox("checkboxName2", "checkboxTooltip literal: &lt;&gt;&amp;\"!", true, "checkboxValue2",
                "rightLabel2", "")
            +
            "\n" +
            ...
            +
            "<br>\n" +
            widgets.checkbox("checkboxName3", "checkboxTooltip literal: &lt;&gt;&amp;\"!", true, "checkboxValue3",
                "rightLabel3", "")
            +
            "<br>\n" +
            widgets.checkbox("checkboxName4", "checkboxTooltip literal: &lt;&gt;&amp;\"!", true, "checkboxValue4",
                "rightLabel4", "")
            +
    ...
    sb.append("<br>\n" +
        widgets.radioButtons("radioName1", "radioTooltip literal: &lt;&gt;&amp;\"!", true,
            new String[] { "apple", "banana", "cucumber" }, 1, "")
        +
        "<br>\n" +
        widgets.radioButtons("radioName2", "radioTooltip literal: &lt;&gt;&amp;\"!", true,
            new String[] { "apple", "banana", "cucumber" }, 2, "")
        +
        widgets.select("dropdownName", "dropdownTooltip literal: &lt;&gt;&amp;\"!",
            HtmlWidgets.BUTTONS_0n + HtmlWidgets.BUTTONS_1 + HtmlWidgets.BUTTONS_100 + HtmlWidgets.BUTTONS_1000,
            options, 37, "")
        +
        ...
        widgets.comboBox(language, formName, "myComboBox", "My comboBox tooltip", 25, 255,
            "myInitialValue", new String[] { "", "able", "baker", "charlie" }, "", null)
        + // other
        "<br>TextField1: \n" +
        ...
        widgets.textField("textFieldName2", "", 20, 255, "has big tooltip <script>prompt(123)</script>",
            HtmlWidgets.htmlTooltip("Hi <strong>bold</strong>!\n<br>There \\/'\"&amp;&brvbar;!"))
        +
        "<br>\n" +
        // textbox
        ...
        widgets.button("button", "button1", "button tooltip  literal: &lt;&gt;&amp;\"!", "Skinny Button",
            "class=\"skinny\"")
        +
        // make a button that looks like a submit button but doesn't submit the form
        "<br>\n" +
        widgets.button("button", "submit1Name", "submit tooltip  literal: &lt;&gt;&amp;\"!", "Submit",
            "onclick=\"alert('alert!');\"")
        +
        "<br>\n" +
    ...
    String twoClickMap[] = HtmlWidgets.myTwoClickMap540Big(language, formName, imageDir + "world540Big.png", false); // debugInBrowser
