...
class SharedWatchServiceTests {
    ...
    private class EventHandler implements WatchUpdateHandler {
    ...
    void basicTest() throws Throwable {
        ...
        Math2.sleep(sleep);
        SharedWatchService.watchDirectory(watchDir, false, null, eventHandler, "basicTest"); // recursive, pathRegex
        ...
        Test.ensureBetween(contexts.size(), 1, 4, ""); // sometimes the dir event isn't caught
        ...
        Test.ensureBetween(contexts.size(), 1, 3,
        ...
        RegexFilenameFilter.regexDelete(watchDir, ".*", true);
        Math2.sleep(sleep);
        SharedWatchService.watchDirectory(watchDir, true, "", eventHandler, "basicTest"); // recursive, pathRegex
        ...
        Test.ensureBetween(contexts.size(), 4, 5, ""); // sometimes the dir event isn't caught
        eventHandler.resetTest();
        ...
        Test.ensureBetween(contexts.size(), 2, 5, "");
    }
}
