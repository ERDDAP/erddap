...
class FileVisitorSubdirTests {
  ...
  void testAWSS3() throws Throwable {
    ...
    alps = FileVisitorSubdir.oneStep(
        ...
        "");
    String results = alps.toNewlineString();
    String expected = "https://nasanex.s3.us-west-2.amazonaws.com/NEX-DCP30/BCSD/rcp26/mon/atmos/tasmin/r1i1p1/v1.0/\n"
        +
  ...
  void testWAF() throws Throwable {
    ...
    try {
      ...
      alps = FileVisitorSubdir.oneStep("https://www.fisheries.noaa.gov/inportserve/waf/", // after 2020-08-03
          // "https://inport.nmfs.noaa.gov/inport-metadata/NOAA/NMFS/", //pre 2020-08-03
          ".*/NMFS/(|SWFSC/|NWFSC/)(|inport-xml/)(|xml/)"); // tricky!
      String results = alps.toNewlineString();
      String expected = "https://inport.nmfs.noaa.gov/inport-metadata/NOAA/NMFS/NWFSC/\n" +
