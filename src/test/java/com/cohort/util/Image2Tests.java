...
public class Image2Tests {
  ...
  void basicTest() throws Exception {
    ...
    Image image = Image2.getImage(testDir + "temp.gif",
  ...
  /**
   * This is like the other testImagesIdentical, but uses
   * DEFAULT_ALLOW_N_PIXELS_DIFFERENT.
   *
   * @param observed the full name of the image file to be tested (.gif, .jpg, or
   *                 .png)
   * @param expected the full name of the expected/standard/correct image file
   *                 (.gif, .jpg, or .png)
  ...
  public static void testImagesIdentical(String observed, String expected,
    ...
    testImagesIdentical(observed, expected, diffName, Image2.DEFAULT_ALLOW_N_PIXELS_DIFFERENT,
        Image2.DEFAULT_AUTO_CREATE_IF_MISSING, Image2.DEFAULT_DISPLAY_IMAGES);
  }
   ...
   *                              that is sometimes created if there are
   *                              differences
   * @param allowNPixelsDifferent doesn't throw an Exception if nPixelsDifferent
   *                              &lt;=allowNPixelsDifferent. Use 0 to test for
   *                              true equality.
  ...
  public static String compareImages(Image image1, Image image2,
    ...
    PixelGrabber grabber = new PixelGrabber(image1, // see Nutshell pg 369
    ...
    grabber = new PixelGrabber(image2, // see Nutshell pg 369
   ...
   * If different, the differences are saved in diffName.
   *
   * @param observed              the full name of the image file to be tested
   *                              (.gif, .jpg, or .png)
   * @param expected              the full name of the expected/standard/correct
   *                              image file (.gif, .jpg, or .png)
   * @param diffName              the full name of a .png image file that will be
   *                              created
   *                              highlighting the differences between observed
   *                              and expected.
   * @param allowNPixelsDifferent doesn't throw an Exception if nPixelsDifferent
   *                              &lt;=allowNPixelsDifferent. Use 0 to test for
   *                              true equality.
  ...
  public static void testImagesIdentical(String observed, String expected,
    ...
    String error = Image2Tests.compareImages(obsImg, expImg, diffName, allowNPixelsDifferent); // error.length>0 if >
