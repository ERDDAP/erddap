...
class XMLTests {
  ...
  void basicTest() throws Exception {
    ...
    Document document = XML.parseXml(new BufferedReader(new StringReader(
    ...
    Test.ensureEqual(XML.getTextContent(XML.getFirstNode(document, xPath, "/testr/level1")), "level 1 & text",
        "get text");
    ...
    Test.ensureEqual(XML.getAttribute(XML.getFirstNode(document, xPath, "/testr/level1[@att1]"), "att1"), "value1",
        "get attribute");
