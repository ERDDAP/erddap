...
class AttributesTests {
  ...
  void basicTest() throws Exception {
    ...
    Test.ensureEqual(atts.get("String1"), new StringArray(new String[] { "a, csv, ÿ\u20ac, string" }), ""); // 1 string
                                                                                                            // with csv
                                                                                                            // content
    ...
    Test.ensureEqual(atts.get("String1").toString(), "\"a, csv, \\u00ff\\u20ac, string\"", ""); // 1 string with csv
                                                                                                // content
    Test.ensureEqual(atts.get("String1").toNccsvAttString(), "\"a, csv, ÿ\u20ac, string\"", ""); // 1 string with csv
                                                                                                 // content
    Test.ensureEqual(atts.get("String1").toNccsv127AttString(), "\"a, csv, \\u00ff\\u20ac, string\"", ""); // 1 string
                                                                                                           // with csv
                                                                                                           // content
    ...
    Test.ensureEqual(atts2.getNames(),
        new String[] { "byte", "char", "double", "float", "int", "long", "PA", "short", "String1", "String4" },
        "");
    Test.ensureEqual(atts2.get("String1"), new StringArray(new String[] { "a, csv, \u00ff\u20ac, string" }), ""); // 1
                                                                                                                  // string
                                                                                                                  // with
                                                                                                                  // csv
                                                                                                                  // content
