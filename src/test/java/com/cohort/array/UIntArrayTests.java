...
class UIntArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    anArray = new UIntArray(new long[] { UIntArray.MAX_VALUE, 1, 2, UIntArray.MAX_VALUE, 3, UIntArray.MAX_VALUE });
    ...
    anArray.set(2, 31);
    Test.ensureEqual(anArray.isEvenlySpaced(),
        "UIntArray isn't evenly spaced: [0]=10.0, [1]=20.0, spacing=10.0, expected spacing=10.5.", "");
    ...
    Test.ensureEqual((new UIntArray(new long[] { UIntArray.MAX_VALUE })).tryToFindNumericMissingValue(),
        UIntArray.MAX_VALUE, "");
    Test.ensureEqual((new UIntArray(new int[] { 1, 99 })).tryToFindNumericMissingValue(), 99, "");

    // sort
    anArray = new UIntArray(new long[] { UIntArray.MAX_VALUE, Integer.MAX_VALUE + 1L, 0, 5, Integer.MAX_VALUE });
    anArray.sort();
    Test.ensureEqual(anArray.toString(), "0, 5, " + Integer.MAX_VALUE + ", " +
        (Integer.MAX_VALUE + 1L) + ", " + UIntArray.MAX_VALUE, "");
