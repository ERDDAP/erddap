...
class UByteArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    anArray = new UByteArray(new short[] { UByteArray.MAX_VALUE, 1, 2, UByteArray.MAX_VALUE, 3, UByteArray.MAX_VALUE });
    ...
    Test.ensureEqual(anArray.isEvenlySpaced(),
        "UByteArray isn't evenly spaced: [0]=10.0, [1]=20.0, spacing=10.0, expected spacing=10.5.", "");
