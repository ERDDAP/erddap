...
class ULongArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(ULongArray.pack(new BigInteger("" + (Long.MAX_VALUE)).add(BigInteger.ONE)), Long.MIN_VALUE, "");
    Test.ensureEqual(ULongArray.pack(new BigInteger("" + (Long.MAX_VALUE)).multiply(new BigInteger("2"))), -2, "");
    Test.ensureEqual(
        ULongArray.pack(new BigInteger("" + (Long.MAX_VALUE)).multiply(new BigInteger("2")).add(BigInteger.ONE)), -1,
        "");
    ...
    Test.ensureEqual(anArray.toNccsvAttString(),
        "0uL,1uL,9223372036854775807uL,18446744073709551615uL,18446744073709551615uL,18446744073709551615uL", "");
    Test.ensureEqual(anArray.toNccsv127AttString(),
        "0uL,1uL,9223372036854775807uL,18446744073709551615uL,18446744073709551615uL,18446744073709551615uL", "");

    // ** test default constructor and many of the methods
    anArray = new ULongArray();
    Test.ensureEqual(anArray.isIntegerType(), true, "");
    Test.ensureEqual(anArray.missingValue().getRawDouble(), ULongArray.MAX_VALUE.doubleValue(), ""); // loss of
                                                                                                     // precision
    anArray.addString("");
    Test.ensureEqual(anArray.get(0), null, "");
    Test.ensureEqual(anArray.getRawInt(0), Integer.MAX_VALUE, "");
    Test.ensureEqual(anArray.getRawDouble(0), ULongArray.MAX_VALUE.doubleValue(), ""); // loss of precision
    Test.ensureEqual(anArray.getUnsignedDouble(0), Double.NaN, "");
    Test.ensureEqual(anArray.getRawString(0), "" + ULongArray.MAX_VALUE, "");
    Test.ensureEqual(anArray.getRawNiceDouble(0), ULongArray.MAX_VALUE.doubleValue(), ""); // loss of precision
    ...
    Test.ensureEqual(anArray.toString(), "0, 1, 9223372036854775807, 9223372036854775808, "
        + ULongArray.MAX_VALUE.subtract(BigInteger.ONE) + ", 18446744073709551615", "");
    anArray.clear();
    ...
    anArray = new ULongArray(
        new long[] { ULongArray.PACKED_MAX_VALUE, 1, 2, ULongArray.PACKED_MAX_VALUE, 3, ULongArray.PACKED_MAX_VALUE });
