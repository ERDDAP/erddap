...
class PrimitiveArrayTests {
  ...
  void testNccsv() throws Throwable {
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1b,3")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    Test.ensureEqual(pa.toString(), "1b, 3", "");

    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1b,1234b")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1s,3")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    Test.ensureEqual(pa.toString(), "1s, 3", "");

    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1s,123456s")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("-2147483648i,-0i,0i,2147483647i"));
    Test.ensureEqual(pa.elementTypeString(), "int", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1i,3.00i")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    ...
    pa = PrimitiveArray
        .parseNccsvAttributes(StringArray.simpleFromNccsv("-9223372036854775808L,-0L,0L,9223372036854775807L"));
    Test.ensureEqual(pa.elementTypeString(), "long", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1L,123456")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv(
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1f,3..0e23f")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("3.0d,3..0d")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    Test.ensureEqual(pa.toString(), "3.0d, 3..0d", "");

    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("1.0d,3")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv( // \\b is not supported
        "\"'\\f'\", \"'\\n'\", \"'\\r'\", \"'\\t'\", \"'\\\\'\""));
    Test.ensureEqual(pa.elementTypeString(), "char", "");
    Test.ensureEqual(pa.toString(),
        "\\f, \\n, \\r, \\t, \\\\", "");
    ...
    pa = PrimitiveArray.parseNccsvAttributes(StringArray.simpleFromNccsv("'a', ''")); // doesn't match regex
    Test.ensureEqual(pa.elementTypeString(), "String", "");
    Test.ensureEqual(pa.toString(), "'a', ''", "");
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(PrimitiveArray.factory(Character.valueOf((char) 1)).elementType(), PAType.CHAR, "");
    Test.ensureEqual(PrimitiveArray.factory(Short.valueOf((short) 1)).elementType(), PAType.SHORT, "");
    ...
    Test.ensureEqual(PrimitiveArray.factory(PAType.LONG, 5, "50").toString(), "50, 50, 50, 50, 50", "");
    Test.ensureEqual(PrimitiveArray.factory(PAType.FLOAT, 6, "60").toString(), "60.0, 60.0, 60.0, 60.0, 60.0, 60.0",
        "");
    ...
    Test.ensureEqual(PrimitiveArray.rank(table, new int[] { 0 }, new boolean[] { true }), // ascending
        new int[] { 0, 2, 1, 3 }, "");
    Test.ensureEqual(PrimitiveArray.rank(table, new int[] { 0 }, new boolean[] { false }), // descending
        new int[] { 3, 1, 2, 0 }, "");
    Test.ensureEqual(PrimitiveArray.rank(table, new int[] { 1 }, new boolean[] { true }), // ties
        new int[] { 3, 0, 1, 2 }, "");
    Test.ensureEqual(PrimitiveArray.rank(table, new int[] { 2 }, new boolean[] { true }),
        new int[] { 3, 2, 0, 1 }, "");
    ...
    for (int i = 0; i < 4; i++)
      Test.ensureEqual(arString.get(i), (new String[] { "A", "a", "ABE", "abe" })[i],
    ...
    Test.ensureEqual(rank, new int[] { 4, 1, 0, 2, 3 }, ""); // NaN PrimitiveArray.ranks like big positive number
    ...
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(2)), 0, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(4)), 1, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(6)), 2, ""); // 2,3,4
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(8)), 5, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(1)), -1, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(3)), -2, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(5)), -3, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(7)), -6, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(9)), -7, "");

    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(2)), 0, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(4)), 1, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(6)), 4, ""); // any
                                                                                                                    // of
                                                                                                                    // 2,3,4
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(1)), -1, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(3)), -2, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(5)), -3, "");
    Test.ensureEqual(PrimitiveArray.rafBinarySearch(raf, PAType.FLOAT, farStart, 0, 4, PAOne.fromFloat(7)), -6, "");

    // test rafFirstGE
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(2)), 0, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(4)), 1, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(6)), 2, ""); // first
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(8)), 5, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(1)), 0, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(3)), 1, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(5)), 2, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(7)), 5, "");
    Test.ensureEqual(PrimitiveArray.rafFirstGE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(9)), 6, "");
    ...
    Test.ensureEqual(PrimitiveArray.rafFirstGAE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(9), 5), 6, "");

    // test rafLastLE
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(2)), 0, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(4)), 1, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(6)), 4, ""); // last
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(8)), 5, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(1)), -1, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(3)), 0, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(5)), 1, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(7)), 4, "");
    Test.ensureEqual(PrimitiveArray.rafLastLE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(9)), 5, "");
    ...
    Test.ensureEqual(PrimitiveArray.rafLastLAE(raf, PAType.FLOAT, farStart, 0, 5, PAOne.fromFloat(9), 5), 5, "");
    raf.close();
    ...
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.BYTE, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1, 2, 22, 33", "");
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.CHAR, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1, 2, \\u0016, !", "");
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.DOUBLE, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1.1, 2.2, 22.2, 33.3", "");
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.FLOAT, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1.1, 2.2, 22.2, 33.3", "");
    ...
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.SHORT, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1, 2, 22, 33", "");
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.STRING, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1.1, 2.2, 22.2, 33.3", "");
    Test.ensureEqual(PrimitiveArray.csvFactory(PAType.STRING, "1.1, 2.2").addFromPA(other, 1, 2).toString(),
        "1.1, 2.2, 22.2, 33.3", "");
    ...
    Test.ensureEqual(
        PrimitiveArray.csvFactory(PAType.SHORT, "1.1, 2.2")
            .addFromPA(PrimitiveArray.csvFactory(PAType.SHORT, "11.1, 22.2, 33.3"), 1, 2).toString(),
        "1, 2, 22, 33", "");
    Test.ensureEqual(
        PrimitiveArray.csvFactory(PAType.STRING, "1.1, 2.2")
            .addFromPA(PrimitiveArray.csvFactory(PAType.STRING, "11.1, 22.2, 33.3"), 1, 2).toString(),
        "1.1, 2.2, 22.2, 33.3", "");
  ...
  void testTestValueOpValue() {
    ...
    Test.ensureEqual(PrimitiveArray.testValueOpValue("12345", PrimitiveArray.REGEX_OP, "[0-9]+"), true, "");
    Test.ensureEqual(PrimitiveArray.testValueOpValue("12a45", PrimitiveArray.REGEX_OP, "[0-9]+"), false, "");
