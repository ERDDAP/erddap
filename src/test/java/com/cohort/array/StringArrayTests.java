...
class StringArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(StringArray.wordsAndQuotedPhrases(" a,\"b b").toString(), "a, b b", ""); // no error for missing "
    ...
    Test.ensureEqual(StringArray.fromCSV(" a, \"b b\" ,c ").toString(), "a, b b, c", "");
    Test.ensureEqual(StringArray.fromCSV(" a,\"b b").toString(), "a, b b", ""); // no error for missing "
    ...
    Test.ensureEqual(anArray.get(1), "b\"b", ""); // internal quotes
    anArray = StringArray.fromCSV(" a \"b\"\"b\" c ");
    Test.ensureEqual(anArray.get(0), "b\"b", ""); // internal quotes, only the quoted string is saved
    ...
    Test.ensureEqual(StringArray.fromCSV(" a,junk\"b \"\"\"\"b\"junk,c ").toString(), "a, \"b \"\"\"\"b\", c", "");
    ...
    Test.ensureEqual((new StringArray(new String[] { "a", "", "1", "99" })).tryToFindNumericMissingValue(), null, ""); // doesn't
                                                                                                                       // catch
                                                                                                                       // 99.
                                                                                                                       // Should
                                                                                                                       // it?
