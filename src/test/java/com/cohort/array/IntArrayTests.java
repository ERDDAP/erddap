...
class IntArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(uArray.toString(), "2147483648, 4294967294, 4294967295, 0, 1, 2147483646, 2147483647", ""); // -1
                                                                                                                 // ->
                                                                                                                 // mv
    anArray.clear();
    ...
    anArray.set(2, 31);
    Test.ensureEqual(anArray.isEvenlySpaced(),
        "IntArray isn't evenly spaced: [0]=10.0, [1]=20.0, spacing=10.0, expected spacing=10.5.", "");
  ...
  void testSynchSpeed() {
    ...
    String2.log("n=" + n + " time/test=" + (((System.currentTimeMillis() - time) * 1000000) / n)
        + " nanoseconds  (~31) currentTime=" + tTime);
  }
