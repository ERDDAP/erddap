...
class CharArrayTests {
  ...
  void basicTest() throws Throwable {
    ...
    Test.ensureEqual(anArray.isEvenlySpaced(),
        "CharArray isn't evenly spaced: [0]=10.0, [1]=20.0, spacing=10.0, expected spacing=10.5.", "");
    ...
    Test.ensureEqual((new CharArray(new char[] { Character.MIN_VALUE })).tryToFindNumericMissingValue(),
