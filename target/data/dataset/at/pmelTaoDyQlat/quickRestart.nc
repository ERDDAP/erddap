...
*GLOBAL*,creationTimeMillis,"1747835288333"
...
*GLOBAL*,defaultGraphQuery,"longitude,latitude,QL_137&time>=now-7days"
...
*GLOBAL*,keywords,"buoys, centered, daily, depth, Earth Science > Atmosphere > Atmospheric Radiation > Heat Flux, Earth Science > Oceans > Ocean Heat Budget > Heat Flux, flux, heat, heat flux, identifier, latent, noaa, pirata, pmel, quality, rama, station, surface_downward_latent_heat_flux, tao, time, triton"
...
*GLOBAL*,title,"TAO/TRITON, RAMA, and PIRATA Buoys, Daily, 1989-present, Latent Heat Flux"
...
depth,type,EVEN
depth,units,m
QL_137,*DATA_TYPE*,float
QL_137,_FillValue,1.0E35f
QL_137,actual_range,-104.6987f,503.1481f
QL_137,colorBarMaximum,500.0d
QL_137,colorBarMinimum,-100.0d
QL_137,epic_code,137i
QL_137,generic_name,qlat
QL_137,ioos_category,Heat Flux
QL_137,long_name,Latent Heat Flux
QL_137,missing_value,1.0E35f
QL_137,name,QL
QL_137,standard_name,surface_downward_latent_heat_flux
QL_137,units,W m-2
QQL_5137,*DATA_TYPE*,float
QQL_5137,_FillValue,1.0E35f
QQL_5137,actual_range,0.0f,2.0f
QQL_5137,colorBarContinuous,false
QQL_5137,colorBarMaximum,6.0d
QQL_5137,colorBarMinimum,0.0d
QQL_5137,description,"Quality: 0=missing data, 1=highest, 2=standard, 3=lower, 4=questionable, 5=bad, -9=contact Dai.C.McClurg@noaa.gov.  To get probably valid data only, request QQL_5137>=1 and QQL_5137<=3."
QQL_5137,epic_code,5137i
QQL_5137,generic_name,qqlat
QQL_5137,ioos_category,Quality
QQL_5137,long_name,Latent Heat Flux Quality
QQL_5137,missing_value,1.0E35f
QQL_5137,name,QQL

*END_METADATA*
array,station,wmo_platform_code,longitude,latitude,time,depth,QL_137,QQL_5137
*END_DATA*
