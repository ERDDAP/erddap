...
*GLOBAL*,creationTimeMillis,"1747835309576"
...
*GLOBAL*,defaultGraphQuery,"longitude,latitude,QR_139&time>=now-7days"
...
*GLOBAL*,keywords,"buoys, centered, daily, depth, due, Earth Science > Atmosphere > Precipitation > Rain, Earth Science > Oceans > Ocean Heat Budget > Heat Flux, flux, heat, heat flux, identifier, noaa, pirata, pmel, quality, rain, rama, station, tao, temperature_flux_due_to_rainfall_expressed_as_heat_flux_into_sea_water, time, triton"
...
*GLOBAL*,title,"TAO/TRITON, RAMA, and PIRATA Buoys, Daily, 1997-present, Heat Flux Due To Rain"
...
depth,type,EVEN
depth,units,m
QR_139,*DATA_TYPE*,float
QR_139,_FillValue,1.0E35f
QR_139,actual_range,-1.862732f,48.94205f
QR_139,colorBarMaximum,38.0d
QR_139,colorBarMinimum,-2.0d
QR_139,epic_code,139i
QR_139,generic_name,qrain
QR_139,ioos_category,Heat Flux
QR_139,long_name,Heat Flux Due To Rain
QR_139,missing_value,1.0E35f
QR_139,name,QR
QR_139,standard_name,temperature_flux_due_to_rainfall_expressed_as_heat_flux_into_sea_water
QR_139,units,W m-2
QQR_5139,*DATA_TYPE*,float
QQR_5139,_FillValue,1.0E35f
QQR_5139,actual_range,0.0f,2.0f
QQR_5139,colorBarContinuous,false
QQR_5139,colorBarMaximum,6.0d
QQR_5139,colorBarMinimum,0.0d
QQR_5139,description,"Quality: 0=missing data, 1=highest, 2=standard, 3=lower, 4=questionable, 5=bad, -9=contact Dai.C.McClurg@noaa.gov.  To get probably valid data only, request QQR_5139>=1 and QQR_5139<=3."
QQR_5139,epic_code,5139i
QQR_5139,generic_name,qqrain
QQR_5139,ioos_category,Quality
QQR_5139,long_name,Heat Flux Due To Rain Quality
QQR_5139,missing_value,1.0E35f
QQR_5139,name,QQR

*END_METADATA*
array,station,wmo_platform_code,longitude,latitude,time,depth,QR_139,QQR_5139
*END_DATA*
