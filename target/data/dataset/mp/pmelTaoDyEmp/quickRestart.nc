...
*GLOBAL*,creationTimeMillis,"1747835259809"
...
*GLOBAL*,defaultGraphQuery,"longitude,latitude,EMP_251&time>=now-7days"
...
*GLOBAL*,keywords,"amount, buoys, centered, daily, depth, Earth Science > Atmosphere > Atmospheric Water Vapor > Evaporation, Earth Science > Atmosphere > Precipitation > Precipitation Amount, Earth Science > Atmosphere > Precipitation > Precipitation Rate, evaporation, identifier, meteorology, minus, noaa, pirata, pmel, precipitation, quality, rain, rama, rate, station, tao, time, triton"
...
*GLOBAL*,title,"TAO/TRITON, RAMA, and PIRATA Buoys, Daily, 1997-present, Evaporation Minus Precipitation"
...
depth,type,EVEN
depth,units,m
EMP_251,*DATA_TYPE*,float
EMP_251,_FillValue,1.0E35f
EMP_251,actual_range,-14.60452f,0.787049f
EMP_251,colorBarMaximum,0.5d
EMP_251,colorBarMinimum,-0.5d
EMP_251,colorBarPalette,BlueWhiteRed
EMP_251,epic_code,251i
EMP_251,generic_name,emp
EMP_251,ioos_category,Meteorology
EMP_251,long_name,Evaporation Minus Precipitation
EMP_251,missing_value,1.0E35f
EMP_251,name,EMP
EMP_251,units,mm/hr
QEMP_5251,*DATA_TYPE*,float
QEMP_5251,_FillValue,1.0E35f
QEMP_5251,actual_range,0.0f,2.0f
QEMP_5251,colorBarContinuous,false
QEMP_5251,colorBarMaximum,6.0d
QEMP_5251,colorBarMinimum,0.0d
QEMP_5251,description,"Quality: 0=missing data, 1=highest, 2=standard, 3=lower, 4=questionable, 5=bad, -9=contact Dai.C.McClurg@noaa.gov.  To get probably valid data only, request QEMP_5251>=1 and QEMP_5251<=3."
QEMP_5251,epic_code,5251i
QEMP_5251,generic_name,qemp
QEMP_5251,ioos_category,Quality
QEMP_5251,long_name,Evaporation Minus Precipitation Quality
QEMP_5251,missing_value,1.0E35f
QEMP_5251,name,QEMP

*END_METADATA*
array,station,wmo_platform_code,longitude,latitude,time,depth,EMP_251,QEMP_5251
*END_DATA*
