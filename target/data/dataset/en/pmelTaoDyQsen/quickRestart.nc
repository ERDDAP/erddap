...
*GLOBAL*,creationTimeMillis,"1747835296186"
...
*GLOBAL*,defaultGraphQuery,"longitude,latitude,QS_138&time>=now-7days"
...
*GLOBAL*,keywords,"buoys, centered, daily, depth, Earth Science > Atmosphere > Atmospheric Radiation > Heat Flux, Earth Science > Oceans > Ocean Heat Budget > Heat Flux, flux, heat, heat flux, identifier, noaa, pirata, pmel, quality, rama, sensible, station, surface_downward_sensible_heat_flux, tao, time, triton"
...
*GLOBAL*,title,"TAO/TRITON, RAMA, and PIRATA Buoys, Daily, 1989-present, Sensible Heat Flux"
...
depth,type,EVEN
depth,units,m
QS_138,*DATA_TYPE*,float
QS_138,_FillValue,1.0E35f
QS_138,actual_range,-44.86025f,86.45135f
QS_138,colorBarMaximum,50.0d
QS_138,colorBarMinimum,0.0d
QS_138,epic_code,138i
QS_138,generic_name,qsen
QS_138,ioos_category,Heat Flux
QS_138,long_name,Sensible Heat Flux
QS_138,missing_value,1.0E35f
QS_138,name,QS
QS_138,standard_name,surface_downward_sensible_heat_flux
QS_138,units,W m-2
QQS_5138,*DATA_TYPE*,float
QQS_5138,_FillValue,1.0E35f
QQS_5138,actual_range,0.0f,2.0f
QQS_5138,colorBarContinuous,false
QQS_5138,colorBarMaximum,6.0d
QQS_5138,colorBarMinimum,0.0d
QQS_5138,description,"Quality: 0=missing data, 1=highest, 2=standard, 3=lower, 4=questionable, 5=bad, -9=contact Dai.C.McClurg@noaa.gov.  To get probably valid data only, request QQS_5138>=1 and QQS_5138<=3."
QQS_5138,epic_code,5138i
QQS_5138,generic_name,qqsen
QQS_5138,ioos_category,Quality
QQS_5138,long_name,Sensible Heat Flux Quality
QQS_5138,missing_value,1.0E35f
QQS_5138,name,QQS

*END_METADATA*
array,station,wmo_platform_code,longitude,latitude,time,depth,QS_138,QQS_5138
*END_DATA*
