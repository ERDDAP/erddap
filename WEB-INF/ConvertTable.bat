...
rem <dimensionName> The name for the rows, e.g., "time", "row", "station".
rem
...
rem ConvertTable "http://oceanwatch.pfeg.noaa.gov/opendap/GLOBEC/GLOBEC_bottle?t0,oxygen&month=5" 2 result.nc 1 row
rem
rem 2006-02-14
