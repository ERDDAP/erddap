#!/bin/bash
# This is the Unix/Linux shell script to run DasDds.
...
cp5=":lib/commons-jexl.jar:lib/aws-java-sdk.jar:lib/jackson-annotations.jar:lib/jackson-core.jar:lib/jackson-databind.jar"
cp0="$cp1$cp2$cp3$cp4$cp5"

java -cp $cp0 -Xms1000M -Xmx1000M gov.noaa.pfel.erddap.DasDds "$@"
