...
java -cp classes:lib/netcdfAll-latest.jar:lib/slf4j.jar:lib/activation.jar:lib/mail.jar -Xms1000M -Xmx1000M gov.noaa.pfel.coastwatch.griddata.DoubleCenterGrids $1 $2 $3 $4 $5
