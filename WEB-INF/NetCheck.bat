...
set thisDir=%~dp0
java -cp %thisDir%/;%thisDir%/classes;%thisDir%/lib/lucene-core.jar;%thisDir%/lib/mail.jar;%thisDir%/lib/netcdfAll-latest.jar;%thisDir%/lib/slf4j-jdk14.jar;%thisDir%/lib/activation.jar -Xms1000M -Xmx1000M gov.noaa.pfel.coastwatch.netcheck.NetCheck NetCheck.xml %1
