...
public class Gif89Encoder {
  ...
  public final static int DYNAMIC_PALETTE = GifColorTable.DYNAMIC_PALETTE; //use first 256 colors found in image
  public final static int WEB216_PALETTE =  GifColorTable.WEB216_PALETTE;  //find nearest colors in standard web 216 color palette
  public final static int DITHERED_WEB216_PALETTE =  GifColorTable.DITHERED_WEB216_PALETTE;  //find nearest colors in standard web 216 color palette, using dithering
  ...
  //----------------------------------------------------------------------------
  /** 
   * Use this constructor if you want to specify the WEB216_PALETTE.
   * Added by Bob Simons.
   */
  ...
  /**
   * This is the like the constructor above, but allows you to specify the palette.
   * Added by Bob Simons.
   */
...
class GifColorTable {
  ...
  public final static int DYNAMIC_PALETTE = 0; //use first 256 colors found in image
  public final static int WEB216_PALETTE  = 1; //find nearest colors in standard web 216 color palette
  public final static int DITHERED_WEB216_PALETTE  = 2; //find nearest colors in standard web 216 color palette, with dithering
  ...
  GifColorTable(int palette)
  {
    if (palette != WEB216_PALETTE &&
        palette != DITHERED_WEB216_PALETTE) 
