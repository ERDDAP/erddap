...
/**
 * Holds a DODS Server <code>sqlList</code> value.
 *
 * @version $Revision: 1.2.2.1 $
 * @author ndp
 * @see SDList
 */
public class sqlList extends SDList {

    private boolean Debug = false;

    /** Constructs a new <code>sqlList</code>. */
    public sqlList() {
        super();
    }

    /**
     * Constructs a new <code>sqlList</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlList(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
        ...
        throw new NoSuchVariableException("Lists are not implemented for Generic SQL Servers");
    }
