 ...
 * @see BaseType
 */
public class sqlGrid extends SDGrid {

    /** Constructs a new <code>sqlGrid</code>. */
    public sqlGrid() {
        super();
    }

    /**
     * Constructs a new <code>sqlGrid</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlGrid(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
        ...
        throw new NoSuchVariableException("Grids are not implemented for SQL Servers");
    }
