...
/**
 * Holds a DODS Server <code>sqlUI32</code> value.
 *
 * @version $Revision: 1.3.2.1 $
 * @author ndp
 * @see BaseType
 */
public class sqlUI32 extends SDUInt32 {

    //private static final boolean _Debug = false;

    /** Constructs a new <code>sqlUI32</code>. */
    public sqlUI32() {
        super();
    }

    /**
     * Constructs a new <code>sqlUI32</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlUI32(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
        ...
        try {
            ...
            switch (rsmd.getColumnType(column)) {
                ...
                case Types.INTEGER:
                    ...
                    b = result.getInt(column);
                    break;

                case Types.BIGINT:

                    //WARNING! LOSS OF PRECISION RIGHT HERE!
                    b = (int) result.getLong(column);
                    break;
        ...
        if (Debug.isSet("sqlRead")) System.out.println("UInt32 received from SQl Query: \"" + b + "\"");
