...
/**
 * Holds a DODS Server <code>sqlI16</code> value.
 *
 * @version $Revision: 1.3.2.1 $
 * @author ndp
 * @see BaseType
 */
public class sqlI16 extends SDInt16 {

    //private static final boolean _Debug = false;

    /** Constructs a new <code>sqlI16</code>. */
    public sqlI16() {
        super();
    }

    /**
     * Constructs a new <code>sqlI16</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlI16(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
        ...
        if (Debug.isSet("sqlRead")) System.out.println("Int16 received from SQl Query: \"" + b + "\"");
