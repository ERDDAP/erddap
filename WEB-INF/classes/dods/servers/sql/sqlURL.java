...
public class sqlURL extends SDURL {
    ...
    /** Constructs a new <code>sqlURL</code>. */
    public sqlURL() {
        super();
    }

    /**
     * Constructs a new <code>sqlURL</code> with name <code>n</code>.
     * @param n the name of the variable.
     */
    public sqlURL(String n) {
        super(n);
    }
    ...
    public boolean read(String datasetName, Object specialO)
        ...
        if (Debug.isSet("sqlRead")) System.out.println("URL received from SQl Query: \"" + b + "\"");
