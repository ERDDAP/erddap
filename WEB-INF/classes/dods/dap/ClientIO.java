...
/**
 * Client-side serialization for DODS variables (sub-classes of <code>BaseType</code>). This does
 * not send the entire class as the Java <code>Serializable</code> interface does, rather it sends
 * only the binary data values. Other software is responsible for sending variable type information
 * (see <code>DDS</code>).
 *
...
public interface ClientIO {
   ...
   * @see DataDDS
   */
  public void deserialize(DataInputStream source, ServerVersion sv, StatusUI statusUI)
