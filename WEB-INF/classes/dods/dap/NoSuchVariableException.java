...
public class NoSuchVariableException extends DDSException {
  /**
   * Construct a <code>NoSuchVariableException</code> with the specified detail message.
   *
  ...
  /**
   * Construct a <code>NoSuchVariableException</code> with the specified message and DODS error code
