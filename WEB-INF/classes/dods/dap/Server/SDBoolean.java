 ...
 * @see BaseType
 */
public abstract class SDBoolean extends DBoolean
   ...
   * will not have sensible responses to all of the relational operators (e.g. DBoolean won't know
  ...
  public void serialize(String dataset, DataOutputStream sink, CEEvaluator ce, Object specialO)
    ...
    if (ce.evalClauses(specialO)) externalize(sink);
  }
}
