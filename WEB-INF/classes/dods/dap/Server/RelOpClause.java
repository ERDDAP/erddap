...
/**
 * Represents a clause which compares subclauses, using one of the relative operators supported by
 * the Operator class.
 *
 * @author joew
 * @see Operator
...
public class RelOpClause extends AbstractClause implements TopLevelClause {
  ...
  /**
   * Creates a new RelOpClause. If the lhs and all the elements of the rhs are constant, the
   * RelOpClause will be flagged as constant, and evaluated immediately.
   *
   * @param operator The operator invoked by the clause
   * @param lhs The left-hand side of the comparison.
   * @param rhs A list of SubClauses representing the right-hand side of the comparison.
   * @throws SDODSException Thrown if the clause is constant, but the attempt to evaluate it fails.
   */
