...
/**
 * A Factory for BaseType objects. The DDS parser must implement this interface so that specific
 * instances of <code>DByte</code>, and other <code>BaseType</code>s, can be created.
 *
 * <p>DDS and its parser will use this interface to create specific instances of the various data
 * type classes in DODS. There is an implementation of this interface which creates instances of the
 * <code>DByte</code>, etc. classes. If a new set of classes are defined (e.g. <code>NC_Byte</code>,
 * etc.) this interface should be implemented for those classes such that the methods return
