...
/**
 * This class is a convenient place to store the major and minor version number of the remote
 * server, as well as the full version string. It is used so that classes which implement ClientIO
 * don't need any knowledge of the DDS class.
 *
...
public class ServerVersion {
  ...
  public ServerVersion(String ver) {
    ...
    if (verIndex != -1) {
      ...
      if (dotIndex != -1) {
        ...
        if (minorDotIndex != -1) minor = Integer.parseInt(minorString.substring(0, minorDotIndex));
        else minor = Integer.parseInt(minorString);
      }
    }
  }
  ...
  /**
   * Returns the DODS core version as a <code>String</code>. This was a convenient place to put this
   * information, rather than creating a new class.
   *
