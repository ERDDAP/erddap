...
public class DASParser implements DASParserConstants {
  ...
  public final void AttrTuple() throws ParseException, DASException {
    ...
    try {
      ...
      error(
          attrTupleMsg
              + "\n"
              + "The offending line contained the token: '"
              + t
              + "'\n"
  ...
  void addBadAttribute(String container_name, int type, String name, String value, String msg)
    ...
    // string to an attribute in the container called `<name_explanation.'.
      ...
      if (a != null) errorContainer = a.getContainer(); // get value as container
      else errorContainer = topOfStack().appendContainer(errorContainerName);

      // Arg four == false --> supress type/value checking.
      errorContainer.appendAttribute(name, type, value, false);
      errorContainer.appendAttribute(
          name + "_explanation", dods.dap.Attribute.STRING, "\"" + msg + "\"");
    }
  }

  String aOrAn(String subject) throws ParseException {
    String vowels = "aeiouAEIOUyY";
    if (vowels.indexOf(subject.charAt(1)) >= 0) return "an";
    else return "a";
  }
  ...
  private final int[] jj_la1_0 = {
    0x40, 0x40, 0x3ffc0, 0x200000, 0x200000, 0x200000, 0x200000, 0x200000, 0x200000, 0x200000,
    0x200000, 0x200000, 0x60000, 0x3ffc0,
  };
