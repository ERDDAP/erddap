...
public class DataReadException extends DDSException {
  /**
   * Construct a <code>DataReadException</code> with the specified detail message.
   *
  ...
  /**
   * Construct a <code>DataReadException</code> with the specified message and DODS error code see (
   * <code>DODSException</code>).
   *
