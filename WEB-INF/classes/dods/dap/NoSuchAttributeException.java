...
/**
 * Thrown by <code>AttributeTable</code> when an attempt is made to alias to a non-existent
 * attribute.
 *
...
public class NoSuchAttributeException extends DASException {
  /**
   * Construct a <code>NoSuchAttributeException</code> with the specified message.
   *
  ...
  /**
   * Construct a <code>NoSuchAttributeException</code> with the specified message and DODS error
