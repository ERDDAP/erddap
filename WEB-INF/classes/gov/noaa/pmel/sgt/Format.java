...
public class Format {
  ...
  /**
   * Formats the number following printf conventions. Main limitation: Can only handle one format
   * parameter at a time Use multiple Format objects to format more than one number
   *
   * @param s the format string following printf conventions The string has a prefix, a format code
   *     and a suffix. The prefix and suffix become part of the formatted output. The format code
   *     directs the formatting of the (single) parameter to be formatted. The code has the
   *     following structure
   *     <ul>
   *       <li>a % (required)
   ...
   *             <dt>#
   *             <dd>use "alternate" format. Add 0 or 0x for octal or hexadecimal numbers. Don't
   *                 suppress trailing zeroes in general floating point format.
   *           </dl>
   ...
   *             <dt>e, E
   *             <dd>floating point number in exponential notation (scientific format). The E format
   *                 results in an uppercase E for the exponent (1.14130E+003), the e format in a
   *                 lowercase e.
   *             <dt>g, G
   *             <dd>floating point number in general format (fixed format for small numbers,
   *                 exponential format for large numbers). Trailing zeroes are suppressed. The G
   *                 format results in an uppercase E for the exponent (if any), the g format in a
   *                 lowercase e.
   *             <dt>d, i
