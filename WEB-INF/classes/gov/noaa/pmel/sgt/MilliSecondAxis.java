...
public class MilliSecondAxis implements TimeAxisStyle {
  ...
  public void computeDefaults(GeoDate delta) {
    ...
    if (msec > 2000)
      defaultMajorLabelInterval_ = 2;   //e.g., 2=everyOther  getMajorValue->seconds
    //else 1

    //System.out.println("  MilliSecondAxis range msec=" + msec + " majorLabelInterval=" + defaultMajorLabelInterval_ +
    //    " minorLabelInter=" + defaultMinorLabelInterval_ + " increment=" + incrementValue__);
  }
  public int getMinorValue(GeoDate time) {
    //System.out.println("  gmtMillis time=" + time.getTime() + " sec=" + time.getGMTSeconds() + " millis=" + time.getGMTMillis());
  ...
  public String toString() {
    return "MilliSecondAxis inc=" + incrementValue__ + " minorLabelInterval=" + defaultMinorLabelInterval_;
  }
}
