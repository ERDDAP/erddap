...
public class TableFromMultidimNcFile {
    ...
    private class VarData {
        ...
        public static VarData fromVariableIfDimsMatch(TableFromMultidimNcFile tableMultidim, Variable tVar, VarData other, int nd0) throws Exception {
     ...
     *   If standardizeWhat != 0, the constraints are applied to the unpacked variables.
    ...
    private VarData findVarToLoad(StringArray loadVarNames, int standardizeWhat, int nd0, ArrayList<Variable> loadVars,
            ArrayList<Dimension> loadDims, int nLoadVars, BitSet loaded, Table allIndicesTable, Table lut, boolean getMetadata) throws Exception {
    ...
    private void addVarAndIndicies(int nd0, ArrayList<Dimension> loadDims, BitSet loaded, Table allIndicesTable, Table lut,
    ...
    private void loadVars(StringArray loadVarNames, StringArray loadDimNames, ArrayList<Variable> loadVars, ArrayList<Dimension> loadDims, int nd0, int nAllVars, List<Variable> allVars) {
