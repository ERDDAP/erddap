...
public class HtmlWidgets {
    ...
    /** This is the standard start of an HTML 5 document up to and including the 
     * 'head' and 'meta charset' tags. */
    public final static String DOCTYPE_HTML = 
        "<!DOCTYPE html>\n" +
        "<html lang=\"en-US\">\n" +
        "<head>\n" +
        "  <meta charset=\"UTF-8\">\n";    
    ...
    */
    ...
    public final static String JAVASCRIPT_VOID = "javascript:void(0);";

    /** This is the HTML for standalone Back button (which uses the browsers
...
//        "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &bull; Edge: \n" +  ??? 2019-12-19 search yielded: it should be supported but administrator may have disabled it. 
    ...
    /** 
     * This returns the html which displays an image (from a local file!)
     * in a htmlTooltip represented by a '?' icon.
     *
     * @param localFileName
     * @param xmlEncodedUrlFileName
     * @param questionMarkImageUrl
     * @return the html which displays an image (from a local file!)
     *   in a htmlTooltip represented by a '?' icon (or "" if trouble).
     */
    public static String imageInTooltip(String localFileName, String xmlEncodedUrlFileName,
        ...
        try {
            ...
            //from https://stackoverflow.com/questions/1559253/java-imageio-getting-image-dimensions-without-reading-the-entire-file
            try (ImageInputStream in = ImageIO.createImageInputStream(
                ...
                if (in != null) {
                    ...
                    return htmlTooltipImage(
                        ...
                        "<img src=\"" + xmlEncodedUrlFileName + 
                            "\" alt=\"" + xmlEncodedUrlFileName + 
                            "\" width=\"" + width + "px\" height=\"" + height + "px\">",
                        //a failed attempt to have this work without pre-specifying width and height:
                        //" onload=\"var ps = this.parentElement.style; ps.width=this.style.width+'px'; ps.height=this.style.height+'px'; \">", 
                        ""); //other
                }
            }
        } catch (Exception e2) {
            String2.log("Caught Exception while making imageInTooltip for " + localFileName + ":\n" +
     ...
     */
    public static String cssTooltipImage(String img1Url, String img1Alt, String img1Other,
        String img2Url, String img2ID) {
        ...
        return 
            ...
            "<img " + img1Other + "src=\"" + img1UrlEncoded + 
                ...
                "  onmouseover=\"var el=document.getElementById('" + img2ID + 
                "'); el.setAttribute('src',el.getAttribute('data-src'));\">",  //I use data-src to tell browser to delay loading this image until it is visible
            "style=\"padding:0px; max-width:90%;\"",  
            "<img style=\"max-width:100%;\" " +
                    "id=\"" + img2ID + "\" class=\"B\" src=\"" + loadingUrlEncoded + "\"\n" + //vertical-align: 'b'ottom
                "  data-src=\"" + XML.encodeAsHTMLAttribute(img2Url) + //I use data-src to tell browser to delay loading this image until it is visible
     ...
     * This is based on CSS-only image tooltip at 
     *   https://codepen.io/electricalbah/pen/eJRLVd (URL works in browser but not in link tests)
     * This code was contributed by Marco Alba and slightly modified 
     * (so the image data occurs only once in the HTML document) by Bob Simons.
     *
     * @param img1Url for the image for the user to hover over, e.g., questionMarkImageUrl.
     *   It must be in the images directory.
     * @param img1Alt alt text for the imgUrl, e.g., "?". It will be encoded as HTML attribute.
    ...
    public static String cssTooltipImageBase64(String img1Url, String img1Alt, String img1Other,
        ...
        return 
            ...
            cssTooltip(
                ...
                "<img style=\"max-width:100%;\" " +
                    "id=\"" + img2ID + "\" class=\"B\" src=\"" + loadingUrlEncoded + "\"\n" + //vertical-align: 'b'ottom  
                    " data-src=\"" + img2Url + "\"" + //I use data-src to tell browser to delay loading this image until it is visible
            ...
            "<button type=\"button\" onclick=\"javascript:if(navigator.clipboard==undefined){alert('" + 
                ...
                "');return false};navigator.clipboard.writeText(" +
                    "document.getElementById('" + img2ID + "').getAttribute('data-src')" +  //reuse img2Url data from img2ID.data-src
                ");\" style=\"cursor: pointer; cursor: hand;\" >"+ EDStatic.copyTextToClipboardAr[language] + "</button>\n" +                

            "<button type=\"button\" onclick=\"javascript:if(navigator.clipboard==undefined){alert('" + 
                EDStatic.copyToClipboardNotAvailableAr[language] +"');return false};"+
            " var img = new Image();"+
            " img.onload = () => {"+
            ...
            " img.src = document.getElementById('" + img2ID + "').getAttribute('data-src');" +  //reuse img2Url data from img2ID.data-src
            " return false;\""+                 
            " style=\"cursor: pointer; cursor: hand;\" >"+ EDStatic.copyImageToClipboardAr[language] + "</button>";
     ...
     */
    public static String cssTooltipVideo(String imgUrl, String imgAlt, String imgOther,
        String vidUrl) {

        return cssTooltip(
            "<img " + imgOther + "src=\"" + XML.encodeAsHTMLAttribute(imgUrl) + 
     ...
     */
    public static String cssTooltipAudio(String imgUrl, String imgAlt, String imgOther,
        String audUrl) {
     ...
     * @return the mime type for an audio file (or "" if you shouldn't show
     *   an audio control)
     */
    public static String audioMimeType(String ext) {
        String extLC = ext.toLowerCase();
        return  
            extLC.startsWith(".aif")? "x-aiff" : //aiff, aifc
            extLC.equals(".au")?      "basic" :
            extLC.equals(".mp3")?     "mpeg" :
            extLC.equals(".ogg")?     "ogg" : 
            extLC.equals(".wav") ||
            extLC.equals(".wave")?    "wav" :
            ""; 
    }
    ...
    public String beginForm(String name, String method, String url, String other) {
        ...
        return 
            ...
            "  action=\"" + (String2.isSomething(url)?
                XML.encodeAsHTMLAttribute(url) : JAVASCRIPT_VOID) + 
            "\" " + 
            other + " >\n";
    }
    ...
    public String beginTable(int lineWidth, String otherStyle, String otherAtts) { 
        ...
        return 
            "<table style=\"border:" + lineWidth + "px; " +
            "border-collapse:collapse; " + otherStyle + "\" " + 
            otherAtts + ">\n";
    }
     ...
     *    (or null or "" if you don't need anything submitted with the form)
     * @param tooltip If htmlTooltips is true, this is already html.
     *     If it is false, this is plain text.  Or "" if no tooltip.
     ...
     * @param buttonJS is addtional javascript to be done when a button is pushed,
     *   most commonly " sel.onchange();" which triggers the select widget's
     *   onchange javascript.
     */    
    public String select(String name, String tooltip, int nRows,
        ...
        sb.append("<select name=\"" + XML.encodeAsHTMLAttribute(name) + 
            "\" size=\"" + Math.max(1, nRows) + "\"" +
            completeTooltip(tooltip) +
            " " + other + " >\n");

        String spacer = nOptions < 20? "" : ""; //save space if lots of options //was 6 spaces if few options
...
*/
     ...
     *     For plain text, use XML.encodeAsPreHTML(plainText, 82).
     * @param other e.g., "onclick=\"pleaseWait();\""
    ...
    public String slider(int sliderNumber, int bgWidth, String other) {
        return //order is important
            "      <img id=\"sliderLeft" + sliderNumber + 
    ...
    public String dualSlider(int sliderNumber, int bgWidth, String other) {
        return //order is important
            ...
            "      <img id=\"sliderRight" + sliderNumber + 
...
"<img \n" +
"   id=\"worldImage\" src=\"" + XML.encodeAsHTMLAttribute(imageUrl) + 
...
"  <area href=\"" + JAVASCRIPT_VOID + "\" shape=RECT coords=\"0,0," + (imageWidth-1) + "," + (imageHeight-1) + 
...
//            "https://coastwatch.pfeg.noaa.gov/erddap/images/"); //SANS_SERIF_STYLE);
        ...
        sb.append(cssTooltipImageBase64(
            "http://localhost:8080/cwexperimental/images/QuestionMark.png", "?", "",
...
"</td></tr>\n" +
"<tr><td>\n" +
widgets.dualSlider(0, bgWidth, "") + //was "style=\"text-align:left\""
"</td></tr>\n" +
"\n" +
...
"<tr><td>\n" +
widgets.slider(1, bgWidth, "") + //was "style=\"text-align:left\"") +
"</td></tr>\n" +
"\n" +
...
"</td></tr>\n" +
"<tr><td>\n" +
widgets.dualSlider(3, bgWidth, "") +  //was style=\"text-align:left\"") +
"</td></tr>\n" +
...
"</td></tr>\n" +
"<tr><td>\n" +
widgets.dualSlider(4, bgWidth, "") +  //was "style=\"text-align:left\"") +
"</td></tr>\n" +
...
"</td></tr>\n" +
"<tr><td>\n" +
widgets.slider(5, bgWidth, "") + //was "style=\"text-align:left\"") +
"</td></tr>\n" +
...
"</td></tr>\n" +
"<tr><td>Euro \\u20AC encodedAsHtml=" + XML.encodeAsHTML("\u20AC") + 
...
"<img src=\"" + imageDir + "minus1000.gif\" alt=\"-1000\">" +
"<img src=\"" + imageDir + "minusminus.gif\" alt=\"--\">" +
"<img src=\"" + imageDir + "plus.gif\" alt=\"+\">" +
"<img src=\"" + imageDir + "plus10.gif\" alt=\"+10\">" +
"<img src=\"" + imageDir + "plus100.gif\" alt=\"+100\">" +
"<img src=\"" + imageDir + "plus1000.gif\" alt=\"+1000\">" +
"<img src=\"" + imageDir + "plusplus.gif\" alt=\"++\">\n" +
"<br>" +
"<img src=\"" + imageDir + "data.gif\" alt=\"data\">" +
"<img src=\"" + imageDir + "i.gif\" alt=\"i\">" +
"<img src=\"" + imageDir + "resize.gif\" alt=\"resize\">" +
"<img src=\"" + imageDir + "source.gif\" alt=\"source\">" +
"<img src=\"" + imageDir + "title.gif\" alt=\"title\">" +
"<img src=\"" + imageDir + "URL.gif\" alt=\"URL\">" +
"<img src=\"" + imageDir + "x.gif\" alt=\"x\">\n" + 
"</td></tr>\n" +
"</table>\n");
...
"  <td rowSpan=7 class=\"N\">" + twoClickMap[0] + "text on same row!" + twoClickMap[1] +
   "</td>\n" +
"</tr>\n" +
