...
public class AttributedString2 {
     ...
     * Note that italic is done with TextAttribute.POSTURE and Float.valueOf(0.2).
     *
     * @param attribute  e.g., TextAttribute.BACKGROUND
     * @param object   e.g., color
     */
                ...
                if (po2 < 0)
                    ...
                    if (tag.equals("b") || tag.equals("strong") ) {
                        ...
                        if (boldStart == as2.size()) {
                            ...
                            as2.addAttribute(TextAttribute.WEIGHT, Float.valueOf(2), 
                                boldStart, as2.size());
                            boldStart = -1;
                    ...
                    //italic
                        ...
                        if (italicStart == as2.size()) {
                            ...
                            as2.addAttribute(TextAttribute.POSTURE, Float.valueOf(0.2f), 
