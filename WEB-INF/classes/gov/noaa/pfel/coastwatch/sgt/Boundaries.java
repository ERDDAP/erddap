...
public class Boundaries  {
     ...
     * <br>Crude estimate: 100 takes 2 MB per type.  
     * <br>There are 3 types of boundaries (National, State, Rivers).  
     */
    ...
    public final static String NATIONAL_FILE_NAMES[] = {
        "nationalBoundariesf.double", "nationalBoundariesh.double", "nationalBoundariesi.double", 
        "nationalBoundariesl.double", "nationalBoundariesc.double"};
    ...
    public final static String STATE_FILE_NAMES[] = {
        "stateBoundariesf.double", "stateBoundariesh.double", "stateBoundariesi.double", 
        "stateBoundariesl.double", "stateBoundariesc.double"};
    public final static String RIVER_FILE_NAMES[] = {
    ...
    public SGTLine getSgtLine( 
        ...
        if (resolution >= 3) {
            ...
            nCoarse++; 
            tCoarse = "*"; 
            sgtLine = readSgtLineDouble(directory + fileNames[resolution], 
...
//                    String2.log(
    ...
    /**
     * This converts an .asc SGTLine datafile into a .double SGTLine datafile.
     * The .double file has groups of pairs of doubles:
     * <br>NaN,    nPoints
     * <br>minLon, minLat
     * <br>maxLon, maxLat
     * <br>nPoints pairs of lon, lat
     *
    ...
    public static void bobConvertAll() throws Exception {
        ...
        for (int type = 0; type < types.length; type++) {
            for (int res = 0; res < ress.length; res++) {
                convertSgtLine(dir + types[type] + ress[res] + ".asc",
                               dir + types[type] + ress[res] + ".double");
            }
        }
    }
    ...
    public String statsString() {
        return 
            id + ": nCached=" + cache.size() + " of " + CACHE_SIZE +
    ...
    public static Boundaries getNationalBoundaries() {
        return new Boundaries("NationalBoundaries", 
            REF_DIRECTORY, NATIONAL_FILE_NAMES, GMT_FORMAT);
    }

    /** This is a convenience method to construct a national boundaries object. */
    public static Boundaries getStateBoundaries() {
        return new Boundaries("StateBoundaries", 
            REF_DIRECTORY, STATE_FILE_NAMES, GMT_FORMAT);
    }
