...
public class HdfVGroup extends HdfTag {
     ...
     */
    public HdfVGroup(short referenceNumber, short[] tag_n, short[] ref_n, 
    ...
    public void writeData(DataOutputStream stream) throws Exception {
        ...
        for (int i = 0; i < nelt; i++)
            stream.writeShort(ref_n[i]); //Reference number of the nth member of the Vgroup (16-bit integer)
     ...
     * @throws Exception
     */
    public HdfVGroup(short referenceNumber, int length, DataInputStream stream)
        throws Exception {
