/* 
 * CWBrowserSA Copyright 2005, NOAA.
...
/**
 * The CoastWatch Browser for South America. See info for Browser.java.
 *
 * @author Bob Simons (bob.simons@noaa.gov) 2005-02-10
 */
public class CWBrowserSA extends Browser {

    /**
     * Constructor
     */
    public CWBrowserSA() throws Exception {
        super("gov.noaa.pfel.coastwatch.CWBrowserSA");
    }
