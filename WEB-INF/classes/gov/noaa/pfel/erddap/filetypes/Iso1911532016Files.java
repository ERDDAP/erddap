...
@FileTypeClass(
    ...
    fileTypeName = ".iso19115_3_2016",
    infoUrl = "https://en.wikipedia.org/wiki/Geospatial_metadata",
    versionAdded = "2.29.0",
    contentType = "application/xml")
public class Iso1911532016Files extends FileTypeInterface {
  ...
  public void writeTableToStream(DapRequestInfo requestInfo) throws Throwable {
    ...
    try (BufferedWriter writer =
      ...
      requestInfo
          .getEDDTable()
          .writeISO19115(requestInfo.language(), writer, ISO_VERSION.ISO19115_3_2016);
    }
  }
  ...
  public String getHelpText(int language) {
    return EDStatic.messages.get(Message.FILE_HELP_ISO19115_3_2016, language);
  }
}
