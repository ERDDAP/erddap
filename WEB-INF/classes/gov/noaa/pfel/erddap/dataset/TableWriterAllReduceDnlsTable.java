...
/**
 * TableWriterAllReduceDnlsTable is a subclass of TableWriterAll that 
 * just keeps the files in one directory and accumulates a list
 * of immediate subdirectory short names. 
 *
