...
public class OutputStreamViaAwsS3 extends BufferedOutputStream {
     ...
     */
    public OutputStreamViaAwsS3(OutputStreamFromHttpResponseViaAwsS3 tParent, String tCharacterEncoding) throws IOException {
    ...
    public void close() throws IOException {
        ...
        Object fileTypeInfo[] = OutputStreamFromHttpResponse.getFileTypeInfo(parent.request, parent.fileType, parent.extension);
...
//tell Aws about other file attributes when file accessed as from web site
        ...
        SSR.uploadFileToAwsS3(EDStatic.awsS3OutputTransferManager, fullLocalFileName, fullAwsUrl, contentType);
