    ...
    public GridDataRandomAccessorInMemory(GridDataAccessor gridDataAccessor) throws Throwable {
        try {
            if (!gridDataAccessor.rowMajor())
                throw new RuntimeException("GridDataRandomAccessorInMemory.constructor requires the gridDataAccessor to be rowMajor.");
            ...
            if (longCapacity >= Integer.MAX_VALUE)
                throw new RuntimeException("GridDataRandomAccessorInMemory.constructor requires totalIndex.size=" + 
                    longCapacity + " to be <" + Integer.MAX_VALUE + ".");
