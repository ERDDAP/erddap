...
/**
 * This class represents a table of data from a collection of jsonlCSV files. See
...
public class EDDTableFromJsonlCSVFiles extends EDDTableFromFiles {
   ...
   */
  public EDDTableFromJsonlCSVFiles(
      String tDatasetID,
  ...
  /**
   * This generates a ready-to-use datasets.xml entry for an EDDTableFromJsonlCSVFiles. The XML can
