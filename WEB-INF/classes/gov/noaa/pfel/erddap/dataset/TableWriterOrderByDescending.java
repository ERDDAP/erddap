...
/**
 * TableWriterOrderByDescending provides a way to gather all rows, sort them (descending!), then
 * write to some other TableWriter. This functions like SQL's ORDER BY, except in descending order.
 *
 ...
 *
 * @author Bob Simons (was bob.simons@noaa.gov, now BobSimons2.00@gmail.com) 2022-05-26 (based on
 *     TableWriterOrderBy)
 */
public class TableWriterOrderByDescending extends TableWriterAll {
   ...
   */
  public TableWriterOrderByDescending(
      int tLanguage,
      EDD tEdd,
      String tNewHistory,
      String tDir,
