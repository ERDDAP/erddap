...
public abstract class EDDTableFromFiles extends EDDTable implements WatchUpdateHandler {
     ...
     *                                  <ul>
     *                                  <li>"title" - the short (&lt; 80 characters)
     *                                  description of the dataset
     *                                  <li>"summary" - the longer description of
     *                                  the dataset.
     ...
     *                                  graph's legend).
     *                                  <li>"infoUrl" - the url with information
     *                                  about this data set
     *                                  <li>"cdm_data_type" - one of the EDD.CDM_xxx
     *                                  options
     *                                  </ul>
     ...
     *                                  <li>a java.time.format.DateTimeFormatter
     *                                  string
