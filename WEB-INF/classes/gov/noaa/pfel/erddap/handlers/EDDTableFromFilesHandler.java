...
public class EDDTableFromFilesHandler extends State {
  ...
  com.cohort.array.Attributes tGlobalAttributes = new com.cohort.array.Attributes();
  ...
  boolean tRemoveMVRows = true;
  int tStandardizeWhat = Integer.MAX_VALUE;
  String tSpecialMode = "";
  String tCharset = null;
  String tSkipHeaderToRegex = "";
  String tSkipLinesRegex = "";
  int tColumnNamesRow = 1, tFirstDataRow = 2;
