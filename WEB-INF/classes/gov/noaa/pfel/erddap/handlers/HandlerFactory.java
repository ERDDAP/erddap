...
public class HandlerFactory {
    ...
    public static boolean skipDataset(String datasetID, String active, SaxParsingContext context) {
        ...
        if (!skip) {
            ...
            if (isFlagged) {
                String2.log("*** reloading datasetID=" + datasetID +
                ...
                if (oldEdd == null)
                    oldEdd = erddap.tableDatasetHashMap.get(datasetID);
                if (oldEdd != null) {
                ...
                FileVisitorDNLS.pruneCache(EDD.decompressedDirectory(datasetID), 2, 0.5); //remove as many files as possible
                ...
                if (oldEdd != null) {
                    ...
                    if (minutesOld < oldEdd.getReloadEveryNMinutes()) {
                        ...
                        if (reallyVerbose) String2.log("*** skipping datasetID=" + datasetID +
