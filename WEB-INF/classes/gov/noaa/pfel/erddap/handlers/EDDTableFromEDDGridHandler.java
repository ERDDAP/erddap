...
public class EDDTableFromEDDGridHandler extends State {
    ...
    public EDDTableFromEDDGridHandler(SaxHandler saxHandler, String datasetID, State completeState, SaxParsingContext context) {
        super(saxHandler);
    ...
    public com.cohort.array.Attributes tAddGlobalAttributes = null;
    ...
    public void endElement(String uri, String localName, String qName) throws Throwable {
        ...
        switch (localName) {
            ...
            case "dataset" -> {
                EDD dataset = new EDDTableFromEDDGrid(context.getErddap(), datasetID,
                        ...
                        tReloadEveryNMinutes, tChildDataset
                );
