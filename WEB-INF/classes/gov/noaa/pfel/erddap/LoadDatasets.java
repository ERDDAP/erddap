...
public class LoadDatasets extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            parseUsingSimpleXmlReader(xmlReader, nTry, nDatasets, changedDatasetIDs, orphanIDSet, datasetIDSet, duplicateDatasetIDs, datasetsThatFailedToLoadSB, tUserHashMap);
...
//    skip = true;
    ...
    private InputStream getInputStream(InputStream inputStream) throws Exception {
        if (inputStream == null) {
            ...
            return File2.getBufferedInputStream(newFileName);  //not File2.getDecompressedBufferedInputStream(). Read file as is.
        } else {
