...
public class Erddap extends HttpServlet {
    ...
    /**
     * This responds by sending out the "Information" Html page (information.html, EDStatic.theLongDescriptionHtml).
     *
     * @param language the index of the selected language
     * @param loggedInAs  the name of the logged in user (or null if not logged in)
     */
    ...
    public void doLogin(int language, HttpServletRequest request, HttpServletResponse response, 
        ...
        if (EDStatic.authentication.equals("custom")) {
            ...
            Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
                ...
                queryString, EDStatic.LogInAr[language], out);
            try {
                writer.write("<div class=\"standard_width\">\n");
    ...
    public void doDataProviderForm(int language, HttpServletRequest request, 
        ...
        OutputStream out = getHtmlOutputStreamUtf8(request, response);
        Writer writer = getHtmlWriterUtf8(language, tLoggedInAs, 
...
*/);
    ...
    public void doDataProviderForm1(int language, HttpServletRequest request, 
        ...
        try {
            ...
            writer = getHtmlWriterUtf8(language, tLoggedInAs, 
    ...
    public void doDataProviderFormDone(int language, HttpServletRequest request, 
        ...
        try {
            ...
            writer = getHtmlWriterUtf8(language, tLoggedInAs, 
                ...
                queryString, EDStatic.dataProviderFormDoneAr[language], out);
            writer.write(
                "<div class=\"standard_width\">\n" +
...
//     "/index.html\">ERDDAP home page</a>.\n"
    ...
    public void doRestHtml(int language, HttpServletRequest request, 
        ...
        Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
            ...
            queryString, "RESTful Web Services", out);
        try {
    ...
    public void doDap(int language, int requestNumber, HttpServletRequest request, 
        ...
        String endOfRequestUrl = hasDatasetID? requestUrl.substring(datasetIDStartsAt) : ""; //datasetID or something else in that position
        ...
        if (endOfRequestUrl.equals("documentation.html")) {
            ...
            Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
                ...
                queryString, protocol + " Documentation", out); 
            try {
                writer.write("<div class=\"standard_width\">\n" +
    ...
    public void doFiles(int language, int requestNumber, HttpServletRequest request, 
        ...
        if (id.length() == 0) {
            ...
            table.addColumn("Last modified", (new LongArray(new long[]{EDStatic.startupMillis})).setMaxIsMV(true));
            table.addColumn("Size",          (new LongArray(new long[]{Long.MAX_VALUE})).setMaxIsMV(true)); //it is made on-the-fly, so size not known           
            ...
            Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
                ...
                queryString, "Browse Source Files", out);
            try {
...
//tally other things?
    ...
    public void doSosDocumentation(int language, int requestNumber, HttpServletRequest request, 
        ...
        Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
            ...
            queryString, "SOS Documentation", out);
        try {
            writer.write(
                "<div class=\"standard_width\">\n" +
...
//tally other things?
            ...
            Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
                ...
                queryString, XML.encodeAsHTML(eddGrid.title()) + " - WCS", out);
            try {
                writer.write("<div class=\"standard_width\">\n");
    ...
    public void doWcsDocumentation(int language, int requestNumber, HttpServletRequest request, 
        ...
        Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
            ...
            queryString, "WCS Documentation", out);
        try {
            writer.write(
                "<div class=\"standard_width\">\n" +
...
//these 3 are demos.  Remove them (and links to them)?  add update(language)?
    ...
    public void doWmsDocumentation(int language, int requestNumber, HttpServletRequest request, HttpServletResponse response,
        ...
        Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
            ...
            queryString, "WMS Documentation", out);
        try {
...
"</script>\n");
        ...
        try {
            ...
            writer.write(
                EDStatic.startBodyHtml(language, loggedInAs, 
...
"<br/>\n");
    ...
    public void doSlideSorter(int language, int requestNumber, HttpServletRequest request, HttpServletResponse response,
        ...
        Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
            ...
            queryString, EDStatic.slideSorterAr[language], out); 
        try {
    ...
    public void doSearch(int language, int requestNumber, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            String error = MustBe.getShortErrorMessage(t);
            out = getHtmlOutputStreamUtf8(request, response);
            writer = getHtmlWriterUtf8(language, loggedInAs, 
                "search/index.html", //was endOfRequest, 
                queryString, EDStatic.searchTitleAr[language], out);
            try {
                //you are here      Search
                writer.write(
                    "<div class=\"standard_width\">\n" +
...
"</OpenSearchDescription>\n");
    ...
    public void doAdvancedSearch(int language, int requestNumber, HttpServletRequest request, HttpServletResponse response,
        ...
        if (toHtml) { 
            ...
            writer = getHtmlWriterUtf8(language, loggedInAs, 
                ...
                queryString, EDStatic.advancedSearchAr[language], out); 
            try {
                HtmlWidgets widgets = new HtmlWidgets(true, EDStatic.imageDirUrl(loggedInAs, language)); //true=htmlTooltips
     ...
     *
     * <p>REJECTED: Especially for Lucene, could you speed this up by adding a 
     * maxHits parameter so this method doesn't have to look up all the datasetID's
     * (which is timeconsuming if e.g., 30,000 datasets).
     * No. Because 
     * <br>1) The number of hits is shown to user, so truncating would make that incorrect.
     * <br>2) Sometimes the caller resorts the results (e.g., by datasetID), 
    ...
    public void doCategorize(int language, int requestNumber, HttpServletRequest request, 
        ...
        if (part2.equals("index.html")) {
            ...
            OutputStream out = getHtmlOutputStreamUtf8(request, response);
            Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
                "categorize/" + attributeInURL + "/" + categoryName + "/index.html", //was endOfRequest, 
                queryString, "Categorize", out); 
            try {
                writer.write(
                    "<div class=\"standard_width\">\n" +
...
//??? Make it so ERDDAP admin must also okay subscription requests (so admin can screen out malicious requests)?
    ...
    public void doConvertFipsCounty(int language, int requestNumber, HttpServletRequest request, 
        ...
        Writer writer = getHtmlWriterUtf8(language, loggedInAs, 
            ...
            queryString, "Convert FIPS County", out); 
        try {
            writer.write(
                "<div class=\"standard_width\">" +
...
"\n");
     ...
     * @param language the index of the selected language
     * @param loggedInAs  the name of the logged in user (or null if not logged in)
     * @param endOfRequest   The part after https://..../erddap/
     ...
     * @throws Throwable if trouble
     */
    Writer getHtmlWriterUtf8(int language, String loggedInAs, String endOfRequest, 
        String queryString, String addToTitle, OutputStream out) throws Throwable {
     ...
     */
    Writer getHtmlWriterUtf8(int language, String loggedInAs, String endOfRequest, 
        String queryString, String addToTitle, String addToHead, OutputStream out) throws Throwable {
