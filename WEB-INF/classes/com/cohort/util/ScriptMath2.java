 ...
 * in com.cohort.Math2 accessible to JexlScript scripts as "Math2.<i>name</i>()" methods.
 * This doesn't include the memory related and sleep related methods.
 *
 * <p>The underlying Math2 class is Copyright (c) 2005 Robert Simons (CoHortSoftware@gmail.com).
...
public class ScriptMath2  {
     ...
     * of the data type. epsilon for floats=fEps=1e-5f
     */
    ...
    /** For security, this is a different object than Math2's random. 
     *  It is private so only accessible via methods in this class. */
     ...
     */
    public final static double meterPerFoot = Math2.meterPerFoot;

    /** 5280 * meterPerFoot */
    public final static double mPerMile = Math2.mPerMile;

    /** mPerMile * 0.001 */
    public final static double kmPerMile = Math2.kmPerMile;
