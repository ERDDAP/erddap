 ...
 *
 * <p><strong>newGCalendar only accounts for daylight saving time if 
 ...
 * will be for standard time (not including daylight saving time, if any).
 *
 ...
 * daylight saving time if that is what your area does) and Zulu (aka GMT and UTC,
 * which doesn't ever use daylight saving time).
 *
...
public class Calendar2 {
    ...
    public final static String SUPPORTED_CALENDARS[] = { 
        "gregorian", "standard"};
    ...
    public final static String ISO8601T6_FORMAT   = "yyyy-MM-dd'T'HH:mm:ss.SSS000";    //WARNING: only useful if S digits 4-6 are '0'. gc doesn't support microseconds.
    public final static String ISO8601T9_FORMAT   = "yyyy-MM-dd'T'HH:mm:ss.SSS000000"; //WARNING: only useful if S digits 4-9 are '0'. gc doesn't support nanoseconds.
    ...
    public final static String ISO8601T6Z_FORMAT  = "yyyy-MM-dd'T'HH:mm:ss.SSS000Z";    //WARNING: only useful if S digits 4-6 are '0'. gc doesn't support microseconds.
    public final static String ISO8601T9Z_FORMAT  = "yyyy-MM-dd'T'HH:mm:ss.SSS000000Z"; //WARNING: only useful if S digits 4-9 are '0'. gc doesn't support nanoseconds.
    public final static DateTimeFormatter ISO_OFFSET_LOCAL_FORMATTER = 
        ...
        DateTimeFormatter.ofPattern("uuuu-MM-dd'T'HH:mm:ssxxxxx"); //offset always ISO formatted e.g., -07:00

    public final static String RFC822_GMT_REGEX = "[a-zA-Z]{3}, [0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012][0-9]:[0-5][0-9]:[0-5][0-9] GMT";
    public final static String RFC822_GMT_FORMAT = "EEE, d MMM yyyy HH:mm:ss 'GMT'";

    // month can be e.g., 9 | 19 | [01]\\D      //avoid uuuu-DDD
    public final static Pattern ISO_DATE_PATTERN     = Pattern.compile("-?\\d{4}-[01]?\\d(|\\-\\d.*)"); 
    public final static Pattern NUMERIC_TIME_PATTERN = Pattern.compile(" *[a-z]+ +since +.*[0-9].*"); //lenient. Test already lowercase string.

    /** This is used to catch e.g. time/1day for cell_methods for some orderBy TableWriters. */
    public final static Pattern TIME_N_UNITS_PATTERN = Pattern.compile("time */ *(\\d+) *([a-z]+)");
    ...
    public final static String digitRegexTimeFormat[] = {
        ...
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]:[0-5][0-9],[0-9]{7,9} UTC", // in practice, I have only seen " UTC"
            "yyyy-DDD'T'HH:mm:ss,SSS000000 'UTC'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]:[0-5][0-9],[0-9]{7,9} GMT", // GMT is rarely used
        ...
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]:[0-5][0-9],[0-9]{4,6} UTC", // in practice, I have only seen " UTC"
            "yyyy-DDD'T'HH:mm:ss,SSS000 'UTC'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]:[0-5][0-9],[0-9]{4,6} GMT", // GMT is rarely used
        ...
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]:[0-5][0-9],[0-9]{1,3} UTC", // in practice, I have only seen " UTC"
            "yyyy-DDD'T'HH:mm:ss,SSS 'UTC'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]:[0-5][0-9],[0-9]{1,3} GMT", // GMT is rarely used
        ...
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9] GMT", 
            "yyyy-DDD'T'HH:mm 'GMT'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9] [+\\-][0-9]{1,2}:[0-9]{2}", 
            "yyyy-DDD'T'HH:mm xxx",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9] [+\\-][0-9]{3,4}", 
            "yyyy-DDD'T'HH:mm xx",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9] [+\\-][0-9]{2}", 
            "yyyy-DDD'T'HH:mm x",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]UTC", 
            "yyyy-DDD'T'HH:mm'UTC'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]:[0-5][0-9]GMT", 
        ...
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9] UTC", 
            "yyyy-DDD'T'HH 'UTC'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9] GMT", 
            "yyyy-DDD'T'HH 'GMT'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9] [+\\-][0-9]{1,2}:[0-9]{2}", 
            "yyyy-DDD'T'HH xxx",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9] [+\\-][0-9]{3,4}", 
            "yyyy-DDD'T'HH xx",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9] [+\\-][0-9]{2}", 
            "yyyy-DDD'T'HH x",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]UTC", 
            "yyyy-DDD'T'HH'UTC'",  
        "-?[0-9]{4}-[0-3][0-9]{2}T[0-2][0-9]GMT", 
        ...
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]:[0-5][0-9] UTC",
            "yyyy-MM-dd HH:mm 'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]:[0-5][0-9] GMT",
        ...
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]:[0-5][0-9][ +\\-][0-9]{2}",
            "yyyy-MM-dd HH:mmx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]:[0-5][0-9]Z",
            "yyyy-MM-dd HH:mm'Z'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]:[0-5][0-9]",
            "yyyy-MM-dd HH:mm", 

        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9] UTC",
            "yyyy-MM-dd HH 'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9] GMT",
            "yyyy-MM-dd HH 'GMT'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]UTC",
            "yyyy-MM-dd HH'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]GMT",
        ...
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9][ +\\-][0-9]{1,2}:[0-9]{2}",
            "yyyy-MM-dd HHxxx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9][ +\\-][0-9]{3,4}",
            "yyyy-MM-dd HHxx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9][ +\\-][0-9]{2}",
            "yyyy-MM-dd HHx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]Z",
            "yyyy-MM-dd HH'Z'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] [0-2][0-9]",
            "yyyy-MM-dd HH", 

        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] UTC",                      
            "yyyy-MM-dd 'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9] GMT",                      
            "yyyy-MM-dd 'GMT'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]UTC",                      
            "yyyy-MM-dd'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]GMT",                      
            "yyyy-MM-dd'GMT'", 
        //"-?[0-9]{4}-[01][0-9]-[0-3][0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  //ambiguous (time or timezone). treat as time (above)
        //    "yyyy-MM-ddxxx", 
        //"-?[0-9]{4}-[01][0-9]-[0-3][0-9][ +\\-][0-9]{3,4}",                      
        //    "yyyy-MM-ddxx", 
        //"-?[0-9]{4}-[01][0-9]-[0-3][0-9][ +\\-][0-9]{2}",  
        //    "yyyy-MM-ddx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]Z",                      
            "yyyy-MM-dd'Z'", 
        ...
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9][0-5][0-9][0-5][0-9]",
            "yyyy-MM-dd'T'HHmmss",
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9][0-5][0-9]Z",
            "yyyy-MM-dd'T'HHmm'Z'",
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9][0-5][0-9]",
            "yyyy-MM-dd'T'HHmm",

        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9]:[0-5][0-9] UTC",
            "yyyy-MM-dd'T'HH:mm 'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9]:[0-5][0-9] GMT",
            "yyyy-MM-dd'T'HH:mm 'GMT'", 
        ...
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9] UTC",
            "yyyy-MM-dd'T'HH 'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9] GMT",
            "yyyy-MM-dd'T'HH 'GMT'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9]UTC",
            "yyyy-MM-dd'T'HH'UTC'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9]GMT",
        ...
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9][ +\\-][0-9]{1,2}:[0-9]{2}",
            "yyyy-MM-dd'T'HHxxx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9][ +\\-][0-9]{3,4}",
            "yyyy-MM-dd'T'HHxx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9][ +\\-][0-9]{2}",
            "yyyy-MM-dd'T'HHx", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9]Z",
            "yyyy-MM-dd'T'HH'Z'", 
        "-?[0-9]{4}-[01][0-9]-[0-3][0-9]T[0-2][0-9]",
            "yyyy-MM-dd'T'HH", 
        ...
        //flexi digits with space separator                                  //3 = up to 3 decimal digits 
        ...
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9][0-5][0-9][ +\\-][0-9]{2}",          
                                                                   "yyyyMMddHHmmssx", 
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9][0-5][0-9]Z",          
                                                                   "yyyyMMddHHmmss'Z'", 

        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9] UTC",  
                                                                   "yyyyMMddHHmm 'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9] GMT",  
                                                                   "yyyyMMddHHmm 'GMT'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9]UTC",  
                                                                   "yyyyMMddHHmm'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9]GMT",  
        ...
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  
                                                                   "yyyyMMddHHmmxxx",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9][ +\\-][0-9]{3,4}",  
                                                                   "yyyyMMddHHmmxx",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9][ +\\-][0-9]{2}",  
                                                                   "yyyyMMddHHmmx",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9]Z",  
                                                                   "yyyyMMddHHmm'Z'",

        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9] UTC",  
                                                                   "yyyyMMddHH 'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9] GMT",  
                                                                   "yyyyMMddHH 'GMT'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9]UTC",  
                                                                   "yyyyMMddHH'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9]GMT",  
                                                                   "yyyyMMddHH'GMT'",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  
                                                                   "yyyyMMddHHxxx",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][ +\\-][0-9]{3,4}",  
                                                                   "yyyyMMddHHxx",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][ +\\-][0-9]{2}",  
                                                                   "yyyyMMddHHx",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9]Z",  
                                                                   "yyyyMMddHH'Z'",
        ...
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9][0-5][0-9]Z",          
                                                                   "yyyyMMdd'T'HHmmss'Z'",  
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9][0-5][0-9]",          
                                                                   "yyyyMMdd'T'HHmmss",  

        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9] UTC",  
                                                                   "yyyyMMdd'T'HHmm 'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9] GMT",  
                                                                   "yyyyMMdd'T'HHmm 'GMT'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9]UTC",  
                                                                   "yyyyMMdd'T'HHmm'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9]GMT",  
        ...
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9][ +\\-][0-9]{2}",  
                                                                   "yyyyMMdd'T'HHmmx",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9]Z",  
                                                                   "yyyyMMdd'T'HHmm'Z'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][0-5][0-9]",  
                                                                   "yyyyMMdd'T'HHmm",

        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9] UTC",  
                                                                   "yyyyMMdd'T'HH 'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9] GMT",  
                                                                   "yyyyMMdd'T'HH 'GMT'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9]UTC",  
                                                                   "yyyyMMdd'T'HH'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9]GMT",  
        ...
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  
                                                                   "yyyyMMdd'T'HHxxx",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][ +\\-][0-9]{3,4}",  
                                                                   "yyyyMMdd'T'HHxx",
        "[012][0-9]{3}[01][0-9][0-3][0-9]T[0-2][0-9][ +\\-][0-9]{2}",  
                                                                   "yyyyMMdd'T'HHx",
        ...
        "[012][0-9]{3}[01][0-9][0-3][0-9]UTC",                     "yyyyMMdd'UTC'",
        "[012][0-9]{3}[01][0-9][0-3][0-9]GMT",                     "yyyyMMdd'GMT'",
        //"[012][0-9]{3}[01][0-9][0-3][0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "yyyyMMddxxx", //if just date, time offset will screw it up
        ...
        //misc formats
        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9] UTC",   "M/d/yyyy H:m:s 'UTC'",    //assume US ordering
        "[01]?[0-9]-[0123]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9] UTC",   "M-d-yyyy H:m:s 'UTC'",    //assume US ordering
        ...
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9] UTC", "d MMMM yyyy H:m:s 'UTC'", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9] UTC", "d-MMMM-yyyy H:m:s 'UTC'", //02-JANUARY-1985
        ...
        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",   "M/d/yyyy H:m:sxxx",    //assume US ordering
        "[01]?[0-9]-[0123]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",   "M-d-yyyy H:m:sxxx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d MMM yyyy H:m:sxxx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d-MMM-yyyy H:m:sxxx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "d MMMM yyyy H:m:sxxx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "d-MMMM-yyyy H:m:sxxx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",   "M/d/yyyy H:m:sxx",    //assume US ordering
        "[01]?[0-9]-[0123]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",   "M-d-yyyy H:m:sxx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d MMM yyyy H:m:sxx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d-MMM-yyyy H:m:sxx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}", "d MMMM yyyy H:m:sxx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}", "d-MMMM-yyyy H:m:sxx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",   "M/d/yyyy H:m:sx",    //assume US ordering
        "[01]?[0-9]-[0123]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",   "M-d-yyyy H:m:sx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d MMM yyyy H:m:sx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d-MMM-yyyy H:m:sx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}", "d MMMM yyyy H:m:sx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}", "d-MMMM-yyyy H:m:sx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z",   "M/d/yyyy H:m:s'Z'",    //assume US ordering
        "[01]?[0-9]-[0123]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z",   "M-d-yyyy H:m:s'Z'",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z",  "d MMM yyyy H:m:s'Z'",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z",  "d-MMM-yyyy H:m:s'Z'",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z", "d MMMM yyyy H:m:s'Z'", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z", "d-MMMM-yyyy H:m:s'Z'", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]",   "M/d/yyyy H:m:s",    //assume US ordering
        "[01]?[0-9]-[0123]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]",   "M-d-yyyy H:m:s",    //assume US ordering
        ...
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]", "d MMMM yyyy H:m:s", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]", "d-MMMM-yyyy H:m:s", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9] UTC",   "M/d/yyyy H:m 'UTC'",    //assume US ordering
        ...
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9] UTC", "d MMMM yyyy H:m 'UTC'", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9] UTC", "d-MMMM-yyyy H:m 'UTC'", //02-JANUARY-1985
        ...
        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",   "M/d/yyyy H:mxxx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d MMM yyyy H:mxxx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d-MMM-yyyy H:mxxx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "d MMMM yyyy H:mxxx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "d-MMMM-yyyy H:mxxx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",   "M/d/yyyy H:mxx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d MMM yyyy H:mxx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d-MMM-yyyy H:mxx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}", "d MMMM yyyy H:mxx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}", "d-MMMM-yyyy H:mxx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",   "M/d/yyyy H:mx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d MMM yyyy H:mx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d-MMM-yyyy H:mx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}", "d MMMM yyyy H:mx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}", "d-MMMM-yyyy H:mx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]Z",   "M/d/yyyy H:m'Z'",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]Z",  "d MMM yyyy H:m'Z'",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]Z",  "d-MMM-yyyy H:m'Z'",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]Z", "d MMMM yyyy H:m'Z'", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]Z", "d-MMMM-yyyy H:m'Z'", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]",   "M/d/yyyy H:m",    //assume US ordering
        ...
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9]:[0-5]?[0-9]", "d MMMM yyyy H:m", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]", "d-MMMM-yyyy H:m", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9] UTC",   "M/d/yyyy H 'UTC'",    //assume US ordering
        ...
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9] UTC", "d-MMMM-yyyy H 'UTC'", //02-JANUARY-1985
        ...
        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",   "M/d/yyyy Hxxx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d MMM yyyy Hxxx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d-MMM-yyyy Hxxx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "d MMMM yyyy Hxxx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}", "d-MMMM-yyyy Hxxx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9][ +\\-][0-9]{3,4}",   "M/d/yyyy Hxx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9][ +\\-][0-9]{3,4}",  "d MMM yyyy Hxx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9][ +\\-][0-9]{3,4}",  "d-MMM-yyyy Hxx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9][ +\\-][0-9]{3,4}", "d MMMM yyyy Hxx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9][ +\\-][0-9]{3,4}", "d-MMMM-yyyy Hxx", //02-JANUARY-1985

        "[01]?[0-9]/[0123]?[0-9]/[0-9]{4} [012]?[0-9][ +\\-][0-9]{2}",   "M/d/yyyy Hx",    //assume US ordering
        "[0123]?[0-9] [a-zA-Z]{3} [0-9]{4} [012]?[0-9][ +\\-][0-9]{2}",  "d MMM yyyy Hx",  //2 Jan 85
        "[0123]?[0-9]-[a-zA-Z]{3}-[0-9]{4} [012]?[0-9][ +\\-][0-9]{2}",  "d-MMM-yyyy Hx",  //02-JAN-1985
        "[0123]?[0-9] [a-zA-Z]{3,} [0-9]{4} [012]?[0-9][ +\\-][0-9]{2}", "d MMMM yyyy Hx", //2 January 85
        "[0123]?[0-9]-[a-zA-Z]{3,}-[0-9]{4} [012]?[0-9][ +\\-][0-9]{2}", "d-MMMM-yyyy Hx", //02-JANUARY-1985
        ...
        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9] UTC",  "d/M/yyyy H:m:s 'UTC'",   //try Euro ordering
        "[0123]?[0-9]-[01]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9] UTC",  "d-M-yyyy H:m:s 'UTC'",   //try Euro ordering
        ...
        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d/M/yyyy H:m:sxxx",   //try Euro ordering
        "[0123]?[0-9]-[01]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d-M-yyyy H:m:sxxx",   //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d/M/yyyy H:m:sxx",   //try Euro ordering
        "[0123]?[0-9]-[01]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d-M-yyyy H:m:sxx",   //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d/M/yyyy H:m:sx",   //try Euro ordering
        "[0123]?[0-9]-[01]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d-M-yyyy H:m:sx",   //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z",  "d/M/yyyy H:m:s'Z'",   //try Euro ordering
        "[0123]?[0-9]-[01]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]Z",  "d-M-yyyy H:m:s'Z'",   //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]",  "d/M/yyyy H:m:s",   //try Euro ordering
        "[0123]?[0-9]-[01]?[0-9]-[0-9]{4} [012]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]",  "d-M-yyyy H:m:s",   //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9] UTC",  "d/M/yyyy H:m 'UTC'",  //try Euro ordering
        ...
        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d/M/yyyy H:mxxx",  //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{3,4}",  "d/M/yyyy H:mxx",  //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9][ +\\-][0-9]{2}",  "d/M/yyyy H:mx",  //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]Z",  "d/M/yyyy H:m'Z'",  //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9]:[0-5]?[0-9]",  "d/M/yyyy H:m",  //try Euro ordering
        ...
        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9][ +\\-][0-9]{1,2}:[0-9]{2}",  "d/M/yyyy Hxxx",  //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9][ +\\-][0-9]{3,4}",  "d/M/yyyy Hxx",  //try Euro ordering

        "[0123]?[0-9]/[01]?[0-9]/[0-9]{4} [012]?[0-9][ +\\-][0-9]{2}",  "d/M/yyyy Hx",  //try Euro ordering
    ...
    /** 
     * This has alternating regex/timeFormat for formats where all chars are digits.
     * This is used by suggestDateTimeFormat. 
     */
    public final static String allDigitsRegexTimeFormat[] = {
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9][0-5][0-9]",          
                                                                   "yyyyMMddHHmmss", 
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9][0-5][0-9]",  
                                                                   "yyyyMMddHHmm",
        "[012][0-9]{3}[01][0-9][0-3][0-9][0-2][0-9]",  
                                                                   "yyyyMMddHH",
    ...
    public static char   digitRegexTimeFormatLastChar[] = new char[digitRegexTimeFormat.length]; //to catch/match C|T|Z
    public static BitSet digitRegexTimeFormatHasColon = new BitSet(digitRegexTimeFormat.length);
    public static BitSet digitRegexTimeFormatHasPeriod= new BitSet(digitRegexTimeFormat.length); //all periods in regexes are literals
    public static BitSet digitRegexTimeFormatHasSlash = new BitSet(digitRegexTimeFormat.length);
    //not hasT because of 'T'hursday
    public static char letterRegexTimeFormatLastChar[] = new char[letterRegexTimeFormat.length];
    static {
        for (int i = 0; i < digitRegexTimeFormat.length; i += 2) {
            String drtf = digitRegexTimeFormat[i];
            ...
            dateTimeFormatPatternHM.put(digitRegexTimeFormat[i + 1], 
                        Pattern.compile(drtf));
            dateTimeFormatFormatterHM.put(digitRegexTimeFormat[i + 1], 
                    makeDateTimeFormatter(digitRegexTimeFormat[i + 1], zulu));
        }

        for (int i = 0; i < allDigitsRegexTimeFormat.length; i += 2) {
            String drtf = allDigitsRegexTimeFormat[i];
            dateTimeFormatPatternHM.put(allDigitsRegexTimeFormat[i + 1], 
                        Pattern.compile(drtf));
            dateTimeFormatFormatterHM.put(allDigitsRegexTimeFormat[i + 1], 
                    makeDateTimeFormatter(allDigitsRegexTimeFormat[i + 1], zulu));
        }

        for (int i = 0; i < letterRegexTimeFormat.length; i += 2) {
            letterRegexTimeFormatLastChar[i] = letterRegexTimeFormat[i].charAt(letterRegexTimeFormat[i].length() - 1);
            dateTimeFormatPatternHM.put(letterRegexTimeFormat[i + 1], 
                        Pattern.compile(letterRegexTimeFormat[i])); 
            dateTimeFormatFormatterHM.put(letterRegexTimeFormat[i + 1], 
                    makeDateTimeFormatter(letterRegexTimeFormat[i + 1], zulu));
        }
    }
    ...
    /**
     * This tests if the units are numeric time units.
     * This is a good, lenient, quick hueristic. For a definitive test, use getTimeBaseAndFactor(String tsUnits).
     */
     ...
     * String time units ("uuuu", "yyyy": a formatting string which has the year designator).
     *
    ...
    /**
     * This tests if the units are numeric time units (basically, has "since") or 
     * or String time units ("uuuu", "yyyy": a formatting string which has the year designator).
     *
     * <p>The test for numeric time units is a good, quick hueristic. 
     * For a definitive test, use getTimeBaseAndFactor(String tsUnits).
     */
...
//expand this to support fractional years???
     ...
     *   (abbreviated or not) (singular or plural). This is lenient.
    ...
    /**
     * This converts an ISO dateTime String to seconds since 1970-01-01T00:00:00Z,
     ...
     * This may optionally include hours, minutes, seconds, decimal, 
    ...
    public static double safeIsoStringToEpochSeconds(String isoString) {
        if (isoString == null || isoString.length() < 4)
            return Double.NaN;
        try {
            return isoStringToMillis(isoString) / 1000.0;
        } catch (Exception e) {
     ...
     * @throws SimpleException if trouble
     */
    public static double parseMinMaxString(String mmString, double mmValue, 
        boolean allowTimeUnits) {

        if (!mmString.startsWith("min(") &&
            !mmString.startsWith("max("))
            throw new SimpleException("Query error: \"min(\" or \"max(\" expected.");
        String mm = mmString.substring(0, 4);

        String tError = 
            "Query error: Invalid \"" + mm + ")\" constraint: \"" + mmString + "\". " +
            (allowTimeUnits? "T" : "Non-t") + 
            "imestamp constraints with \"" + mm + ")\" must be in the form " +
            "\"" + mmString.substring(0, 3) + "(varName)[+|-" +
            (allowTimeUnits? "positiveInteger[millis|seconds|minutes|hours|days|months|years]]\" (or singular units)." : 
                             "positiveNumber]\".");
     ...
     * (matching yyyy-M... or uuuu-M..., but a little more sophisticated than that).
     *
     * @param s 
    ...
    /**
     * This converts an ISO dateTime String to hours since 1970-01-01T00:00:00Z,
     ...
     * The 'T' connector can be any non-digit.
     * This may optionally include hours, minutes, seconds, decimal, and timezone offset (default=Zulu).  
     *
    ...
    /**
     * This is like epochSecondsToIsoStringTZ, but showing milliseconds,
     * and returns NaNString if seconds is NaN.
     */
    ...
    /**
     * This is like epochSecondsToIsoStringTZ, but showing microseconds,
     * and returns NaNString if seconds is NaN.
     */
    ...
    /**
     * This is like epochSecondsToIsoStringTZ, but showing nanoseconds,
     * and returns NaNString if seconds is NaN.
     */
     ...
     *    "1970-01-01T00:00:00.0Z", ..., "1970-01-01T00:00:00.000000000Z".
     ...
     * which includes daylight saving time, if applicable) and the local time zone.
     *
     ...
     * Info about UTC versus GMT versus TAI... see http://www.leapsecond.com/java/gpsclock.htm.
    ...
    /**
     * Get a GregorianCalendar object with the specified epoch seconds time (UTC) 
     * and a UTC time zone.
     *
...
*/
    ...
    /**
     * This returns the astronomical year as -?uuuu.
     *   For years B.C., this returns Calendar2Year = 1 - BCYear.  
     ...
     * ISO-format dateTime string (with 'T' separator: [-]uuuu-MM-ddTHH:mm:ss)
     * using its current get() values (not influenced by the format's timeZone).
    ...
    public static String formatAsISODateTimeT(GregorianCalendar gc) {
        return 
            formatAsISOYear(gc) + "-" +
            String2.zeroPad("" + (gc.get(MONTH) + 1), 2) + "-" +
            String2.zeroPad("" + gc.get(DATE), 2) + "T" + 
    ...
    public static String formatAsISODateTimeTZ(GregorianCalendar gc) {
        return
            ...
            String2.zeroPad("" + gc.get(HOUR_OF_DAY), 2) + ":" +
            String2.zeroPad("" + gc.get(MINUTE), 2) + ":" +
            String2.zeroPad("" + gc.get(SECOND), 2) + "Z";
    }
    ...
    public static String formatAsISODateTimeT3Z(GregorianCalendar gc) {
        return 
            ...
            String2.zeroPad("" + gc.get(MINUTE), 2) + ":" +
            String2.zeroPad("" + gc.get(SECOND), 2) + "." +
            String2.zeroPad("" + gc.get(MILLISECOND), 3) + "Z";
    }
    ...
    public static String formatAsISODateTimeT6Z(GregorianCalendar gc) {
        return 
            ...
            String2.zeroPad("" + gc.get(MINUTE), 2) + ":" +
            String2.zeroPad("" + gc.get(SECOND), 2) + "." +
            String2.zeroPad("" + gc.get(MILLISECOND), 3) + "000Z"; //!!! because gc doesn't support microseconds
    }
    ...
    public static String formatAsISODateTimeT9Z(GregorianCalendar gc) {
        return 
            ...
            String2.zeroPad("" + gc.get(MINUTE), 2) + ":" +
            String2.zeroPad("" + gc.get(SECOND), 2) + "." +
            String2.zeroPad("" + gc.get(MILLISECOND), 3) + "000000Z"; //!!! because gc doesn't support microseconds
    }
    ...
    public static String timePrecisionToTimeFormat(String pre) {
        ...
        String iso = String2.replaceAll(ISO8601T9Z_FORMAT.substring(0, 31), "'T'", "T"); //remove 'Z' and change T
     ...
     * dateTime string (with space separator: [-]uuuu-MM-dd HH:mm:ss)
     * using its current get() values (not influenced by the format's timeZone).
     * [was calendarToString]
     *
     * @param gc
    ...
    /**
     * This returns a compact formatted [-]uuuuMMddHHmmss string e.g., "20040102030405"
     * using its current get() values (not influenced by the format's timeZone).
     *
     * @param gc a GregorianCalendar object
    ...
    /**
     * This returns a [-]uuuuDDD string e.g., "2004001"
     * using its current get() values (not influenced by the format's timeZone).
     *
     * @param gc a GregorianCalendar object
    ...
    /**
     * This returns a [-]uuuuMM string e.g., "200401"
     * using its current get() values (not influenced by the format's timeZone).
     *
     * @param gc a GregorianCalendar object
    ...
    /**
     * This returns a DD-Mon-[-]uuuu string e.g., "31-Jul-2004 00:00:00"
     * using its current get() values (not influenced by the format's timeZone).
     ...
     *   Timezone hours and minutes will both be + or -, as indicated by sign in s.
     */
        ...
        for (int part = 0; part < nParts; part++) {
            if (po2 + 1 < sLength) {
                ...
                if (part > 0 && separatorN[part - 1] == '.') {
                    //this works for any number of digits 1-9 (and more), but standardizes (truncates) result to millis 
                    resultsN[part] = Math2.truncToInt(1000 * 
                        String2.parseDouble("0." + s.substring(po1, po2)));
                    //String2.log("  millis=" + resultsN[part]);
                } else if (part > 0 && separatorN[part - 1] == '±' && separatorN[part] == ':' && 
     ...
     * (variations of [-]uuuu-MM-ddTHH:mm:ss.SSS±XX:XX) into a GregorianCalendar object.
     ...
     *   (variations of uuuu-MM-ddTHH:mm:ss.SSS±XX:XX
     *   where uuuu is an astronomical year)
    ...
    /**
     * This converts an ISO (default *ZULU* time zone) date time string 
     * (variations of [-]uuuu-MM-ddTHH:mm:ss.SSS±XX:XX) into
     * a GregorianCalendar object with the Zulu time zone.
     * See parseISODateTime documentation.
     *
     * @param s the dateTimeString in the ISO format 
     *   (variations of [-]uuuu-MM-ddTHH:mm:ss)
     *   This may include hours, minutes, seconds, decimal, and Z or timezone offset (default=Zulu).  
    ...
    /**
     * This converts a non-ISO (default *ZULU* time zone) date time string 
     * into a GregorianCalendar object with the Zulu time zone.
     * See parseDateTime documentation.
     *
     * @param s the dateTimeString in the specified format 
     *   This may include hours, minutes, seconds, decimal, and Z or timezone offset (default=Zulu).  
...
//    }
    ...
    private static String parseErrorUnexpectedContent(String s, String format, int sPo) {
        return parseError(s, format) + 
            "The time string doesn't match the format at time string character #" + (sPo+1) + ".";
    }
    /** Generate an error message for parseDateTime.
     * @param formatPo is 0.. but is printed as 1..
     */
    private static String parseErrorUnexpectedFormat(String s, String format, 
        char ch, int formatPo) {
        return parseError(s, format) + 
            "Unexpected or unsupported format character '" + ch + "' at #" + (formatPo+1) + ".";
    }
    /** Generate an error message for parseDateTime.
     * @param formatPo is 0.. but is printed as 1..
     */
    private static String parseErrorUnexpectedCount(String s, String format, 
        int nCh, char ch, int formatPo) {
        return parseError(s, format) + 
            "Unexpected or unsupported format character count: '" + 
            String2.makeString(ch, nCh) + "' at #" + (formatPo+1) + ".";
    }
     ...
     * 1) y and Y are treated as u (may be 0000 or negative). 
     * 2) E only supports 3 letter and full versions of English day-of-week names, 
     *   case insensitive, but the value is ignored and isn't used or validated 
     *   against the year/day numbers.
     * 3) MMM only supports 3 letter and full versions of English month names, 
     *   case insensitive, but the value isn't used or validated against the 
     *   year/day numbers.
     * 3) GQqecwWcFAnNVzOp are not supported.
     * 4) [] (conditional/optional) can only be used in a simple way, e.g., 
     ...
     * @param format A DateTimeFormatter-style specification, e.g., yyyy-DDD.
     *   Note that yyyy is processed as uuuu, so year 0 and before are supported.
     * @return the same GregorianCalendar object, but with the date info
     * @throws RuntimeException if trouble (e.g., any input param is null,
     *    or s doesn't exactly match the format.
     */
    public static GregorianCalendar parseDateTime(GregorianCalendar gc, 
        ...
        while (formatPo >= 0 && formatPo < formatLength) {
            ...
            while (formatPo < formatLength && format.charAt(formatPo) == ch) 
                formatPo++;
            ...
            if (ch == '\'') {
                ...
                for (int i = 0; i < nCh; i++) {
                    if (optionalMode) {
                        //character may match
                        if (sPo < sLength && s.charAt(sPo) == ch)
                            sPo++;
                    } else {
                        //character must match
                        if (sPo >= sLength)
            ...
            // turn optionalMode on/off
                ...
                if (nCh > 1)
                    throw new RuntimeException(
                        parseErrorUnexpectedCount(s, format, nCh, ch, formatPo-nCh));
                else if (optionalMode == true)
                    throw new RuntimeException(parseError(s, format) + 
                ...
                //??? L?
                int ospo = sPo;
                while (sPo < sLength && String2.isAsciiLetter(s.charAt(sPo))) 
                    sPo++;
                ...
                if (nCh > 4) {
                    ...
                    int i = String2.indexOf( //both are titleCase
                        s2.length() == 3? MONTH_3 : MONTH_FULL, s2);
                    //String2.log(">>    i=" + i);                
                    if (i >= 0) gc.set(MONTH, i); //month is 0..
                    else throw new RuntimeException(
                        parseErrorUnexpectedContent(s, format, ospo));
                ...
                //X (and non-standard Z) allows 'Z'.   If content is 'Z', we're done
                    ...
                    int nDigits = 0;
                    while (sPo + nDigits < sLength && String2.isDigit(s.charAt(sPo + nDigits))) 
                        nDigits++;
                    if (nDigits == 0)
                        throw new RuntimeException(
                            parseErrorUnexpectedContent(s, format, sPo));
                    ...
                    gc.set(Calendar.ZONE_OFFSET, Math2.narrowToInt( //millis
                        HH * MILLIS_PER_HOUR +
                        mm * MILLIS_PER_MINUTE));
                }
            ...
            //parse as long int
                ...
                if (nCh == 1) {
                    ...
                    while (sPo < sLength && String2.isDigit(s.charAt(sPo)))
                        sPo++;
                    if (sPo - ospo == 0)
                        throw new RuntimeException(
                            parseErrorUnexpectedContent(s, format, sPo));
            ...
            //all other letters  a-zA-Z, parse at int
                ...
                if ("GLQcVzOp".indexOf(ch) >= 0) {
                    ...
                    throw new RuntimeException(
                        parseErrorUnexpectedFormat(s, format, ch, oFormatPo));
                }
    ...
    /**
     * This converts compact string (must be [-]uuuuMMdd, [-]uuuuMMddHH,
     * [-]uuuuMMddHHmm, or [-]uuuuMMddHHmmss) into
     ...
     * @param gc a GregorianCalendar object. The dateTime will be interpreted
     *   as being in gc's time zone.
     * @param s dateTimeString in compact format (must be [-]uuuuMMdd, [-]uuuuMMddHH,
     * [-]uuuuMMddHHmm, or [-]uuuuMMddHHmmss)
     * @return the same GregorianCalendar object, but with the date info
     * @throws RuntimeException if trouble (e.g., gc is null or s is null or not at least
     *    YYYYMMDD)
     */
    ...
    /**
     * This converts a dd-MMM-[-]uuuu string e.g., "31-Jul-2004 00:00:00"
     ...
     * @param gc a GregorianCalendar object. The dateTime will be interpreted
     *   as being in gc's time zone. 
     * @param s dateTimeString in dd-MMM-uuuu format.
    ...
    public static GregorianCalendar parseDDMonYYYY(GregorianCalendar gc, String s) {
        ...
        if (sLength >= 19) {
            if (s.charAt(17) != ':' ||
                !String2.isDigit(s.charAt(18)) ||
                !String2.isDigit(s.charAt(19)))
                Test.error(String2.ERROR + " in parseDDMonYYYY: s=" + s + " has an invalid format!");
    ...
    /**
     * Convert a String with [-]uuuuDDD to a String with YYYY-mm-dd.
     ...
     *   This may optionally include hours, minutes, seconds, millis and Z or
     ...
     *
     * @param s the ISO DateTime string.
     *   This may include hours, minutes, seconds, millis and perhaps Z or timezone offset (default=Zulu).  
    ...
    /**
     * This converts millis since 1970-01-01T00:00:00Z to an ISO Zulu DateTime 
     * string with a trailing Z.
     *
     * @param millis the millis since 1970-01-01T00:00:00Z
    ...
    public static double[] getNEvenlySpaced(double start, double stop,
        ...
        try {
            ...
            if (reallyVerbose) String2.log(
                "Calendar2.getNEvenlySpaced start=" + epochSecondsToIsoStringTZ(start) +
                " stop=" + epochSecondsToIsoStringTZ(stop) + " field=" + fieldName(field) +
     ...
     *
     * @param sample   
     * @return a digitRegexTimeFormat an appropriate java.time.format.DateTimeFormatter (was Joda) date/time format
     *   or "" if not matched.
        ...
        if (ch >= '0' && ch <= '9') {
            ...
            if (allDigits) {
                for (int i = 0; i < allDigitsRegexTimeFormat.length; i += 2) {
                    ...
                    if (sample.matches(allDigitsRegexTimeFormat[i]))
                        return allDigitsRegexTimeFormat[i+1];
                }
                ...
                for (int i = 0; i < digitRegexTimeFormat.length; i += 2) {
                    ...
                    if (digitRegexTimeFormatHasColon.get( i) != hasColon ||
                        ...
                        digitRegexTimeFormatHasSlash.get( i) != hasSlash)
                        continue;
    ...
    public static String suggestDateTimeFormat(PrimitiveArray sa, boolean evenIfPurelyNumeric) {
        ...
        for (int sai = 0; sai < n; sai++) {
            ...
            if (ch == '-' || (ch >= '0' && ch <= '9')) {
                ...
                if (debugMode) String2.log(noMatch + 
                    "#" + sai + "=\"" + s + "\" doesn't start with a digit or a letter.");
                return "";
            }

            if (startWithDigit != null && startWithLetter != null) {
                if (debugMode) String2.log(noMatch +
                    "some start with digits (" + startWithDigit + 
                    ") and some with letters (" + startWithLetter + ").");
                return "";
            }
        }
        ...
        //go through options
        //This is O(m*n) but in practice fast (O(m)) because most formats will be rejected by first string.
        String regexTimeFormat[] = 
            allDigits? allDigitsRegexTimeFormat : 
            startWithDigit != null? digitRegexTimeFormat :
                letterRegexTimeFormat;
        for (int i = 0; i < regexTimeFormat.length; i += 2) {
            String regex  = regexTimeFormat[i];  //regex
            String format = regexTimeFormat[i+1];
     ...
     *
     * @param regex
     * @return true if the dateTimeFormat is a purely numeric regex 
     *   (e.g., [012][0-9]{3}[01][0-9][0-3][0-9])
     */
    public static boolean isPurelyNumericRegex(String regex) {
        int n = regex.length();
        for (int po = 0; po < n; po++) {
            if ("[]{}-0123456789".indexOf(regex.charAt(po)) < 0) {
                if (debugMode) String2.log(">> regex=" + regex + " is not purely numeric because regex char[" + 
                    po + "]=" + regex.charAt(po));
                return false;
            }
        }
    ...
    public static String tryToFindFormat(String someDateTimeString) {
        ...
        if (someDateTimeString.endsWith(" (original)")) //e.g., https://www.esrl.noaa.gov/psd/thredds/dodsC/Datasets/noaa.ersst.v5/sst.mon.ltm.nc
        ...
        if (format.length() == 0) 
            String2.log("! Calendar2.tryToFindFormat was unable to find a format for " + someDateTimeString);
        return format;
    }
    ...
    public static String tryToIsoString(String someDateTimeString) {
        ...
        return format.indexOf("SSS000000") >= 0? safeEpochSecondsToIsoStringT9Z( sec, "") : 
               format.indexOf("SSS000")    >= 0? safeEpochSecondsToIsoStringT6Z( sec, "") : 
               format.indexOf('S')         >= 0? safeEpochSecondsToIsoStringT3Z( sec, "") : //1-3 S
               format.indexOf('H')         >= 0? safeEpochSecondsToIsoStringTZ(  sec, "") :
     ...
     * @return a new StringArray with iso8601Strings with T and Z (or ""'s for any that it is unable/ has trouble);
     */
    ...
    /** 
     * Given one of the known dateTimeFormats, this returns a java.time.format.DateTimeFormatter 
     * (was Joda) Pattern for it. Patterns are thread safe.
     *
     ...
     * WARNING: This may give incorrect results with years before 0001.
     *
     * @param epochSeconds
     * @param pattern see
    ...
    public static DateTimeFormatter makeDateTimeFormatter(String pattern, String zone) {
        ...
        DateTimeFormatter dtf = new DateTimeFormatterBuilder()
            ...
            //.parseLenient()   //My tests pass without this (or adding this didn't help). It's effect is unclear: for parsing the format or parsing a date string? 
    ...
    /**
     * DON'T USE THIS EXCEPT FOR TESTING BECAUSE OF BUGS IN DateTimeFormatter.
     * This uses the DateTimeFormatter to parse the formatted time string.
     *
     * @param s a formatted time string
     * @param dtf the DateTimeFormatter to do the parsing.
     * @throws RuntimeException
     */
    public static double parseToEpochSecondsViaBuggyDateTimeFormatter(String s, DateTimeFormatter dtf) {
     ...
     */
    public static double parseToEpochSeconds(String sourceTime, String dateTimeFormat, TimeZone timeZone) {
...
//            DateTimeFormatter formatter = dateTimeFormatFormatterHM.get(dateTimeFormat); //already made?
//            if (formatter == null)
...
//            return parseToEpochSeconds(sourceTime, formatter); //thread safe
            ...
            if (verbose && sourceTime != null && sourceTime.length() > 0) {
                ...
                if (msg.indexOf(sourceTime) < 0) //ensure sourceTime is in msg
                    msg = String2.ERROR + ": Invalid sourceTime=\"" + 
                        sourceTime + "\" format=\"" + dateTimeFormat + "\": " + msg;
                String2.log(msg);
            }
            return Double.NaN;
        }
     ...
     *   If it starts with "uuuu-M", "yyyy-M", or "YYYY-M" (Y is discouraged/incorrect),
     *   sa strings will be parsed with Calendar2.parseISODateTimeZulu();
     *   else parse with java.time.format.DateTimeFormatter (was Joda). 
    ...
    public static DoubleArray parseToEpochSeconds(PrimitiveArray sa, String dateTimeFormat) {
        ...
        try {
            ...
            if (verbose)
                String2.log("  Calendar2.toEpochSeconds: format=" + dateTimeFormat + 
                    ", error=" + t.toString());
        }
        return da;
