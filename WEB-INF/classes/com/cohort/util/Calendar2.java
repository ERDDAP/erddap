...
public class Calendar2 {
    ...
    public final static String digitRegexTimeFormat[] = {
        ...
        //flexi digits with space separator                                  //6 = up to 6 decimal digits
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6} UTC",
            "yyyy-M-d H:m:s,S 'UTC'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6} GMT",
            "yyyy-M-d H:m:s,S 'GMT'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}UTC",
            "yyyy-M-d H:m:s,S'UTC'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}GMT",
            "yyyy-M-d H:m:s,S'GMT'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}[ +\\-][0-9]{1,2}:[0-9]{2}",
            "yyyy-M-d H:m:s,Sxxx", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}[ +\\-][0-9]{3,4}",
            "yyyy-M-d H:m:s,Sxx", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}[ +\\-][0-9]{2}",
            "yyyy-M-d H:m:s,Sx", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}Z",
            "yyyy-M-d H:m:s,S'Z'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9] [0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}",
            "yyyy-M-d H:m:s,S", 
        ...
        // flexi digits with T separator                 //6=up to 6 decimal digits
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6} UTC",
            "yyyy-M-d'T'H:m:s,S 'UTC'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6} GMT",
            "yyyy-M-d'T'H:m:s,S 'GMT'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}UTC",
            "yyyy-M-d'T'H:m:s,S'UTC'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}GMT",
            "yyyy-M-d'T'H:m:s,S'GMT'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}[ +\\-][0-9]{1,2}:[0-9]{2}",
            "yyyy-M-d'T'H:m:s,Sxxx", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}[ +\\-][0-9]{3,4}",
            "yyyy-M-d'T'H:m:s,Sxx", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}[ +\\-][0-9]{2}",
            "yyyy-M-d'T'H:m:s,Sx", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6}Z",
        ...
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]\\.[0-9]{1,6}Z",
            "yyyy-M-d'T'H:m:s.S'Z'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]T[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9]\\.[0-9]{1,6}",
            "yyyy-M-d'T'H:m:s.S", 
        ...
        // flexi digits with - separator                   //6=up to 6 decimal digits
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]-[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6} UTC",
            "yyyy-M-d-H:m:s,S 'UTC'", 
        "-?[0-9]{4}-[01]?[0-9]-[0-3]?[0-9]-[0-2]?[0-9]:[0-5]?[0-9]:[0-5]?[0-9],[0-9]{1,6} GMT",
            "yyyy-M-d-H:m:s,S 'GMT'", 
...
//expand this to support fractional years???
    ...
    /**
     * This is like epochSecondsToIsoStringTZ, but showing millis,
     * and returns NaNString if seconds is NaN..
     */
...
//    }
    ...
    public static String tryToIsoString(String someDateTimeString) {
        ...
        return format.indexOf('S') >= 0?   safeEpochSecondsToIsoStringT3Z(sec, "") :
