 ...
 */
public class ULongArray extends LongArray {


    /** 
     * This is the maxiumum unsigned value, stored as a signed long.
     */
    public final static long MAX_VALUE_AS_LONG = -1;

    /** 
     * This is the maxiumum unsigned value, stored as a double.
     */
    public final static double MAX_VALUE = Math2.ULONG_MAX_VALUE;
...
//trouble: ULong can't be contained in a long.
    ...
    public static long pack(double d) {
        return 0; //trouble (int)(i & 0xffffffffL);
    }

    /**
     * This unpacks a ulong stored in a long as a BigInteger.
     */
    public static double unpack(long tl) {
        //BigInteger bi = new BigInteger("" + tl);
        return 0; //trouble tl > 0? bi : bi.add(MAX_VALUE);
    }
    ...
    /**
     * This returns the PAType (PAType.ULONG) of the element type.
     *
     * @return the PAType (PAType.ULONG) of the element type.
     */
    ...
    public String testEquals(Object o) {
        ...
        for (int i = 0; i < size; i++)
            if (array[i] != other.array[i])
                return "The two ULongArrays aren't equal: this[" + i + "]=" + array[i] + 
...
/* for releases, this line should have open/close comment */
        ...
        anArray = (ULongArray)unsignedFactory(PAType.LONG, 
            new ULongArray(new long[] {0, 1, Long.MAX_VALUE, Long.MIN_VALUE, -1}));
        ...
        anArray = new ULongArray(new long[] {35,35,Long.MAX_VALUE,1,2});
        ...
        anArray = new ULongArray(new long[] {Long.MAX_VALUE,1,2,Long.MAX_VALUE,3,Long.MAX_VALUE});
        ...
        anArray.set(2, Long.MAX_VALUE);
        Test.ensureEqual(anArray.isDescending(), 
            "ULongArray isn't sorted in descending order: [1]=10 < [2]=9223372036854775807.", "");
        anArray.set(1, 35);
        Test.ensureEqual(anArray.isDescending(), 
        ...
        Test.ensureEqual((new ULongArray(new long[] {Long.MIN_VALUE})).tryToFindNumericMissingValue(), Long.MIN_VALUE, "");
        Test.ensureEqual((new ULongArray(new long[] {Long.MAX_VALUE})).tryToFindNumericMissingValue(), Long.MAX_VALUE, "");
