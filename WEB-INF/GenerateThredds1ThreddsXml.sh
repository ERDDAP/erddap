#!/bin/bash
#
# usage: ./GenerateThredds1ThreddsXml
#
# GenerateThredds1ThreddsXml is a version of GenerateThreddsXml specifically
# for use on the Thredds1 computer at ERD.
...
#    chmod +x GenerateThredds1ThreddsXml
#
...
incomplete=/usr/local/tomcat/content/thredds/GeneratedXml/incompleteMainCatalog.xml 
xmlMainDir=/usr/local/tomcat/content/thredds/GeneratedXml

java -cp classes:../../../lib/servlet-api.jar:lib/* -Xms1000M -Xmx1000M gov.noaa.pfel.coastwatch.griddata.GenerateThreddsXml $dataMainDir $dataSubDir $incomplete $xmlMainDir
